...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: f */
    public static int m69966f(View view) {
        int m62546E = C38790bq6.m62546E(view);
        if (m62546E > 0) {
            return m62546E;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m69966f(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: g */
    public final boolean m69965g(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C39902dh4.topPanel) {
                    view = childAt;
                } else if (id == C39902dh4.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C39902dh4.contentPanel && id != C39902dh4.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int m75415b = YD1.m75415b(i12, C38790bq6.m62548D(this)) & 7;
                if (m75415b != 1) {
                    if (m75415b != 5) {
