...
public class LoggerContext extends ContextBase implements PO1 {
    ...
    public final FilterReply getTurboFilterChainDecision_0_3OrMore(InterfaceC41482gM2 interfaceC41482gM2, Logger logger, Level level, String str, Object[] objArr, Throwable th) {
        return this.turboFilterList.size() == 0 ? FilterReply.NEUTRAL : this.turboFilterList.getTurboFilterChainDecision(interfaceC41482gM2, logger, level, str, objArr, th);
    }

    public final FilterReply getTurboFilterChainDecision_1(InterfaceC41482gM2 interfaceC41482gM2, Logger logger, Level level, String str, Object obj, Throwable th) {
        return this.turboFilterList.size() == 0 ? FilterReply.NEUTRAL : this.turboFilterList.getTurboFilterChainDecision(interfaceC41482gM2, logger, level, str, new Object[]{obj}, th);
    }

    public final FilterReply getTurboFilterChainDecision_2(InterfaceC41482gM2 interfaceC41482gM2, Logger logger, Level level, String str, Object obj, Object obj2, Throwable th) {
        return this.turboFilterList.size() == 0 ? FilterReply.NEUTRAL : this.turboFilterList.getTurboFilterChainDecision(interfaceC41482gM2, logger, level, str, new Object[]{obj, obj2}, th);
    }
