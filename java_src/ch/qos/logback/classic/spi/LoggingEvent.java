...
public class LoggingEvent implements ILoggingEvent {
    ...
    private InterfaceC41482gM2 marker;
    ...
    public String getFormattedMessage() {
        ...
        this.formattedMessage = objArr != null ? C46882pT2.m19252a(this.message, objArr).m85a() : this.message;
    ...
    public Map<String, String> getMDCPropertyMap() {
        if (this.mdcPropertyMap == null) {
            HE2 m105604c = GE2.m105604c();
            this.mdcPropertyMap = m105604c instanceof LogbackMDCAdapter ? ((LogbackMDCAdapter) m105604c).getPropertyMap() : m105604c.getCopyOfContextMap();
        }
        if (this.mdcPropertyMap == null) {
    ...
    public void setMarker(InterfaceC41482gM2 interfaceC41482gM2) {
        if (this.marker != null) {
            throw new IllegalStateException("The marker has been already set for this event.");
        }
        this.marker = interfaceC41482gM2;
    }
