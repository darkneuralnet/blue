...
public class NestedBasicPropertyIA extends ImplicitAction {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C136171 {
    ...
    public void body(InterpretationContext interpretationContext, String str) {
        ...
        int i = C136171.$SwitchMap$ch$qos$logback$core$util$AggregationType[peek.aggregationType.ordinal()];
        if (i == 4) {
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext interpretationContext) {
        ...
        int i = C136171.$SwitchMap$ch$qos$logback$core$util$AggregationType[computeAggregationType.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4 || i == 5) {
