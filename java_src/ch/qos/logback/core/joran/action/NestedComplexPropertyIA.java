...
public class NestedComplexPropertyIA extends ImplicitAction {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C136181 {
    ...
    public void end(InterpretationContext interpretationContext, String str) {
        ...
        if (interpretationContext.peekObject() != pop.getNestedComplexProperty()) {
            ...
            int i = C136181.$SwitchMap$ch$qos$logback$core$util$AggregationType[pop.aggregationType.ordinal()];
            if (i == 4) {
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext interpretationContext) {
        ...
        int i = C136181.$SwitchMap$ch$qos$logback$core$util$AggregationType[computeAggregationType.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4 || i == 5) {
