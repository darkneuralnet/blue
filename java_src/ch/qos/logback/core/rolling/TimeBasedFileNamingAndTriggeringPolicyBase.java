...
public abstract class TimeBasedFileNamingAndTriggeringPolicyBase<E> extends ContextAwareBase implements TimeBasedFileNamingAndTriggeringPolicy<E> {
    ...
    /* renamed from: rc */
    protected RollingCalendar f61067rc;
    ...
    public void computeNextCheck() {
        this.nextCheck = this.f61067rc.getNextTriggeringDate(this.dateInCurrentPeriod).getTime();
    }
    ...
    public void start() {
        ...
        this.f61067rc = primaryDateTokenConverter.getTimeZone() != null ? new RollingCalendar(primaryDateTokenConverter.getDatePattern(), primaryDateTokenConverter.getTimeZone(), Locale.US) : new RollingCalendar(primaryDateTokenConverter.getDatePattern());
        ...
        this.f61067rc.printPeriodicity(this);
        if (!this.f61067rc.isCollisionFree()) {
