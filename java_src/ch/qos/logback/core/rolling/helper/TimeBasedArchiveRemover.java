...
public class TimeBasedArchiveRemover extends ContextAwareBase implements ArchiveRemover {
    ...
    /* renamed from: rc */
    private final RollingCalendar f61069rc;
    ...
    private FilenameFilter createExpiredFileFilter(final Date date) {
        return new FilenameFilter() { // from class: ch.qos.logback.core.rolling.helper.TimeBasedArchiveRemover.1
            ...
            public boolean accept(File file, String str) {
                return TimeBasedArchiveRemover.this.f61069rc.normalizeDate(TimeBasedArchiveRemover.this.dateParser.parseFilename(str)).compareTo(TimeBasedArchiveRemover.this.f61069rc.normalizeDate(TimeBasedArchiveRemover.this.f61069rc.getEndOfNextNthPeriod(date, -TimeBasedArchiveRemover.this.maxHistory))) < 0;
            }
        };
    }
