...
public final class BaseUnreadyMarkerOverrides$setReadyAndReleaseItemsFor$1 extends Lambda implements Function1<BaseUnreadyMarkerOverrides.HeldClusterItem<T>, Boolean> {
    final /* synthetic */ String $overrideId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseUnreadyMarkerOverrides$setReadyAndReleaseItemsFor$1(String str) {
        super(1);
        this.$overrideId = str;
    }
    ...
    public final Boolean invoke(BaseUnreadyMarkerOverrides.HeldClusterItem<T> it) {
        ...
        return Boolean.valueOf(Intrinsics.areEqual(it.getLoadingOverride().m96242b(), this.$overrideId));
    }
}
