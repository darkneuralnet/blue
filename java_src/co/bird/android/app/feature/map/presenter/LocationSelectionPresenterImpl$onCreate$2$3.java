...
public final class LocationSelectionPresenterImpl$onCreate$2$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ LocationSelectionPresenterImpl $this_run;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LocationSelectionPresenterImpl$onCreate$2$3(LocationSelectionPresenterImpl locationSelectionPresenterImpl) {
        super(1);
    ...
    public final void invoke2(String address) {
        LocationSelectionPresenterImpl locationSelectionPresenterImpl = this.$this_run;
