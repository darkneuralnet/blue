...
public final class MapPresenterImpl$onResume$4 extends Lambda implements Function1<Location, Unit> {
    final /* synthetic */ MapPresenterImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MapPresenterImpl$onResume$4(MapPresenterImpl mapPresenterImpl) {
        super(1);
