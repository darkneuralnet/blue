...
public final class FleetMarkerOptionProvider$bitmapDescriptor$2 extends Lambda implements Function0<C6378PT> {
    final /* synthetic */ Lazy<C6378PT> $descriptor$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FleetMarkerOptionProvider$bitmapDescriptor$2(Lazy<C6378PT> lazy) {
        super(0);
