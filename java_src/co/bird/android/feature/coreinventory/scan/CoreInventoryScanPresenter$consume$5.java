...
public final class CoreInventoryScanPresenter$consume$5 extends Lambda implements Function1<Throwable, Unit> {

    /* renamed from: g */
    public final /* synthetic */ CoreInventoryScanPresenter f63861g;
    ...
    @SourceDebugExtension({"SMAP\nCoreInventoryScanPresenter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CoreInventoryScanPresenter.kt\nco/bird/android/feature/coreinventory/scan/CoreInventoryScanPresenter$consume$5$1\n+ 2 CoreInventoryScanState.kt\nco/bird/android/feature/coreinventory/scan/CoreInventoryScanStateKt\n*L\n1#1,261:1\n111#2,20:262\n*S KotlinDebug\n*F\n+ 1 CoreInventoryScanPresenter.kt\nco/bird/android/feature/coreinventory/scan/CoreInventoryScanPresenter$consume$5$1\n*L\n91#1:262,20\n*E\n"})
    /* renamed from: co.bird.android.feature.coreinventory.scan.CoreInventoryScanPresenter$consume$5$1 */
    /* loaded from: classes3.dex */
    public static final class C147651 extends Lambda implements Function1<CoreInventoryScanState, CoreInventoryScanState> {

        /* renamed from: g */
        public final /* synthetic */ Throwable f63862g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C147651(Throwable th) {
            super(1);
            this.f63862g = th;
        }
        ...
        public final CoreInventoryScanState invoke(CoreInventoryScanState coreInventoryScanState) {
            ...
            m58257n = r1.m58257n((r32 & 1) != 0 ? r1.f63875a : null, (r32 & 2) != 0 ? r1.f63876b : null, (r32 & 4) != 0 ? r1.f63877c : null, (r32 & 8) != 0 ? r1.f63878d : null, (r32 & 16) != 0 ? r1.f63879e : null, (r32 & 32) != 0 ? r1.f63880f : null, (r32 & 64) != 0 ? r1.f63881g : null, (r32 & 128) != 0 ? r1.f63882h : null, (r32 & 256) != 0 ? r1.f63883i : null, (r32 & 512) != 0 ? r1.f63884j : null, (r32 & 1024) != 0 ? r1.f63885k : false, (r32 & 2048) != 0 ? r1.f63886l : null, (r32 & 4096) != 0 ? r1.f63887m : 0, (r32 & 8192) != 0 ? r1.f63888n : 0, (r32 & 16384) != 0 ? ((UpdateUi) state).f63889o : this.f63862g);
            return m58257n;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoreInventoryScanPresenter$consume$5(CoreInventoryScanPresenter coreInventoryScanPresenter) {
        super(1);
        this.f63861g = coreInventoryScanPresenter;
    }
    ...
    public final void invoke2(Throwable th) {
        this.f63861g.m42279i(new C147651(th));
    }
}
