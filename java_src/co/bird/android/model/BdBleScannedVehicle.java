...
public final class BdBleScannedVehicle implements BleScannedVehicle {
    ...
    public BdBleScannedVehicle(InterfaceC45802ne5 rxBleDevice, BluetoothDevice device, int i, int i2, int i3, EnergyMode energyMode, Integer num, String str, InterfaceC32176Ck5 scanRecord) {
    ...
    public Observable<VehicleConnection> connect() {
        ...
        final BdBleScannedVehicle$connect$1 bdBleScannedVehicle$connect$1 = new BdBleScannedVehicle$connect$1(this);
        Observable map = mo17282c.map(new InterfaceC23492o() { // from class: XF
            @Override // io.reactivex.functions.InterfaceC23492o
            public final Object apply(Object obj) {
                VehicleConnection connect$lambda$0;
                connect$lambda$0 = BdBleScannedVehicle.connect$lambda$0(Function1.this, obj);
