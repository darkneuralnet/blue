...
public final class BirdAirBleScannedVehicle implements BleScannedVehicle {
    ...
    public BirdAirBleScannedVehicle(InterfaceC45802ne5 rxBleDevice, BluetoothDevice device, int i, int i2, int i3, EnergyMode energyMode, Integer num, String str, InterfaceC32176Ck5 scanRecord) {
    ...
    public Observable<VehicleConnection> connect() {
        ...
        final BirdAirBleScannedVehicle$connect$1 birdAirBleScannedVehicle$connect$1 = new BirdAirBleScannedVehicle$connect$1(this);
        Observable map = mo17282c.map(new InterfaceC23492o() { // from class: iI
            @Override // io.reactivex.functions.InterfaceC23492o
            public final Object apply(Object obj) {
                VehicleConnection connect$lambda$0;
                connect$lambda$0 = BirdAirBleScannedVehicle.connect$lambda$0(Function1.this, obj);
