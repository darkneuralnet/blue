...
public final class BirdBikeBleScannedVehicle$connect$3 extends Lambda implements Function1<InterfaceC44023ke5, VehicleConnection> {
    final /* synthetic */ BirdBikeBleScannedVehicle this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BirdBikeBleScannedVehicle$connect$3(BirdBikeBleScannedVehicle birdBikeBleScannedVehicle) {
        super(1);
    ...
    public final VehicleConnection invoke(InterfaceC44023ke5 it) {
        ...
        return new BirdBikeVehicleConnection(it, interfaceC45802ne5, this.this$0.payloadEncryptor());
    }
}
