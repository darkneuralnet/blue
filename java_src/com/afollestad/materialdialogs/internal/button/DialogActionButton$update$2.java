...
public final class DialogActionButton$update$2 extends Lambda implements Function0<Integer> {
    ...
    public final int invoke2() {
        return ColorsKt.adjustAlpha(MDUtil.resolveColor$default(MDUtil.INSTANCE, this.$appContext, null, Integer.valueOf(C16848R.attr.colorPrimary), null, 10, null), 0.12f);
    }
}
