...
public class STSAssumeRoleSessionCredentialsProvider implements AWSCredentialsProvider {
    ...
    private void startSession() {
        Credentials credentials = this.securityTokenService.assumeRole(new AssumeRoleRequest().withRoleArn(this.roleArn).withDurationSeconds(Integer.valueOf((int) DEFAULT_DURATION_SECONDS)).withRoleSessionName(this.roleSessionName)).getCredentials();
