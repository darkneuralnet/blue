    ...
    public synchronized Key generateKey(String str) throws KeyNotGeneratedException {
        ...
        try {
            try {
                ...
                KeyPairGeneratorSpec build = alias.setSubject(new X500Principal("CN=" + str)).setSerialNumber(BigInteger.TEN).setStartDate(calendar.getTime()).setEndDate(calendar2.getTime()).build();
