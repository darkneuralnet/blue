...
import com.amazonaws.mobileconnectors.p025s3.transfermanager.PauseResult;
...
public class UploadMonitor implements Callable<UploadResult>, TransferMonitor {
    ...
    /* renamed from: s3 */
    private final AmazonS3 f68568s3;
    ...
    public UploadMonitor(TransferManager transferManager, UploadImpl uploadImpl, ExecutorService executorService, UploadCallable uploadCallable, PutObjectRequest putObjectRequest, ProgressListenerChain progressListenerChain) {
        this.f68568s3 = transferManager.getAmazonS3Client();
    ...
    private UploadResult completeMultipartUpload() {
        CompleteMultipartUploadResult completeMultipartUpload = this.f68568s3.completeMultipartUpload(new CompleteMultipartUploadRequest(this.putObjectRequest.getBucketName(), this.putObjectRequest.getKey(), this.uploadId, collectPartETags()));
        uploadComplete();
