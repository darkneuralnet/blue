...
import com.amazonaws.services.p026s3.internal.AWSS3V4Signer;
import com.amazonaws.services.p026s3.internal.BucketNameUtils;
import com.amazonaws.services.p026s3.internal.CompleteMultipartUploadRetryCondition;
import com.amazonaws.services.p026s3.internal.Constants;
import com.amazonaws.services.p026s3.internal.DeleteObjectTaggingHeaderHandler;
import com.amazonaws.services.p026s3.internal.DeleteObjectsResponse;
import com.amazonaws.services.p026s3.internal.DigestValidationInputStream;
import com.amazonaws.services.p026s3.internal.GetObjectTaggingResponseHeaderHandler;
import com.amazonaws.services.p026s3.internal.InputSubstream;
import com.amazonaws.services.p026s3.internal.MD5DigestCalculatingInputStream;
import com.amazonaws.services.p026s3.internal.ObjectExpirationHeaderHandler;
import com.amazonaws.services.p026s3.internal.RepeatableFileInputStream;
import com.amazonaws.services.p026s3.internal.ResponseHeaderHandlerChain;
import com.amazonaws.services.p026s3.internal.S3ErrorResponseHandler;
import com.amazonaws.services.p026s3.internal.S3ExecutionContext;
import com.amazonaws.services.p026s3.internal.S3HttpUtils;
import com.amazonaws.services.p026s3.internal.S3MetadataResponseHandler;
import com.amazonaws.services.p026s3.internal.S3ObjectResponseHandler;
import com.amazonaws.services.p026s3.internal.S3QueryStringSigner;
import com.amazonaws.services.p026s3.internal.S3RequesterChargedHeaderHandler;
import com.amazonaws.services.p026s3.internal.S3Signer;
import com.amazonaws.services.p026s3.internal.S3StringResponseHandler;
import com.amazonaws.services.p026s3.internal.S3VersionHeaderHandler;
import com.amazonaws.services.p026s3.internal.S3XmlResponseHandler;
import com.amazonaws.services.p026s3.internal.ServerSideEncryptionHeaderHandler;
import com.amazonaws.services.p026s3.internal.ServiceUtils;
import com.amazonaws.services.p026s3.internal.SetObjectTaggingResponseHeaderHandler;
...
import com.amazonaws.services.p026s3.model.BucketNotificationConfiguration;
import com.amazonaws.services.p026s3.model.BucketPolicy;
...
import com.amazonaws.services.p026s3.model.CreateBucketRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketAnalyticsConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketAnalyticsConfigurationResult;
import com.amazonaws.services.p026s3.model.DeleteBucketCrossOriginConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketInventoryConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketInventoryConfigurationResult;
import com.amazonaws.services.p026s3.model.DeleteBucketLifecycleConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketMetricsConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketMetricsConfigurationResult;
import com.amazonaws.services.p026s3.model.DeleteBucketPolicyRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketReplicationConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketTaggingConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteBucketWebsiteConfigurationRequest;
import com.amazonaws.services.p026s3.model.DeleteObjectRequest;
import com.amazonaws.services.p026s3.model.DeleteObjectTaggingRequest;
...
import com.amazonaws.services.p026s3.model.DeleteVersionRequest;
import com.amazonaws.services.p026s3.model.GeneratePresignedUrlRequest;
import com.amazonaws.services.p026s3.model.GenericBucketRequest;
import com.amazonaws.services.p026s3.model.GetBucketAccelerateConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketAclRequest;
import com.amazonaws.services.p026s3.model.GetBucketAnalyticsConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketAnalyticsConfigurationResult;
import com.amazonaws.services.p026s3.model.GetBucketCrossOriginConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketInventoryConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketInventoryConfigurationResult;
import com.amazonaws.services.p026s3.model.GetBucketLifecycleConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketLocationRequest;
import com.amazonaws.services.p026s3.model.GetBucketLoggingConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketMetricsConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketMetricsConfigurationResult;
import com.amazonaws.services.p026s3.model.GetBucketNotificationConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketPolicyRequest;
import com.amazonaws.services.p026s3.model.GetBucketReplicationConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketTaggingConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketVersioningConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetBucketWebsiteConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetObjectAclRequest;
import com.amazonaws.services.p026s3.model.GetObjectMetadataRequest;
import com.amazonaws.services.p026s3.model.GetObjectRequest;
import com.amazonaws.services.p026s3.model.GetObjectTaggingRequest;
import com.amazonaws.services.p026s3.model.GetObjectTaggingResult;
import com.amazonaws.services.p026s3.model.GetRequestPaymentConfigurationRequest;
import com.amazonaws.services.p026s3.model.GetS3AccountOwnerRequest;
import com.amazonaws.services.p026s3.model.Grant;
import com.amazonaws.services.p026s3.model.Grantee;
import com.amazonaws.services.p026s3.model.HeadBucketRequest;
...
import com.amazonaws.services.p026s3.model.ListBucketAnalyticsConfigurationsRequest;
import com.amazonaws.services.p026s3.model.ListBucketAnalyticsConfigurationsResult;
import com.amazonaws.services.p026s3.model.ListBucketInventoryConfigurationsRequest;
import com.amazonaws.services.p026s3.model.ListBucketInventoryConfigurationsResult;
import com.amazonaws.services.p026s3.model.ListBucketMetricsConfigurationsRequest;
import com.amazonaws.services.p026s3.model.ListBucketMetricsConfigurationsResult;
import com.amazonaws.services.p026s3.model.ListBucketsRequest;
import com.amazonaws.services.p026s3.model.ListMultipartUploadsRequest;
import com.amazonaws.services.p026s3.model.ListNextBatchOfObjectsRequest;
import com.amazonaws.services.p026s3.model.ListNextBatchOfVersionsRequest;
import com.amazonaws.services.p026s3.model.ListObjectsRequest;
import com.amazonaws.services.p026s3.model.ListObjectsV2Request;
...
import com.amazonaws.services.p026s3.model.ListVersionsRequest;
import com.amazonaws.services.p026s3.model.MultiFactorAuthentication;
...
import com.amazonaws.services.p026s3.model.Region;
...
import com.amazonaws.services.p026s3.model.RestoreObjectRequest;
import com.amazonaws.services.p026s3.model.S3AccelerateUnsupported;
import com.amazonaws.services.p026s3.model.S3Object;
import com.amazonaws.services.p026s3.model.S3ObjectInputStream;
...
import com.amazonaws.services.p026s3.model.SetBucketAccelerateConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketAclRequest;
import com.amazonaws.services.p026s3.model.SetBucketAnalyticsConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketAnalyticsConfigurationResult;
import com.amazonaws.services.p026s3.model.SetBucketCrossOriginConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketInventoryConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketInventoryConfigurationResult;
import com.amazonaws.services.p026s3.model.SetBucketLifecycleConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketLoggingConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketMetricsConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketMetricsConfigurationResult;
import com.amazonaws.services.p026s3.model.SetBucketNotificationConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketPolicyRequest;
import com.amazonaws.services.p026s3.model.SetBucketReplicationConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketTaggingConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketVersioningConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetBucketWebsiteConfigurationRequest;
import com.amazonaws.services.p026s3.model.SetObjectAclRequest;
import com.amazonaws.services.p026s3.model.SetObjectTaggingRequest;
import com.amazonaws.services.p026s3.model.SetObjectTaggingResult;
import com.amazonaws.services.p026s3.model.SetRequestPaymentConfigurationRequest;
...
import com.amazonaws.services.p026s3.model.transform.AclXmlFactory;
import com.amazonaws.services.p026s3.model.transform.BucketConfigurationXmlFactory;
import com.amazonaws.services.p026s3.model.transform.BucketNotificationConfigurationStaxUnmarshaller;
import com.amazonaws.services.p026s3.model.transform.HeadBucketResultHandler;
import com.amazonaws.services.p026s3.model.transform.MultiObjectDeleteXmlFactory;
import com.amazonaws.services.p026s3.model.transform.ObjectTaggingXmlFactory;
import com.amazonaws.services.p026s3.model.transform.RequestPaymentConfigurationXmlFactory;
import com.amazonaws.services.p026s3.model.transform.RequestXmlFactory;
import com.amazonaws.services.p026s3.model.transform.Unmarshallers;
...
public class AmazonS3Client extends AmazonWebServiceClient implements AmazonS3 {
    ...
    private void populateRequestWithCopyPartParameters(Request<?> request, CopyPartRequest copyPartRequest) {
        ...
        if (copyPartRequest.getFirstByte() != null && copyPartRequest.getLastByte() != null) {
            request.addHeader(Headers.COPY_PART_RANGE, "bytes=" + copyPartRequest.getFirstByte() + Detail.EMPTY_CHAR + copyPartRequest.getLastByte());
        }
    ...
    private ByteArrayInputStream toByteArray(InputStream inputStream) {
        int i = net.danlew.android.joda.DateUtils.FORMAT_ABBREV_RELATIVE;
        byte[] bArr = new byte[net.danlew.android.joda.DateUtils.FORMAT_ABBREV_RELATIVE];
        int i2 = 0;
        while (i > 0) {
            try {
    ...
    @Override // com.amazonaws.services.p026s3.AmazonS3, com.amazonaws.services.p026s3.internal.S3DirectSpi
    ...
    @Override // com.amazonaws.services.p026s3.AmazonS3
    ...
    public CopyPartResult copyPart(CopyPartRequest copyPartRequest) {
        ...
        try {
            ...
            amazonS3Exception.setStatusCode(C11925l.AbstractC11930e.DEFAULT_DRAG_ANIMATION_DURATION);
    ...
    public DeleteObjectsResult deleteObjects(DeleteObjectsRequest deleteObjectsRequest) {
        ...
        try {
            ...
            multiObjectDeleteException.setStatusCode(C11925l.AbstractC11930e.DEFAULT_DRAG_ANIMATION_DURATION);
    ...
    @Override // com.amazonaws.AmazonWebServiceClient, com.amazonaws.services.p026s3.AmazonS3
    ...
    public S3Object getObject(GetObjectRequest getObjectRequest) throws AmazonClientException, AmazonServiceException {
        ...
        if (range != null) {
            String str = "bytes=" + Long.toString(range[0]) + Detail.EMPTY_CHAR;
            if (range[1] >= 0) {
    ...
    public ObjectMetadata getObject(final GetObjectRequest getObjectRequest, File file) throws AmazonClientException, AmazonServiceException {
        ...
        S3Object retryableDownloadS3ObjectToFile = ServiceUtils.retryableDownloadS3ObjectToFile(file, new ServiceUtils.RetryableS3DownloadTask() { // from class: com.amazonaws.services.s3.AmazonS3Client.2
            @Override // com.amazonaws.services.p026s3.internal.ServiceUtils.RetryableS3DownloadTask
