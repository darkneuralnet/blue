...
import com.amazonaws.services.p026s3.KeyWrapException;
import com.amazonaws.services.p026s3.model.CryptoMode;
import com.amazonaws.services.p026s3.model.EncryptionMaterials;
import com.amazonaws.services.p026s3.model.EncryptionMaterialsAccessor;
import com.amazonaws.services.p026s3.model.ExtraMaterialsDescription;
import com.amazonaws.services.p026s3.model.KMSEncryptionMaterials;
...
final class ContentCryptoMaterial {
    ...
    private static ContentCryptoMaterial fromObjectMetadata0(ObjectMetadata objectMetadata, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, long[] jArr, ExtraMaterialsDescription extraMaterialsDescription, boolean z, AWSKMSClient aWSKMSClient) {
        ...
        if (decode != null && decode2 != null) {
            ...
            return new ContentCryptoMaterial(map, decode, str2, fromCEKAlgo.createCipherLite(cek(decode, str2, encryptionMaterials2, provider, fromCEKAlgo, aWSKMSClient), bArr, 2, provider));
        }
