...
import com.amazonaws.services.p026s3.internal.crypto.MultipartUploadCryptoContext;
import com.amazonaws.services.p026s3.model.AbortMultipartUploadRequest;
import com.amazonaws.services.p026s3.model.AbstractPutObjectRequest;
...
import com.amazonaws.services.p026s3.model.CryptoStorageMode;
import com.amazonaws.services.p026s3.model.EncryptionMaterials;
import com.amazonaws.services.p026s3.model.EncryptionMaterialsFactory;
...
import com.amazonaws.services.p026s3.model.MaterialsDescriptionProvider;
...
import com.amazonaws.services.p026s3.model.S3DataSource;
import com.amazonaws.services.p026s3.model.S3Object;
import com.amazonaws.services.p026s3.model.S3ObjectId;
...
public abstract class S3CryptoModuleBase<T extends MultipartUploadCryptoContext> extends S3CryptoModule<T> {
    ...
    /* renamed from: s3 */
    protected final S3Direct f68587s3;
    ...
    private PutObjectResult putObjectUsingInstructionFile(PutObjectRequest putObjectRequest) {
        ...
        PutObjectRequest withInputStream = putObjectRequest.mo116299clone().withFile((File) null).withInputStream((InputStream) null);
        ...
        try {
            PutObjectResult putObject = this.f68587s3.putObject(putObjectRequest2);
            S3DataSource.Utils.cleanupDataSource(putObjectRequest, file, inputStream, putObjectRequest2.getInputStream(), this.log);
            this.f68587s3.putObject(updateInstructionPutRequest(withInputStream, createContentCryptoMaterial));
            return putObject;
        } catch (Throwable th) {
            S3DataSource.Utils.cleanupDataSource(putObjectRequest, file, inputStream, putObjectRequest2.getInputStream(), this.log);
            throw th;
    ...
    private PutObjectResult putObjectUsingMetadata(PutObjectRequest putObjectRequest) {
        ...
        try {
            return this.f68587s3.putObject(putObjectRequest2);
        } finally {
            S3DataSource.Utils.cleanupDataSource(putObjectRequest, file, inputStream, putObjectRequest2.getInputStream(), this.log);
        }
    }
    ...
    public final void abortMultipartUploadSecurely(AbortMultipartUploadRequest abortMultipartUploadRequest) {
        this.f68587s3.abortMultipartUpload(abortMultipartUploadRequest);
    ...
    public CompleteMultipartUploadResult completeMultipartUploadSecurely(CompleteMultipartUploadRequest completeMultipartUploadRequest) {
        ...
        CompleteMultipartUploadResult completeMultipartUpload = this.f68587s3.completeMultipartUpload(completeMultipartUploadRequest);
        if (t != null && this.cryptoConfig.getStorageMode() == CryptoStorageMode.InstructionFile) {
            this.f68587s3.putObject(createInstructionPutRequest(t.getBucketName(), t.getKey(), t.getContentCryptoMaterial()));
        }
    ...
    public final CopyPartResult copyPartSecurely(CopyPartRequest copyPartRequest) {
        ...
        CopyPartResult copyPart = this.f68587s3.copyPart(copyPartRequest);
        if (t != null && !t.hasFinalPartBeenSeen()) {
    ...
    public final S3ObjectWrapper fetchInstructionFile(S3ObjectId s3ObjectId, String str) {
        try {
            S3Object object = this.f68587s3.getObject(createInstructionGetRequest(s3ObjectId, str));
            if (object == null) {
                return null;
            }
    ...
    public InitiateMultipartUploadResult initiateMultipartUploadSecurely(InitiateMultipartUploadRequest initiateMultipartUploadRequest) {
        ...
        InitiateMultipartUploadResult initiateMultipartUpload = this.f68587s3.initiateMultipartUpload(initiateMultipartUploadRequest);
    ...
    public final PutObjectResult putInstructionFileSecurely(PutInstructionFileRequest putInstructionFileRequest) {
        ...
        S3Object object = this.f68587s3.getObject(getObjectRequest);
        ...
        if (object != null) {
            ...
            try {
                ...
                return this.f68587s3.putObject(updateInstructionPutRequest(putInstructionFileRequest.createPutObjectRequest(object), recreate));
            } catch (Error e) {
                IOUtils.closeQuietly(object, this.log);
                throw e;
    ...
    public final void putLocalObjectSecurely(UploadObjectRequest uploadObjectRequest, String str, OutputStream outputStream) throws IOException {
        UploadObjectRequest mo116299clone = uploadObjectRequest.mo116299clone();
        File file = mo116299clone.getFile();
        InputStream inputStream = mo116299clone.getInputStream();
        T t = this.multipartUploadContexts.get(str);
        UploadObjectRequest uploadObjectRequest2 = (UploadObjectRequest) wrapWithCipher(mo116299clone, t.getContentCryptoMaterial());
        try {
        ...
        if (t != null) {
            ...
            try {
                ...
                try {
                    ...
                    UploadPartResult uploadPart = this.f68587s3.uploadPart(uploadPartRequest);
