...
public abstract class AbstractPutObjectRequest extends AmazonWebServiceRequest implements SSECustomerKeyProvider, SSEAwsKeyManagementParamsProvider, S3DataSource, Serializable {
    ...
    public final <T extends AbstractPutObjectRequest> T copyPutObjectBaseTo(T t) {
        ...
        if (metadata == null) {
            ...
            m116302clone = metadata.m116302clone();
        }
        return (T) withInputStream.withMetadata(m116302clone).withRedirectLocation(getRedirectLocation()).withStorageClass(getStorageClass()).withSSEAwsKeyManagementParams(getSSEAwsKeyManagementParams()).withSSECustomerKey(getSSECustomerKey());
    }
    ...
    @Override // com.amazonaws.services.p026s3.model.S3DataSource
    public File getFile() {
        return this.file;
    }
    ...
    @Override // com.amazonaws.services.p026s3.model.SSEAwsKeyManagementParamsProvider
    public SSEAwsKeyManagementParams getSSEAwsKeyManagementParams() {
        return this.sseAwsKeyManagementParams;
    }

    @Override // com.amazonaws.services.p026s3.model.SSECustomerKeyProvider
    ...
    /* renamed from: clone */
    public AbstractPutObjectRequest mo116299clone() {
        return (AbstractPutObjectRequest) super.mo116299clone();
    }
