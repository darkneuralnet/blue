...
import com.amazonaws.services.p026s3.model.CloudFunctionConfiguration;
import com.amazonaws.services.p026s3.model.Filter;
import com.amazonaws.services.p026s3.model.FilterRule;
import com.amazonaws.services.p026s3.model.LambdaConfiguration;
import com.amazonaws.services.p026s3.model.NotificationConfiguration;
...
import com.amazonaws.services.p026s3.model.S3KeyFilter;
...
import com.amazonaws.services.p026s3.model.analytics.AnalyticsPredicateVisitor;
...
import com.amazonaws.services.p026s3.model.inventory.InventoryFilterPredicate;
...
import com.amazonaws.services.p026s3.model.lifecycle.LifecyclePredicateVisitor;
...
import com.amazonaws.services.p026s3.model.metrics.MetricsPredicateVisitor;
...
public class BucketConfigurationXmlFactory {
    ...
    public class AnalyticsPredicateVisitorImpl implements AnalyticsPredicateVisitor {
        ...
        @Override // com.amazonaws.services.p026s3.model.analytics.AnalyticsPredicateVisitor
    ...
    public class LifecyclePredicateVisitorImpl implements LifecyclePredicateVisitor {
        ...
        @Override // com.amazonaws.services.p026s3.model.lifecycle.LifecyclePredicateVisitor
    ...
    public class MetricsPredicateVisitorImpl implements MetricsPredicateVisitor {
        ...
        @Override // com.amazonaws.services.p026s3.model.metrics.MetricsPredicateVisitor
    ...
    private void addEventsAndFilterCriteria(XmlWriter xmlWriter, NotificationConfiguration notificationConfiguration) {
        for (String str : notificationConfiguration.getEvents()) {
            xmlWriter.start("Event").value(str).end();
        }
    ...
    private void addInventoryOptionalFields(XmlWriter xmlWriter, List<String> list) {
        ...
        for (String str : list) {
            xmlWriter.start("Field").value(str).end();
        }
        xmlWriter.end();
    }
    ...
    private void writeRule(XmlWriter xmlWriter, CORSRule cORSRule) {
        ...
        if (cORSRule.getAllowedOrigins() != null) {
            for (String str : cORSRule.getAllowedOrigins()) {
                xmlWriter.start("AllowedOrigin").value(str).end();
            }
        }
        ...
        if (cORSRule.getExposedHeaders() != null) {
            for (String str2 : cORSRule.getExposedHeaders()) {
                xmlWriter.start("ExposeHeader").value(str2).end();
            }
        }
        if (cORSRule.getAllowedHeaders() != null) {
            for (String str3 : cORSRule.getAllowedHeaders()) {
                xmlWriter.start("AllowedHeader").value(str3).end();
            }
        }
        xmlWriter.end();
    }
    ...
    public byte[] convertToXmlByteArray(BucketReplicationConfiguration bucketReplicationConfiguration) {
        ...
        for (Map.Entry<String, ReplicationRule> entry : rules.entrySet()) {
            ...
            xmlWriter.start("Rule");
            xmlWriter.start("ID").value(entry.getKey()).end();
