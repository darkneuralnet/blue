...
public final class ImmutableMapParameter<K, V> implements Map<K, V> {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m53518of(K k, V v) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m53517of(K k, V v, K k2, V v2) {
        HashMap hashMap = new HashMap();
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m53516of(K k, V v, K k2, V v2, K k3, V v3) {
        HashMap hashMap = new HashMap();
        putAndWarnDuplicateKeys(hashMap, k, v);
        putAndWarnDuplicateKeys(hashMap, k2, v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m53515of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        HashMap hashMap = new HashMap();
        putAndWarnDuplicateKeys(hashMap, k, v);
        putAndWarnDuplicateKeys(hashMap, k2, v2);
        putAndWarnDuplicateKeys(hashMap, k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m53514of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        HashMap hashMap = new HashMap();
        putAndWarnDuplicateKeys(hashMap, k, v);
        putAndWarnDuplicateKeys(hashMap, k2, v2);
        putAndWarnDuplicateKeys(hashMap, k3, v3);
