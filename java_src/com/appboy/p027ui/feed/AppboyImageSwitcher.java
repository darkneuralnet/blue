package com.appboy.p027ui.feed;
...
public class AppboyImageSwitcher extends ImageSwitcher {
    private static final String TAG = C43664k20.m29433n(AppboyImageSwitcher.class);
    ...
    public AppboyImageSwitcher(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            for (int i = 0; i < obtainStyledAttributes.getIndexCount(); i++) {
                ...
                } else if (obtainStyledAttributes.getIndex(i) == R$styleable.f68656x3c8566bc && (drawable = obtainStyledAttributes.getDrawable(index)) != null) {
                    this.mUnReadIcon = drawable;
                }
            }
            obtainStyledAttributes.recycle();
        } catch (Exception e) {
            C43664k20.m29450A(TAG, "Error while checking for custom drawable.", e);
        }
    }
