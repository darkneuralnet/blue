...
import com.fasterxml.jackson.core.p030io.JsonEOFException;
...
public abstract class ParserMinimalBase extends JsonParser {
    ...
    public String _longIntegerDesc(String str) {
        ...
        if (str.startsWith(Detail.EMPTY_CHAR)) {
            length--;
        }
    ...
    public void reportOverflowLong(String str, JsonToken jsonToken) throws IOException {
        _reportInputCoercion(String.format("Numeric value (%s) out of range of long (%d - %s)", _longIntegerDesc(str), Long.MIN_VALUE, Long.valueOf((long) LongCompanionObject.MAX_VALUE)), jsonToken, Long.TYPE);
    }
