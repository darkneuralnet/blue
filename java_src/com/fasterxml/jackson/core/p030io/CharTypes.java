...
public final class CharTypes {
    ...
    /* renamed from: HB */
    protected static final byte[] f69945HB;

    /* renamed from: HC */
    protected static final char[] f69946HC;
    ...
    static {
        ...
        f69945HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f69945HB[i2] = (byte) f69946HC[i2];
        }
    ...
    public static int charToHex(int i) {
        return sHexValues[i & KotlinVersion.MAX_COMPONENT_VALUE];
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f69945HB.clone();
    }

    public static char[] copyHexChars() {
        return (char[]) f69946HC.clone();
    }
