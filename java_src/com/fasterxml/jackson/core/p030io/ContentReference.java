...
public class ContentReference implements Serializable {
    ...
    public String buildSourceDescription() {
        return appendSourceDescription(new StringBuilder((int) C11925l.AbstractC11930e.DEFAULT_DRAG_ANIMATION_DURATION)).toString();
    }
    ...
    public String _truncate(byte[] bArr, int[] iArr, int i) {
        ...
        return new String(bArr, iArr[0], Math.min(iArr[1], i), Charset.forName(Constants.DEFAULT_ENCODING));
    }
}
