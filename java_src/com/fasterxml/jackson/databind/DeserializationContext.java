...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C173791 {
    ...
    private TreeTraversingParser _treeAsTokens(JsonNode jsonNode) throws IOException {
        ...
        TreeTraversingParser treeTraversingParser = new TreeTraversingParser(jsonNode, codec);
    ...
    public String _shapeForToken(JsonToken jsonToken) {
        if (jsonToken != null) {
            switch (C173791.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()]) {
                case 1:
                case 2:
                case 3:
                    return "Object value";
