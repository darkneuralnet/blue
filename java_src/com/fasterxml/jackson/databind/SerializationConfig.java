...
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> {
    ...
    private SerializationConfig _withJsonWriteFeatures(FormatFeature... formatFeatureArr) {
        ...
        if (this._formatWriteFeatures == i5 && this._formatWriteFeaturesToChange == i6 && this._generatorFeatures == i7 && this._generatorFeaturesToChange == i4) {
            return this;
        }
        return new SerializationConfig(this, this._mapperFeatures, this._serFeatures, i7, i4, i5, i6);
    }
