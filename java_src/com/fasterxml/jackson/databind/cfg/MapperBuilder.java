...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B activateDefaultTyping(PolymorphicTypeValidator polymorphicTypeValidator, ObjectMapper.DefaultTyping defaultTyping, JsonTypeInfo.EnumC17376As enumC17376As) {
        this._mapper.activateDefaultTyping(polymorphicTypeValidator, defaultTyping, enumC17376As);
        return _this();
    }
