...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C173931 {

        /* renamed from: $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion */
        static final /* synthetic */ int[] f69965xfdbfedae;

        static {
            int[] iArr = new int[JsonSerialize.Inclusion.values().length];
            f69965xfdbfedae = iArr;
            try {
                iArr[JsonSerialize.Inclusion.ALWAYS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f69965xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f69965xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f69965xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f69965xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C173931.f69965xfdbfedae[jsonSerialize.include().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
    ...
    public TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC17377Id.NONE) {
        ...
        JsonTypeInfo.EnumC17376As include = jsonTypeInfo.include();
        if (include == JsonTypeInfo.EnumC17376As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = JsonTypeInfo.EnumC17376As.PROPERTY;
        }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (jsonDeserialize == null) {
            ...
            _classIfExplicit = _classIfExplicit(jsonDeserialize.m52071as());
        }
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (jsonDeserialize == null) {
                ...
                _classIfExplicit2 = _classIfExplicit(jsonDeserialize.keyAs());
            }
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (jsonSerialize == null) {
            ...
            _classIfExplicit = _classIfExplicit(jsonSerialize.m52070as());
        }
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (jsonSerialize == null) {
                ...
                _classIfExplicit2 = _classIfExplicit(jsonSerialize.keyAs());
            }
                ...
                if (contentType.hasRawClass(cls)) {
                    ...
                    try {
                        if (cls.isAssignableFrom(rawClass3)) {
                            withStaticTyping = typeFactory.constructGeneralizedType(contentType, cls);
                        } else if (rawClass3.isAssignableFrom(cls)) {
                            withStaticTyping = typeFactory.constructSpecializedType(contentType, cls);
