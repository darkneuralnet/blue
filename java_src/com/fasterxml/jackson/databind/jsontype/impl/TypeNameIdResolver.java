...
public class TypeNameIdResolver extends TypeIdResolverBase {
        ...
        if (z != z2) {
            ...
            if (collection != null) {
                for (NamedType namedType : collection) {
                    ...
                    if (z) {
                        concurrentHashMap.put(type.getName(), _defaultTypeId);
                    }
                    if (z2) {
                        if (isEnabled) {
                            _defaultTypeId = _defaultTypeId.toLowerCase();
                        }
                        JavaType javaType2 = (JavaType) hashMap.get(_defaultTypeId);
    ...
    public JsonTypeInfo.EnumC17377Id getMechanism() {
        return JsonTypeInfo.EnumC17377Id.NAME;
    }
