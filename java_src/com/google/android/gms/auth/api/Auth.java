...
public final class Auth {
    ...
    public static final Api.ClientKey<M77> zba;
    public static final Api.ClientKey<zbe> zbb;
    private static final Api.AbstractClientBuilder<M77, AuthCredentialsOptions> zbc;
    ...
    static {
        Api.ClientKey<M77> clientKey = new Api.ClientKey<>();
        zba = clientKey;
