...
public class Credential extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getName", m51606id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getProfilePictureUri", m51606id = 3)
    private final Uri zbc;
    @SafeParcelable.Field(getter = "getIdTokens", m51606id = 4)
    private final List<IdToken> zbd;
    @SafeParcelable.Field(getter = "getPassword", m51606id = 5)
    private final String zbe;
    @SafeParcelable.Field(getter = "getAccountType", m51606id = 6)
    private final String zbf;
    @SafeParcelable.Field(getter = "getGivenName", m51606id = 9)
    private final String zbg;
    @SafeParcelable.Field(getter = "getFamilyName", m51606id = 10)
    ...
    public Credential(@SafeParcelable.Param(m51605id = 1) String str, @SafeParcelable.Param(m51605id = 2) String str2, @SafeParcelable.Param(m51605id = 3) Uri uri, @SafeParcelable.Param(m51605id = 4) List<IdToken> list, @SafeParcelable.Param(m51605id = 5) String str3, @SafeParcelable.Param(m51605id = 6) String str4, @SafeParcelable.Param(m51605id = 9) String str5, @SafeParcelable.Param(m51605id = 10) String str6) {
