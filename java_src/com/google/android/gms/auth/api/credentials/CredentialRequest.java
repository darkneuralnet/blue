...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    final int zba;
    @SafeParcelable.Field(getter = "isPasswordLoginSupported", m51606id = 1)
    private final boolean zbb;
    @SafeParcelable.Field(getter = "getAccountTypes", m51606id = 2)
    private final String[] zbc;
    @SafeParcelable.Field(getter = "getCredentialPickerConfig", m51606id = 3)
    private final CredentialPickerConfig zbd;
    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", m51606id = 4)
    ...
    @SafeParcelable.Field(getter = "getRequireUserMediation", m51606id = 8)
    ...
    public CredentialRequest(@SafeParcelable.Param(m51605id = 1000) int i, @SafeParcelable.Param(m51605id = 1) boolean z, @SafeParcelable.Param(m51605id = 2) String[] strArr, @SafeParcelable.Param(m51605id = 3) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(m51605id = 4) CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(m51605id = 5) boolean z2, @SafeParcelable.Param(m51605id = 6) String str, @SafeParcelable.Param(m51605id = 7) String str2, @SafeParcelable.Param(m51605id = 8) boolean z3) {
        this.zba = i;
        this.zbb = z;
