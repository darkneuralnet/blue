...
public class SaveAccountLinkingTokenRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsentPendingIntent", m51606id = 1)
    private final PendingIntent zba;
    @SafeParcelable.Field(getter = "getTokenType", m51606id = 2)
    ...
    @SafeParcelable.Field(getter = "getSessionId", m51606id = 5)
    ...
    public SaveAccountLinkingTokenRequest(@SafeParcelable.Param(m51605id = 1) PendingIntent pendingIntent, @SafeParcelable.Param(m51605id = 2) String str, @SafeParcelable.Param(m51605id = 3) String str2, @SafeParcelable.Param(m51605id = 4) List<String> list, @SafeParcelable.Param(m51605id = 5) String str3) {
        this.zba = pendingIntent;
        this.zbb = str;
        this.zbc = str2;
        this.zbd = list;
