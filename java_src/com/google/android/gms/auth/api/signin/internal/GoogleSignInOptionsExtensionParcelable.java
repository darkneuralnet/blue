...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    private int zab;
    @SafeParcelable.Field(getter = "getBundle", m51606id = 3)
    private Bundle zac;

    @SafeParcelable.Constructor
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) int i2, @SafeParcelable.Param(m51605id = 3) Bundle bundle) {
        this.zaa = i;
        this.zab = i2;
        this.zac = bundle;
    }
