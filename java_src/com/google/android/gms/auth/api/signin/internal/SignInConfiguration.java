...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", m51606id = 2)
    private final String zba;
    @SafeParcelable.Field(getter = "getGoogleConfig", m51606id = 5)
    private GoogleSignInOptions zbb;

    @SafeParcelable.Constructor
    public SignInConfiguration(@SafeParcelable.Param(m51605id = 2) String str, @SafeParcelable.Param(m51605id = 5) GoogleSignInOptions googleSignInOptions) {
