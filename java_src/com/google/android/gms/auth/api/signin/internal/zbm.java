...
public final class zbm {
    ...
    public static Intent zba(Context context, GoogleSignInOptions googleSignInOptions) {
        zba.m51602d("getFallbackSignInIntent()", new Object[0]);
    ...
    public static Intent zbb(Context context, GoogleSignInOptions googleSignInOptions) {
        zba.m51602d("getNoImplementationSignInIntent()", new Object[0]);
        Intent zbc = zbc(context, googleSignInOptions);
    ...
    public static Intent zbc(Context context, GoogleSignInOptions googleSignInOptions) {
        zba.m51602d("getSignInIntent()", new Object[0]);
    ...
    */
    public static OptionalPendingResult<GoogleSignInResult> zbe(GoogleApiClient googleApiClient, Context context, GoogleSignInOptions googleSignInOptions, boolean z) {
        ...
        Logger logger = zba;
        logger.m51602d("silentSignIn()", new Object[0]);
        logger.m51602d("getEligibleSavedSignInResult()", new Object[0]);
            ...
            if (account != null ? account.equals(account2) : account2 == null) {
                if (!googleSignInOptions.isServerAuthCodeRequested() && ((!googleSignInOptions.isIdTokenRequested() || (zbb.isIdTokenRequested() && Objects.equal(googleSignInOptions.getServerClientId(), zbb.getServerClientId()))) && new HashSet(zbb.getScopes()).containsAll(new HashSet(googleSignInOptions.getScopes())) && (zba2 = zbn.zbc(context).zba()) != null && !zba2.isExpired())) {
                    ...
                    if (googleSignInResult == null) {
                        logger.m51602d("Eligible saved sign in result found", new Object[0]);
                        ...
                        logger.m51602d("trySilentSignIn()", new Object[0]);
    ...
    public static PendingResult<Status> zbf(GoogleApiClient googleApiClient, Context context, boolean z) {
        zba.m51602d("Revoking access", new Object[0]);
    ...
    public static PendingResult<Status> zbg(GoogleApiClient googleApiClient, Context context, boolean z) {
        zba.m51602d("Signing out", new Object[0]);
        zbh(context);
        if (z) {
