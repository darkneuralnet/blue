...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    final int zza;
    @SafeParcelable.Field(getter = "getErrorCode", m51606id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getResolution", m51606id = 3)
    private final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", m51606id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) int i2, @SafeParcelable.Param(m51605id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m51605id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
