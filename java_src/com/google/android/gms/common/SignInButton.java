...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C36396Ul4.SignInButton, 0, 0);
        try {
            this.zaa = obtainStyledAttributes.getInt(C36396Ul4.SignInButton_buttonSize, 0);
            this.zab = obtainStyledAttributes.getInt(C36396Ul4.SignInButton_colorScheme, 2);
