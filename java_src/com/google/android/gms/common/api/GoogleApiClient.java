...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            this.zah = new C28385so();
            this.zaj = new C28385so();
            this.zal = -1;
            this.zao = GoogleApiAvailability.getInstance();
            this.zap = NP6.f24554c;
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                c28385so.put(api2, Boolean.valueOf(z2));
                ...
                c28385so2.put(api2.zab(), buildClient);
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, c28385so, this.zaq, this.zar, c28385so2, this.zal, zabe.zad(c28385so2.values(), true), arrayList);
        ...
        public final ClientSettings zaa() {
            ...
            if (map.containsKey(api)) {
                ga5 = (GA5) this.zaj.get(api);
            }
            return new ClientSettings(this.zaa, this.zab, this.zah, this.zad, this.zae, this.zaf, this.zag, ga5, false);
        }
