...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zar = new C30704yo();
    private final Set zas = new C30704yo();

    @KeepForSdk
    private GoogleApiManager(Context context, Looper looper, GoogleApiAvailability googleApiAvailability) {
        this.zau = true;
        this.zak = context;
        HandlerC47452qQ6 handlerC47452qQ6 = new HandlerC47452qQ6(looper, this);
        this.zat = handlerC47452qQ6;
        this.zal = googleApiAvailability;
        this.zam = new com.google.android.gms.common.internal.zal(googleApiAvailability);
        if (DeviceProperties.isAuto(context)) {
            this.zau = false;
        }
        handlerC47452qQ6.sendMessage(handlerC47452qQ6.obtainMessage(6));
    }
