...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    @SafeParcelable.Field(defaultValueUnchecked = "0", m51606id = 1)
    public final int uid;

    @SafeParcelable.Constructor
    public ClientIdentity(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) String str) {
        this.uid = i;
