...
public class ModuleInstallResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", getter = "getShouldUnregisterListener", m51606id = 2)
    ...
    public ModuleInstallResponse(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) boolean z) {
        this.zaa = i;
        this.zab = z;
    }
}
