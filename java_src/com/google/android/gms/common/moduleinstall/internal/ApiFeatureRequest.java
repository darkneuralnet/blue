...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getApiFeatures", m51606id = 1)
    private final List zab;
    @SafeParcelable.Field(getter = "getIsUrgent", m51606id = 2)
    private final boolean zac;
    @SafeParcelable.Field(getter = "getFeatureRequestSessionId", m51606id = 3)
    private final String zad;
    @SafeParcelable.Field(getter = "getCallingPackage", m51606id = 4)
    private final String zae;

    @SafeParcelable.Constructor
    public ApiFeatureRequest(@SafeParcelable.Param(m51605id = 1) List list, @SafeParcelable.Param(m51605id = 2) boolean z, @SafeParcelable.Param(m51605id = 3) String str, @SafeParcelable.Param(m51605id = 4) String str2) {
