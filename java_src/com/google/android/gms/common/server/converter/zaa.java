...
public final class zaa extends AbstractSafeParcelable {
    ...
    final int zaa;
    @SafeParcelable.Field(getter = "getStringToIntConverter", m51606id = 2)
    private final StringToIntConverter zab;

    @SafeParcelable.Constructor
    public zaa(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) StringToIntConverter stringToIntConverter) {
        this.zaa = i;
