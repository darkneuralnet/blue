...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m51606id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) ArrayList arrayList, @SafeParcelable.Param(m51605id = 3) String str) {
        this.zaa = i;
