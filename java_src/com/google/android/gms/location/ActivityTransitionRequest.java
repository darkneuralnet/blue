...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityTransitions", m51606id = 1)
    private final List<ActivityTransition> zza;
    @SafeParcelable.Field(getter = "getTag", m51606id = 2)
    private final String zzb;
    @SafeParcelable.Field(getter = "getClients", m51606id = 3)
    private final List<ClientIdentity> zzc;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getContextAttributionTag", m51606id = 4)
    private String zzd;
    ...
    public ActivityTransitionRequest(@SafeParcelable.Param(m51605id = 1) List<ActivityTransition> list, @SafeParcelable.Param(m51605id = 2) String str, @SafeParcelable.Param(m51605id = 3) List<ClientIdentity> list2, @SafeParcelable.Param(m51605id = 4) String str2) {
