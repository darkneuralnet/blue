...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", m51606id = 1)
    private final List<com.google.android.gms.internal.location.zzbe> zza;
    @InitialTrigger
    @SafeParcelable.Field(getter = "getInitialTrigger", m51606id = 2)
    private final int zzb;
    @SafeParcelable.Field(defaultValue = "", getter = "getTag", m51606id = 3)
    private final String zzc;
    @SafeParcelable.Field(getter = "getContextAttributionTag", m51606id = 4)
    ...
    public GeofencingRequest(@SafeParcelable.Param(m51605id = 1) List<com.google.android.gms.internal.location.zzbe> list, @SafeParcelable.Param(m51605id = 2) @InitialTrigger int i, @SafeParcelable.Param(m51605id = 3) String str, @SafeParcelable.Param(m51605id = 4) String str2) {
        this.zza = list;
        this.zzb = i;
        this.zzc = str;
        this.zzd = str2;
