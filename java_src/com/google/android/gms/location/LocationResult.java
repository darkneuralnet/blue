...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    @SafeParcelable.Field(defaultValueUnchecked = "LocationResult.DEFAULT_LOCATIONS", getter = "getLocations", m51606id = 1)
    ...
    public LocationResult(@SafeParcelable.Param(m51605id = 1) List<Location> list) {
        this.zzb = list;
    }
