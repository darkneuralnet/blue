...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getLocationSettingsStates", m51606id = 2)
    private final LocationSettingsStates zzb;

    @SafeParcelable.Constructor
    public LocationSettingsResult(@SafeParcelable.Param(m51605id = 1) Status status, @SafeParcelable.Param(m51605id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
