...
public class SleepClassifyEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTimestampSec", m51606id = 1)
    private final int zza;
    @SafeParcelable.Field(getter = "getConfidence", m51606id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getMotion", m51606id = 3)
    private final int zzc;
    @SafeParcelable.Field(getter = "getLight", m51606id = 4)
    private final int zzd;
    @SafeParcelable.Field(getter = "getNoise", m51606id = 5)
    private final int zze;
    @SafeParcelable.Field(getter = "getLightDiff", m51606id = 6)
    private final int zzf;
    @SafeParcelable.Field(getter = "getNightOrDay", m51606id = 7)
    private final int zzg;
    @SafeParcelable.Field(getter = "getConfidenceOverwrittenByAlarmClockTrigger", m51606id = 8)
    private final boolean zzh;
    @SafeParcelable.Field(getter = "getPresenceConfidence", m51606id = 9)
    private final int zzi;

    @ShowFirstParty
    @SafeParcelable.Constructor
    public SleepClassifyEvent(@SafeParcelable.Param(m51605id = 1) int i, @SafeParcelable.Param(m51605id = 2) int i2, @SafeParcelable.Param(m51605id = 3) int i3, @SafeParcelable.Param(m51605id = 4) int i4, @SafeParcelable.Param(m51605id = 5) int i5, @SafeParcelable.Param(m51605id = 6) int i6, @SafeParcelable.Param(m51605id = 7) int i7, @SafeParcelable.Param(m51605id = 8) boolean z, @SafeParcelable.Param(m51605id = 9) int i8) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = i4;
