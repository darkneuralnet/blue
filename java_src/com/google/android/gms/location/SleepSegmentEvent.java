...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStartTimeMillis", m51606id = 1)
    private final long zza;
    @SafeParcelable.Field(getter = "getEndTimeMillis", m51606id = 2)
    private final long zzb;
    @SafeParcelable.Field(getter = "getStatus", m51606id = 3)
    private final int zzc;
    @SafeParcelable.Field(getter = "getMissingDataDurationMinutes", m51606id = 4)
    private final int zzd;
    @SafeParcelable.Field(getter = "getNinetiethPctConfidence", m51606id = 5)
    private final int zze;

    @ShowFirstParty
    @SafeParcelable.Constructor
    public SleepSegmentEvent(@SafeParcelable.Param(m51605id = 1) long j, @SafeParcelable.Param(m51605id = 2) long j2, @SafeParcelable.Param(m51605id = 3) int i, @SafeParcelable.Param(m51605id = 4) int i2, @SafeParcelable.Param(m51605id = 5) int i3) {
        boolean z;
        if (j <= j2) {
            z = true;
        } else {
