...
public final class PlaceFilter extends com.google.android.gms.location.places.zzb {
    ...
    private PlaceFilter(Collection<Integer> collection, boolean z, Collection<String> collection2, Collection<zzp> collection3) {
        this((List<Integer>) com.google.android.gms.location.places.zzb.zzb((Collection) null), z, (List<String>) com.google.android.gms.location.places.zzb.zzb(collection2), (List<zzp>) com.google.android.gms.location.places.zzb.zzb((Collection) null));
    }

    @SafeParcelable.Constructor
    public PlaceFilter(@SafeParcelable.Param(m51605id = 1) List<Integer> list, @SafeParcelable.Param(m51605id = 3) boolean z, @SafeParcelable.Param(m51605id = 6) List<String> list2, @SafeParcelable.Param(m51605id = 4) List<zzp> list3) {
        this.zzs = list;
        this.zzt = z;
        this.zzu = list3;
        this.zzv = list2;
        this.zzw = com.google.android.gms.location.places.zzb.zzb((List) list);
        this.zzx = com.google.android.gms.location.places.zzb.zzb((List) list3);
        this.zzy = com.google.android.gms.location.places.zzb.zzb((List) list2);
    }
}
