...
public class PlaceAutocomplete extends zzb {
    ...
    public static class IntentBuilder extends zzc {
        public IntentBuilder(int i) {
            ...
            this.intent.putExtra(AnalyticsRequestV2.HEADER_ORIGIN, 2);
        }

        @Override // com.google.android.gms.location.places.p032ui.zzc
        ...
        public final IntentBuilder zzd(int i) {
            this.intent.putExtra(AnalyticsRequestV2.HEADER_ORIGIN, 1);
            return this;
        }
