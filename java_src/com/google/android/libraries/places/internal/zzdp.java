...
public final class zzdp implements zzbn {
    ...
    public static final /* synthetic */ FetchPlaceResponse zzi(Task task) throws Exception {
        ...
        if (!PlacesStatusCodes.isError(zza)) {
            ...
            if (strArr != null) {
                zzhsVar = zzhs.zzl(strArr);
            } else {
                zzhsVar = null;
            }
            return FetchPlaceResponse.newInstance(zzds.zzc(zzdvVar, zzhsVar));
        }
                ...
                for (zzdu zzduVar : zzduVarArr) {
                    if (zzduVar.zza() != null) {
                        ...
                        if (zzb != null) {
                            ...
                            arrayList.add(PlaceLikelihood.newInstance(zzds.zzc(zza2, zzhsVar), zzb.doubleValue()));
                        } else {
