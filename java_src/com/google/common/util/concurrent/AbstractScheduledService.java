...
public abstract class AbstractScheduledService implements Service {
    ...
    public static abstract class CustomScheduler extends Scheduler {
        ...
        public static final class Schedule {
            ...
            public Schedule(long j, TimeUnit timeUnit) {
                this.delay = j;
                this.unit = (TimeUnit) EZ3.m108801n(timeUnit);
            }
        }
    ...
    public static abstract class Scheduler {
        public static Scheduler newFixedDelaySchedule(final long j, final long j2, final TimeUnit timeUnit) {
            ...
            EZ3.m108807h(z, "delay must be > 0, found %s", j2);
        ...
        public static Scheduler newFixedRateSchedule(final long j, final long j2, final TimeUnit timeUnit) {
            ...
            EZ3.m108807h(z, "period must be > 0, found %s", j2);
    ...
    public final class ServiceDelegate extends AbstractService {
        ...
        public final void doStart() {
            this.executorService = MoreExecutors.renamingDecorator(AbstractScheduledService.this.executor(), new YU5<String>() { // from class: com.google.common.util.concurrent.AbstractScheduledService.ServiceDelegate.1
                @Override // p000.YU5
                public String get() {
