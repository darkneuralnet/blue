...
public abstract class AbstractService implements Service {
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C180776 {
    ...
    public static final class StateSnapshot {
        ...
        public Throwable failureCause() {
            ...
            EZ3.m108792w(z, "failureCause() is only valid if the service has failed, service is %s", state);
        ...
        public StateSnapshot(Service.State state, boolean z, Throwable th) {
            EZ3.m108805j(!z || state == Service.State.STARTING, "shutdownWhenStartupFinishes can only be set if state is STARTING. Got %s instead.", state);
            EZ3.m108804k((th != null) == (state == Service.State.FAILED), "A failure cause should be set if and only if the state is failed.  Got %s and %s instead.", state, th);
            this.state = state;
    ...
    private void enqueueTerminatedEvent(Service.State state) {
        switch (C180776.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
            case 1:
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            ...
            int i = C180776.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i != 2 && i != 3 && i != 4) {
                    if (i != 5) {
                    }
