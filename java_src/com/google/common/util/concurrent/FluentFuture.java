...
public abstract class FluentFuture<V> extends GwtFluentFutureCatchingSpecialization<V> {
    ...
    public final <X extends Throwable> FluentFuture<V> catching(Class<X> cls, InterfaceC50859wA1<? super X, ? extends V> interfaceC50859wA1, Executor executor) {
        return (FluentFuture) Futures.catching(this, cls, interfaceC50859wA1, executor);
    }
    ...
    public final <T> FluentFuture<T> transform(InterfaceC50859wA1<? super V, T> interfaceC50859wA1, Executor executor) {
        return (FluentFuture) Futures.transform(this, interfaceC50859wA1, executor);
    }
    ...
    public static <V> FluentFuture<V> from(FluentFuture<V> fluentFuture) {
        return (FluentFuture) EZ3.m108801n(fluentFuture);
    }
}
