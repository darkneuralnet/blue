...
public final class MoreExecutors {
    ...
    public static class ListeningDecorator extends AbstractListeningExecutorService {
        ...
        public ListeningDecorator(ExecutorService executorService) {
            this.delegate = (ExecutorService) EZ3.m108801n(executorService);
        }
    ...
    public static final class ScheduledListeningDecorator extends ListeningDecorator implements ListeningScheduledExecutorService {
        ...
        public static final class NeverSuccessfulListenableFutureTask extends AbstractFuture.TrustedFuture<Void> implements Runnable {
            ...
            public NeverSuccessfulListenableFutureTask(Runnable runnable) {
                this.delegate = (Runnable) EZ3.m108801n(runnable);
            }
        ...
        public ScheduledListeningDecorator(ScheduledExecutorService scheduledExecutorService) {
            ...
            this.delegate = (ScheduledExecutorService) EZ3.m108801n(scheduledExecutorService);
        }
    ...
    */
    public static <T> T invokeAnyImpl(ListeningExecutorService listeningExecutorService, Collection<? extends Callable<T>> collection, boolean z, long j, TimeUnit timeUnit) throws InterruptedException, ExecutionException, TimeoutException {
        ...
        EZ3.m108811d(z2);
        ArrayList<Future> m93252j = C34819Ns2.m93252j(size);
        LinkedBlockingQueue m36131b = C42233hd4.m36131b();
        long nanos = timeUnit.toNanos(j);
        if (z) {
            try {
                nanoTime = System.nanoTime();
            } catch (Throwable th) {
                for (Future future : m93252j) {
                    future.cancel(true);
                }
                throw th;
            }
        ...
        m93252j.add(submitAndAddQueueListener(listeningExecutorService, it.next(), m36131b));
        int i = size - 1;
        int i2 = 1;
        ExecutionException executionException = null;
        while (true) {
            Future future2 = (Future) m36131b.poll();
            if (future2 == null) {
                if (i > 0) {
                    i--;
                    m93252j.add(submitAndAddQueueListener(listeningExecutorService, it.next(), m36131b));
                    ...
                    future2 = (Future) m36131b.poll(nanos, TimeUnit.NANOSECONDS);
                    if (future2 != null) {
                        j2 = System.nanoTime();
                        nanos -= j2 - nanoTime;
                        long j3 = nanos;
    ...
    public static Executor renamingDecorator(final Executor executor, final YU5<String> yu5) {
        EZ3.m108801n(executor);
        EZ3.m108801n(yu5);
        return new Executor() { // from class: com.google.common.util.concurrent.MoreExecutors.2
            @Override // java.util.concurrent.Executor
            public void execute(Runnable runnable) {
                executor.execute(Callables.threadRenaming(runnable, yu5));
            }
        };
    }
    ...
    public static ExecutorService renamingDecorator(ExecutorService executorService, final YU5<String> yu5) {
        EZ3.m108801n(executorService);
        EZ3.m108801n(yu5);
        return new WrappingExecutorService(executorService) { // from class: com.google.common.util.concurrent.MoreExecutors.3
            ...
            public <T> Callable<T> wrapTask(Callable<T> callable) {
                return Callables.threadRenaming(callable, yu5);
            }

            @Override // com.google.common.util.concurrent.WrappingExecutorService
            public Runnable wrapTask(Runnable runnable) {
                return Callables.threadRenaming(runnable, yu5);
            }
        };
    }
    ...
    public static ScheduledExecutorService renamingDecorator(ScheduledExecutorService scheduledExecutorService, final YU5<String> yu5) {
        EZ3.m108801n(scheduledExecutorService);
        EZ3.m108801n(yu5);
