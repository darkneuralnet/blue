...
public abstract class SmoothRateLimiter extends RateLimiter {
    ...
    public final long reserveEarliestAvailable(int i, long j) {
        ...
        this.nextFreeTicketMicros = C43637jz2.m29524a(this.nextFreeTicketMicros, storedPermitsToWaitTime(this.storedPermits, min) + ((long) ((d - min) * this.stableIntervalMicros)));
