...
abstract class WrappingExecutorService implements ExecutorService {
    ...
    private <T> VY1<Callable<T>> wrapTasks(Collection<? extends Callable<T>> collection) {
        VY1.C8672a m79771u = VY1.m79771u();
        for (Callable<T> callable : collection) {
            m79771u.mo42771d(wrapTask(callable));
        }
        return m79771u.m79763j();
    }
    ...
    public final <T> Future<T> submit(Callable<T> callable) {
        return this.delegate.submit(wrapTask((Callable) EZ3.m108801n(callable)));
    }
