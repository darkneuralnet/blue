...
public class CommonUtils {
    ...
    public enum Architecture {
        ...
        public static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().m47335v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().m47338e(str, e);
            }
        }
    }
    ...
    public static String createInstanceIdFrom(String... strArr) {
        ...
        for (String str : strArr) {
            if (str != null) {
                arrayList.add(str.replace(Detail.EMPTY_CHAR, "").toLowerCase(Locale.US));
            }
        }
    ...
    */
                ...
                while (true) {
                    try {
                        try {
                            ...
                            e = e;
                            Logger.getLogger().m47338e("Error parsing " + file, e);
    ...
    public static List<BuildIdInfo> getBuildIdInfo(Context context) {
        ...
        if (resourcesIdentifier != 0 && resourcesIdentifier2 != 0 && resourcesIdentifier3 != 0) {
            ...
            Logger.getLogger().m47341d(String.format("Lengths did not match: %d %d %d", Integer.valueOf(stringArray.length), Integer.valueOf(stringArray2.length), Integer.valueOf(stringArray3.length)));
            return arrayList;
        }
        Logger.getLogger().m47341d(String.format("Could not find resources: %d %d %d", Integer.valueOf(resourcesIdentifier), Integer.valueOf(resourcesIdentifier2), Integer.valueOf(resourcesIdentifier3)));
        return arrayList;
    }
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.m47333w("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                        j2 = convertMemInfoToBytes;
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.m47338e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.m47338e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
}
