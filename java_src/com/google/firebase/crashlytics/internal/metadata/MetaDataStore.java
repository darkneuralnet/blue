...
public class MetaDataStore {
    ...
    private static void safeDeleteCorruptFile(File file) {
        if (file.exists() && file.delete()) {
            ...
            logger.m47337i("Deleted corrupt file: " + file.getAbsolutePath());
        }
    }
    ...
    public String readUserId(String str) {
        ...
        if (userDataFileForSession.exists() && userDataFileForSession.length() != 0) {
            try {
                ...
                try {
                    try {
                        ...
                        Logger.getLogger().m47341d("Loaded userId " + jsonToUserId + " for session " + str);
                        CommonUtils.closeOrLog(fileInputStream, "Failed to close user metadata file.");
                        return jsonToUserId;
                    } catch (Exception e) {
                        e = e;
                        Logger.getLogger().m47332w("Error deserializing user metadata.", e);
            ...
            Logger.getLogger().m47341d("No userId set for session " + str);
            safeDeleteCorruptFile(userDataFileForSession);
            return null;
        }
    }
    ...
    public void writeUserData(String str, String str2) {
        ...
        try {
            ...
            Logger.getLogger().m47332w("Error serializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map, boolean z) {
        ...
        try {
            ...
            e = e2;
            bufferedWriter2 = bufferedWriter;
            Logger.getLogger().m47332w("Error serializing key/value metadata.", e);
            safeDeleteCorruptFile(internalKeysFileForSession);
