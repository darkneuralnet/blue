...
final class C18299xb26d2aa8 extends CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch {
    ...
    public static final class Builder extends CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch.Builder {
        ...
        public CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch build() {
            ...
            if (str.isEmpty()) {
                return new C18299xb26d2aa8(this.arch, this.libraryName, this.buildId);
            }
    ...
    private C18299xb26d2aa8(String str, String str2, String str3) {
        this.arch = str;
