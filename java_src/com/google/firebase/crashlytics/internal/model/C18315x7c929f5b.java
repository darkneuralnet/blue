...
final class C18315x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            if (str.isEmpty()) {
                return new C18315x7c929f5b(this.name, this.code, this.address.longValue());
            }
    ...
    private C18315x7c929f5b(String str, String str2, long j) {
        this.name = str;
        this.code = str2;
        this.address = j;
    }
