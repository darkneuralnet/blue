...
public class CrashlyticsReportJsonTransform {
    private static final HS0 CRASHLYTICS_REPORT_JSON_ENCODER = new C47618qi2().m17220j(AutoCrashlyticsReportEncoder.CONFIG).m17219k(true).m17221i();
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setFrames(parseArray(jsonReader, new C18325a()));
                    break;
                case 1:
