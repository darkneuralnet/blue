...
public class FileStore {
    ...
    private void cleanupDir(File file) {
        if (file.exists() && recursiveDelete(file)) {
            ...
            logger.m47341d("Deleted previous Crashlytics file system: " + file.getPath());
        }
    }
    ...
    private static synchronized File prepareBaseDir(File file) {
        synchronized (FileStore.class) {
            if (file.exists()) {
                ...
                Logger logger = Logger.getLogger();
                logger.m47341d("Unexpected non-directory file: " + file + "; deleting file and creating new directory.");
                file.delete();
            }
            if (!file.mkdirs()) {
                Logger logger2 = Logger.getLogger();
                logger2.m47339e("Could not create Crashlytics-specific directory: " + file);
            }
            return file;
        }
    }
