...
public class JsonReader implements Closeable {
    ...
    static {
        AbstractC41698gj2.INSTANCE = new AbstractC41698gj2() { // from class: com.google.gson.stream.JsonReader.1
            @Override // p000.AbstractC41698gj2
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof C50591vj2) {
                    ((C50591vj2) jsonReader).m8231g();
                    return;
                }
