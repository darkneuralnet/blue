...
public class Frame {
    ...
    public <T extends Trackable> Collection<T> getUpdatedTrackables(Class<T> cls) {
        ...
        return this.session.convertNativeTrackablesToCollection(cls, nativeAcquireUpdatedTrackables(this.session.nativeWrapperHandle, this.nativeHandle, m48434a.f73785j));
    }
