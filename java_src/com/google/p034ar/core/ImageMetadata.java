...
public class ImageMetadata {
    ...
    private final C18006n sketchEntry;
    ...
    private void getMetdataEntry(int i, C18006n c18006n) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        c18006n.f73818a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            c18006n.f73819b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            c18006n.f73820c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, c18006n.f73818a);
            return;
        }
    ...
    public byte getByte(int i) throws MetadataNotFoundException {
        ...
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 0 && c18006n.f73820c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public byte[] getByteArray(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public double getDouble(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 4 && c18006n.f73820c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public double[] getDoubleArray(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public float getFloat(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 2 && c18006n.f73820c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public float[] getFloatArray(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public int getInt(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 1 && c18006n.f73820c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public int[] getIntArray(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public long getLong(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 3 && c18006n.f73820c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f73819b), Integer.valueOf(this.sketchEntry.f73820c)));
    }

    public long[] getLongArray(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public Rational getRational(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 5 && c18006n.f73820c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
    ...
    public Rational[] getRationalArray(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        C18006n c18006n = this.sketchEntry;
        if (c18006n.f73819b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, c18006n.f73818a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f73818a);
