...
public final class FinancialConnectionsSheetViewModel$onNativeAuthFlowResult$1 extends Lambda implements Function1<FinancialConnectionsSheetState, Unit> {
    ...
    public FinancialConnectionsSheetViewModel$onNativeAuthFlowResult$1(FinancialConnectionsSheetViewModel financialConnectionsSheetViewModel, FinancialConnectionsSheetActivityResult financialConnectionsSheetActivityResult) {
        super(1);
    ...
    public final void invoke2(FinancialConnectionsSheetState it) {
        ...
        this.this$0.finishWithResult(it, this.$result);
    }
}
