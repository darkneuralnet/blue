...
@DebugMetadata(m28419c = "com.stripe.android.financialconnections.FinancialConnectionsSheetViewModel$onResume$1", m28418f = "FinancialConnectionsSheetViewModel.kt", m28417i = {0, 1}, m28416l = {454, 166}, m28415m = "invokeSuspend", m28414n = {"$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, m28413s = {"L$0", "L$0"})
...
public final class FinancialConnectionsSheetViewModel$onResume$1 extends SuspendLambda implements Function2<ZC0, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    public FinancialConnectionsSheetViewModel$onResume$1(FinancialConnectionsSheetViewModel financialConnectionsSheetViewModel, Continuation<? super FinancialConnectionsSheetViewModel$onResume$1> continuation) {
    ...
    public final Object invoke(ZC0 zc0, Continuation<? super Unit> continuation) {
        return ((FinancialConnectionsSheetViewModel$onResume$1) create(zc0, continuation)).invokeSuspend(Unit.INSTANCE);
    }
                    ...
                    if (i == 2) {
                        ...
                        try {
                            ...
                            if (!financialConnectionsSheetState.getActivityRecreated()) {
                                ...
                                if (i2 != 1) {
                                    if (i2 == 2) {
                                        financialConnectionsSheetViewModel2.setState(FinancialConnectionsSheetViewModel$onResume$1$1$1.INSTANCE);
                                    }
                                } else {
