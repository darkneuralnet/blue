...
public final class FinancialConnectionsSheetViewModel$openAuthFlow$2 extends Lambda implements Function1<FinancialConnectionsSheetState, Unit> {
    ...
    public final void invoke2(FinancialConnectionsSheetState it) {
        ...
        this.this$0.finishWithResult(it, new FinancialConnectionsSheetActivityResult.Failed(new IllegalArgumentException("hostedAuthUrl is required!")));
    }
}
