...
public final class Body$$serializer implements InterfaceC44940mB1<Body> {
    ...
    static {
        ...
        AW3 aw3 = new AW3("com.stripe.android.financialconnections.domain.Body", body$$serializer, 1);
        aw3.m115697k("entries", false);
        descriptor = aw3;
    }
    ...
    public InterfaceC34036Kj2<?>[] childSerializers() {
        return new InterfaceC34036Kj2[]{new C27999ro(EntrySerializer.INSTANCE)};
    }

    @Override // p000.E01
    public Body deserialize(GV0 decoder) {
        Object obj;
        ...
        int i = 1;
        if (mo3298b.mo3290k()) {
            obj = mo3298b.mo3283s(descriptor2, 0, new C27999ro(EntrySerializer.INSTANCE), null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (mo11843q == -1) {
                    ...
                    obj = mo3298b.mo3283s(descriptor2, 0, new C27999ro(EntrySerializer.INSTANCE), obj);
                    i2 |= 1;
                }
            }
            i = i2;
        ...
        return new Body(i, (List) obj, null);
    }
    ...
    public void serialize(InterfaceC48140rb1 encoder, Body value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC34588Ms5 descriptor2 = getDescriptor();
        InterfaceC36464Ut0 mo1149b = encoder.mo1149b(descriptor2);
        Body.write$Self(value, mo1149b, descriptor2);
