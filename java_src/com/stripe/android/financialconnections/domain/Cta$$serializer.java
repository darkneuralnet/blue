...
public final class Cta$$serializer implements InterfaceC44940mB1<Cta> {
    ...
    static {
        ...
        AW3 aw3 = new AW3("com.stripe.android.financialconnections.domain.Cta", cta$$serializer, 2);
    ...
    public InterfaceC34036Kj2<?>[] childSerializers() {
        return new InterfaceC34036Kj2[]{C38330b40.m65021p(Image$$serializer.INSTANCE), MarkdownToHtmlSerializer.INSTANCE};
    }

    @Override // p000.E01
    public Cta deserialize(GV0 decoder) {
        Object obj;
        Object obj2;
        int i;
        ...
        if (mo3298b.mo3290k()) {
            obj = mo3298b.mo3292i(descriptor2, 0, Image$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (mo11843q == -1) {
                    ...
                    obj = mo3298b.mo3292i(descriptor2, 0, Image$$serializer.INSTANCE, obj);
                    i2 |= 1;
                } else if (mo11843q != 1) {
        ...
        return new Cta(i, (Image) obj, (String) obj2, (C38819bt5) null);
    }
    ...
    public void serialize(InterfaceC48140rb1 encoder, Cta value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC34588Ms5 descriptor2 = getDescriptor();
        InterfaceC36464Ut0 mo1149b = encoder.mo1149b(descriptor2);
        Cta.write$Self(value, mo1149b, descriptor2);
