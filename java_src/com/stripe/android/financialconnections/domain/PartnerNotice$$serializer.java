...
public final class PartnerNotice$$serializer implements InterfaceC44940mB1<PartnerNotice> {
    ...
    static {
        ...
        AW3 aw3 = new AW3("com.stripe.android.financialconnections.domain.PartnerNotice", partnerNotice$$serializer, 2);
        aw3.m115697k("partner_icon", false);
        aw3.m115697k(Entry.TYPE_TEXT, false);
        descriptor = aw3;
    }
    ...
    public InterfaceC34036Kj2<?>[] childSerializers() {
        return new InterfaceC34036Kj2[]{Image$$serializer.INSTANCE, MarkdownToHtmlSerializer.INSTANCE};
    }

    @Override // p000.E01
    public PartnerNotice deserialize(GV0 decoder) {
        Object obj;
        Object obj2;
        int i;
        ...
        if (mo3298b.mo3290k()) {
            obj = mo3298b.mo3283s(descriptor2, 0, Image$$serializer.INSTANCE, null);
            obj2 = mo3298b.mo3283s(descriptor2, 1, MarkdownToHtmlSerializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (mo11843q == -1) {
                    ...
                    obj = mo3298b.mo3283s(descriptor2, 0, Image$$serializer.INSTANCE, obj);
                    i2 |= 1;
                } else if (mo11843q != 1) {
                    throw new UnknownFieldException(mo11843q);
                } else {
                    obj3 = mo3298b.mo3283s(descriptor2, 1, MarkdownToHtmlSerializer.INSTANCE, obj3);
                    i2 |= 2;
                }
            }
            obj2 = obj3;
    ...
    public void serialize(InterfaceC48140rb1 encoder, PartnerNotice value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC34588Ms5 descriptor2 = getDescriptor();
        InterfaceC36464Ut0 mo1149b = encoder.mo1149b(descriptor2);
        PartnerNotice.write$Self(value, mo1149b, descriptor2);
