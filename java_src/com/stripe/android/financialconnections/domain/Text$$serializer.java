...
public final class Text$$serializer implements InterfaceC44940mB1<Text> {
    ...
    static {
        ...
        AW3 aw3 = new AW3("com.stripe.android.financialconnections.domain.Text", text$$serializer, 1);
        aw3.m115697k("oauth_prepane", false);
        descriptor = aw3;
    }
    ...
    public InterfaceC34036Kj2<?>[] childSerializers() {
        return new InterfaceC34036Kj2[]{OauthPrepane$$serializer.INSTANCE};
    }

    @Override // p000.E01
    public Text deserialize(GV0 decoder) {
        Object obj;
        ...
        int i = 1;
        if (mo3298b.mo3290k()) {
            obj = mo3298b.mo3283s(descriptor2, 0, OauthPrepane$$serializer.INSTANCE, null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (mo11843q == -1) {
                    ...
                    obj = mo3298b.mo3283s(descriptor2, 0, OauthPrepane$$serializer.INSTANCE, obj);
                    i2 |= 1;
                }
            }
            i = i2;
        ...
        return new Text(i, (OauthPrepane) obj, null);
    }
    ...
    public void serialize(InterfaceC48140rb1 encoder, Text value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC34588Ms5 descriptor2 = getDescriptor();
        InterfaceC36464Ut0 mo1149b = encoder.mo1149b(descriptor2);
        Text.write$Self(value, mo1149b, descriptor2);
