...
public final class AccountPickerScreenKt$MultiSelectContent$1$3$1 extends Lambda implements Function3<InterfaceC37486Zc5, InterfaceC32720Et0, Integer, Unit> {
    ...
    public final void invoke(InterfaceC37486Zc5 AccountItem, InterfaceC32720Et0 interfaceC32720Et0, int i) {
        ...
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87816Z(1340966562, i, -1, "com.stripe.android.financialconnections.features.accountpicker.MultiSelectContent.<anonymous>.<anonymous>.<anonymous> (AccountPickerScreen.kt:327)");
        }
        AccountPickerScreenKt.FinancialConnectionCheckbox(this.$selectedIds.contains(this.$account.getAccount().getId()), interfaceC32720Et0, 0);
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87817Y();
        }
    }
