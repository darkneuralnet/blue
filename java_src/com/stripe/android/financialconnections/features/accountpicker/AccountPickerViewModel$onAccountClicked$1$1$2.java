...
public final class AccountPickerViewModel$onAccountClicked$1$1$2 extends Lambda implements Function1<AccountPickerState, AccountPickerState> {
    ...
    public final AccountPickerState invoke(AccountPickerState setState) {
        ...
        minus = SetsKt___SetsKt.minus(setState.getSelectedIds(), this.$account.getId());
