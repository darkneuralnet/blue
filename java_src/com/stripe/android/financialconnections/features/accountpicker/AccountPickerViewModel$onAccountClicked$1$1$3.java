...
public final class AccountPickerViewModel$onAccountClicked$1$1$3 extends Lambda implements Function1<AccountPickerState, AccountPickerState> {
    ...
    public final AccountPickerState invoke(AccountPickerState setState) {
        ...
        plus = SetsKt___SetsKt.plus(setState.getSelectedIds(), this.$account.getId());
