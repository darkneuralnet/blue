...
public final class C18659x3df1a43d extends Lambda implements Function4<InterfaceC34306Ln2, Integer, InterfaceC32720Et0, Integer, Unit> {
    ...
    public C18659x3df1a43d(List list, Set set, Function1 function1, int i) {
        super(4);
        this.$items = list;
    ...
    public final void invoke(InterfaceC34306Ln2 items, int i, InterfaceC32720Et0 interfaceC32720Et0, int i2) {
        ...
        AccountPickerScreenKt.AccountItem(this.$selectedIds$inlined.contains(partnerAccountUI.getAccount().getId()), this.$onAccountClicked$inlined, partnerAccountUI, C43575jt0.m29791b(interfaceC32720Et0, 1340966562, true, new AccountPickerScreenKt$MultiSelectContent$1$3$1(this.$selectedIds$inlined, partnerAccountUI)), interfaceC32720Et0, ((this.$$dirty$inlined >> 3) & 112) | 3584);
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87817Y();
        }
    }
