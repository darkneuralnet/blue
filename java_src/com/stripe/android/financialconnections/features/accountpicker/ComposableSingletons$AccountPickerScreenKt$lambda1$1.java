...
public final class ComposableSingletons$AccountPickerScreenKt$lambda1$1 extends Lambda implements Function3<Boolean, InterfaceC32720Et0, Integer, Unit> {
    ...
    public final void invoke(boolean z, InterfaceC32720Et0 interfaceC32720Et0, int i) {
        ...
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87816Z(241493674, i, -1, "com.stripe.android.financialconnections.features.accountpicker.ComposableSingletons$AccountPickerScreenKt.lambda-1.<anonymous> (AccountPickerScreen.kt:340)");
        }
        if (z) {
            i3 = C18634R.C18635drawable.stripe_ic_checkbox_yes;
        } else {
            i3 = C18634R.C18635drawable.stripe_ic_checkbox_no;
        }
