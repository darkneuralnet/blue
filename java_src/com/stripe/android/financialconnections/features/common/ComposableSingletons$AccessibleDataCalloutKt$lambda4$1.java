...
public final class ComposableSingletons$AccessibleDataCalloutKt$lambda4$1 extends Lambda implements Function2<InterfaceC32720Et0, Integer, Unit> {
    ...
    /* loaded from: classes7.dex */
    public static final class C187111 extends Lambda implements Function0<Unit> {
        public static final C187111 INSTANCE = new C187111();
    ...
    public final void invoke(InterfaceC32720Et0 interfaceC32720Et0, int i) {
        ...
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87816Z(1509844845, i, -1, "com.stripe.android.financialconnections.features.common.ComposableSingletons$AccessibleDataCalloutKt.lambda-4.<anonymous> (AccessibleDataCallout.kt:336)");
        }
        ...
        AccessibleDataCalloutModel accessibleDataCalloutModel = new AccessibleDataCalloutModel("My business", listOf, false, true, "");
        partnerAccountsForPreview = AccessibleDataCalloutKt.partnerAccountsForPreview(interfaceC32720Et0, 0);
        AccessibleDataCalloutKt.AccessibleDataCalloutWithAccounts(accessibleDataCalloutModel, new FinancialConnectionsInstitution(true, "id", false, "name", null, null, null, "url"), partnerAccountsForPreview, C187111.INSTANCE, interfaceC32720Et0, 3592);
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87817Y();
        }
    }
