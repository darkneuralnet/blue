...
public final class ComposableSingletons$ErrorContentKt$lambda6$1 extends Lambda implements Function2<InterfaceC32720Et0, Integer, Unit> {
    ...
    public final void invoke(InterfaceC32720Et0 interfaceC32720Et0, int i) {
        ...
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87816Z(807711428, i, -1, "com.stripe.android.financialconnections.features.common.ComposableSingletons$ErrorContentKt.lambda-6.<anonymous> (ErrorContent.kt:370)");
        }
        ComposableSingletons$ErrorContentKt composableSingletons$ErrorContentKt = ComposableSingletons$ErrorContentKt.INSTANCE;
        ScaffoldKt.FinancialConnectionsScaffold(composableSingletons$ErrorContentKt.m116372getLambda4$financial_connections_release(), composableSingletons$ErrorContentKt.m116373getLambda5$financial_connections_release(), interfaceC32720Et0, 54);
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87817Y();
        }
    }
