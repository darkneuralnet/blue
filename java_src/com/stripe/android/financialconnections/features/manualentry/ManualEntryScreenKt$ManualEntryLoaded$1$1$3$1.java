...
public final class ManualEntryScreenKt$ManualEntryLoaded$1$1$3$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ EX2<Integer> $currentCheck$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ManualEntryScreenKt$ManualEntryLoaded$1$1$3$1(EX2<Integer> ex2) {
        super(0);
