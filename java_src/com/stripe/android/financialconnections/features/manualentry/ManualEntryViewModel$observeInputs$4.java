...
@DebugMetadata(m28419c = "com.stripe.android.financialconnections.features.manualentry.ManualEntryViewModel$observeInputs$4", m28418f = "ManualEntryViewModel.kt", m28417i = {}, m28416l = {}, m28415m = "invokeSuspend", m28414n = {}, m28413s = {})
...
public final class ManualEntryViewModel$observeInputs$4 extends SuspendLambda implements Function2<String, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes7.dex */
    public static final class C188381 extends Lambda implements Function1<ManualEntryState, ManualEntryState> {
        final /* synthetic */ String $input;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C188381(String str) {
            super(1);
            this.$input = str;
        }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ManualEntryViewModel$observeInputs$4 manualEntryViewModel$observeInputs$4 = new ManualEntryViewModel$observeInputs$4(this.this$0, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (str != null) {
                this.this$0.setState(new C188381(str));
            }
