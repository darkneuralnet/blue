...
public final class PartnerAuthViewModel$onAuthFailed$2$1 extends Lambda implements Function1<PartnerAuthState, PartnerAuthState> {
    ...
    public final PartnerAuthState invoke(PartnerAuthState setState) {
        ...
        return PartnerAuthState.copy$default(setState, null, null, new C32163Cj1(this.$error, null, 2, null), 3, null);
    }
}
