...
@Metadata(m28433d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, m28432d2 = {"com/stripe/android/financialconnections/model/LegalDetailsNotice.$serializer", "LmB1;", "Lcom/stripe/android/financialconnections/model/LegalDetailsNotice;", "", "LKj2;", "childSerializers", "()[LKj2;", "LGV0;", "decoder", "deserialize", "Lrb1;", "encoder", "value", "", "serialize", "LMs5;", "getDescriptor", "()LMs5;", "descriptor", "<init>", "()V", "financial-connections_release"}, m28431k = 1, m28430mv = {1, 8, 0})
@Deprecated(level = DeprecationLevel.HIDDEN, message = "This synthesized declaration should not be used directly", replaceWith = @ReplaceWith(expression = "", imports = {}))
/* loaded from: classes7.dex */
public final class LegalDetailsNotice$$serializer implements InterfaceC44940mB1<LegalDetailsNotice> {
    ...
    static {
        ...
        AW3 aw3 = new AW3("com.stripe.android.financialconnections.model.LegalDetailsNotice", legalDetailsNotice$$serializer, 4);
    ...
    public InterfaceC34036Kj2<?>[] childSerializers() {
        ...
        return new InterfaceC34036Kj2[]{LegalDetailsBody$$serializer.INSTANCE, markdownToHtmlSerializer, markdownToHtmlSerializer, markdownToHtmlSerializer};
    }

    @Override // p000.E01
    public LegalDetailsNotice deserialize(GV0 decoder) {
        Object obj;
        Object obj2;
        Object obj3;
        int i;
        ...
        Object obj5 = null;
        if (mo3298b.mo3290k()) {
            obj4 = mo3298b.mo3283s(descriptor2, 0, LegalDetailsBody$$serializer.INSTANCE, null);
            MarkdownToHtmlSerializer markdownToHtmlSerializer = MarkdownToHtmlSerializer.INSTANCE;
            obj = mo3298b.mo3283s(descriptor2, 1, markdownToHtmlSerializer, null);
            obj2 = mo3298b.mo3283s(descriptor2, 2, markdownToHtmlSerializer, null);
            ...
            while (z) {
                ...
                if (mo11843q == -1) {
                    ...
                    obj5 = mo3298b.mo3283s(descriptor2, 0, LegalDetailsBody$$serializer.INSTANCE, obj5);
                    i2 |= 1;
                } else if (mo11843q == 1) {
                    obj6 = mo3298b.mo3283s(descriptor2, 1, MarkdownToHtmlSerializer.INSTANCE, obj6);
                    i2 |= 2;
                } else if (mo11843q == 2) {
                    obj7 = mo3298b.mo3283s(descriptor2, 2, MarkdownToHtmlSerializer.INSTANCE, obj7);
                    i2 |= 4;
                } else if (mo11843q != 3) {
                    throw new UnknownFieldException(mo11843q);
                } else {
                    obj8 = mo3298b.mo3283s(descriptor2, 3, MarkdownToHtmlSerializer.INSTANCE, obj8);
                    i2 |= 8;
                }
            }
            obj = obj6;
    ...
    public void serialize(InterfaceC48140rb1 encoder, LegalDetailsNotice value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC34588Ms5 descriptor2 = getDescriptor();
        InterfaceC36464Ut0 mo1149b = encoder.mo1149b(descriptor2);
        LegalDetailsNotice.write$Self(value, mo1149b, descriptor2);
