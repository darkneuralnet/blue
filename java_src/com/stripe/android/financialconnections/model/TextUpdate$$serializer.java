...
@Metadata(m28433d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, m28432d2 = {"com/stripe/android/financialconnections/model/TextUpdate.$serializer", "LmB1;", "Lcom/stripe/android/financialconnections/model/TextUpdate;", "", "LKj2;", "childSerializers", "()[LKj2;", "LGV0;", "decoder", "deserialize", "Lrb1;", "encoder", "value", "", "serialize", "LMs5;", "getDescriptor", "()LMs5;", "descriptor", "<init>", "()V", "financial-connections_release"}, m28431k = 1, m28430mv = {1, 8, 0})
@Deprecated(level = DeprecationLevel.HIDDEN, message = "This synthesized declaration should not be used directly", replaceWith = @ReplaceWith(expression = "", imports = {}))
/* loaded from: classes7.dex */
public final class TextUpdate$$serializer implements InterfaceC44940mB1<TextUpdate> {
    ...
    static {
        ...
        AW3 aw3 = new AW3("com.stripe.android.financialconnections.model.TextUpdate", textUpdate$$serializer, 1);
        aw3.m115697k("consent_pane", true);
        descriptor = aw3;
    }
    ...
    public InterfaceC34036Kj2<?>[] childSerializers() {
        return new InterfaceC34036Kj2[]{C38330b40.m65021p(ConsentPane$$serializer.INSTANCE)};
    }

    @Override // p000.E01
    public TextUpdate deserialize(GV0 decoder) {
        Object obj;
        ...
        int i = 1;
        if (mo3298b.mo3290k()) {
            obj = mo3298b.mo3292i(descriptor2, 0, ConsentPane$$serializer.INSTANCE, null);
        } else {
            int i2 = 0;
            obj = null;
            while (i != 0) {
                ...
                if (mo11843q == -1) {
                    ...
                    obj = mo3298b.mo3292i(descriptor2, 0, ConsentPane$$serializer.INSTANCE, obj);
                    i2 |= 1;
                }
            }
            i = i2;
        ...
        return new TextUpdate(i, (ConsentPane) obj, (C38819bt5) null);
    }
    ...
    public void serialize(InterfaceC48140rb1 encoder, TextUpdate value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC34588Ms5 descriptor2 = getDescriptor();
        InterfaceC36464Ut0 mo1149b = encoder.mo1149b(descriptor2);
        TextUpdate.write$Self(value, mo1149b, descriptor2);
