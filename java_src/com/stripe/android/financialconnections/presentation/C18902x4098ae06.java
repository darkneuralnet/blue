...
public final class C18902x4098ae06 extends Lambda implements Function1<FinancialConnectionsSheetNativeState, FinancialConnectionsSheetNativeState> {
    final /* synthetic */ String $url;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C18902x4098ae06(String str) {
        super(1);
        this.$url = str;
    }
    ...
    public final FinancialConnectionsSheetNativeState invoke(FinancialConnectionsSheetNativeState setState) {
        ...
        return FinancialConnectionsSheetNativeState.copy$default(setState, new C31786At2(null, 1, null), false, null, false, false, new FinancialConnectionsSheetNativeViewEffect.OpenUrl(this.$url), null, 94, null);
    }
}
