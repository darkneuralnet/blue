...
public final class C18951xc46f15d1 extends Lambda implements Function0<String> {
    final /* synthetic */ GooglePayPaymentMethodLauncherViewModel.Factory.FallbackInjectionParams $arg;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C18951xc46f15d1(GooglePayPaymentMethodLauncherViewModel.Factory.FallbackInjectionParams fallbackInjectionParams) {
        super(0);
