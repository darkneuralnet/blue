...
public final class GooglePayLauncherModule {
    ...
    @Provides
    public final Function1<GooglePayEnvironment, GooglePayRepository> provideGooglePayRepositoryFactory(Context appContext, Logger logger) {
