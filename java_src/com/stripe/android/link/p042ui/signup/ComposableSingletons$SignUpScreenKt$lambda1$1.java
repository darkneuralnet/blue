...
public final class ComposableSingletons$SignUpScreenKt$lambda1$1 extends Lambda implements Function2<InterfaceC32720Et0, Integer, Unit> {
    ...
    /* loaded from: classes7.dex */
    public static final class C190361 extends Lambda implements Function0<Unit> {
        public static final C190361 INSTANCE = new C190361();
    ...
    public final void invoke(InterfaceC32720Et0 interfaceC32720Et0, int i) {
        ...
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87816Z(-887204973, i, -1, "com.stripe.android.link.ui.signup.ComposableSingletons$SignUpScreenKt.lambda-1.<anonymous> (SignUpScreen.kt:54)");
        }
        ...
        C190361 c190361 = C190361.INSTANCE;
        int i2 = SimpleTextFieldController.$stable;
        SignUpScreenKt.SignUpBody("Example, Inc.", createController, createPhoneNumberController$default, createController2, signUpState, false, true, null, c190361, interfaceC32720Et0, (i2 << 3) | 115040262 | (PhoneNumberController.$stable << 6) | (i2 << 9));
        if (C35528Qt0.m87827O()) {
            C35528Qt0.m87817Y();
        }
    }
