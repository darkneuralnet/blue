...
public /* synthetic */ class WalletScreenKt$WalletBody$6 extends FunctionReferenceImpl implements Function1<ConsumerPaymentDetails.PaymentDetails, Unit> {
    ...
    public final void invoke2(ConsumerPaymentDetails.PaymentDetails p0) {
        ...
        ((WalletViewModel) this.receiver).editPaymentMethod(p0);
    }
}
