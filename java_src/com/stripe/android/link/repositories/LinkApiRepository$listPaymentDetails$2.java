...
@DebugMetadata(m28419c = "com.stripe.android.link.repositories.LinkApiRepository$listPaymentDetails$2", m28418f = "LinkApiRepository.kt", m28417i = {}, m28416l = {SyslogConstants.LOG_LOCAL4}, m28415m = "invokeSuspend", m28414n = {}, m28413s = {})
/* loaded from: classes7.dex */
public final class LinkApiRepository$listPaymentDetails$2 extends SuspendLambda implements Function2<ZC0, Continuation<? super Result<? extends ConsumerPaymentDetails>>, Object> {
    ...
    public LinkApiRepository$listPaymentDetails$2(LinkApiRepository linkApiRepository, String str, String str2, Continuation<? super LinkApiRepository$listPaymentDetails$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        LinkApiRepository$listPaymentDetails$2 linkApiRepository$listPaymentDetails$2 = new LinkApiRepository$listPaymentDetails$2(this.this$0, this.$consumerSessionClientSecret, this.$consumerPublishableKey, continuation);
    ...
    public final Object invoke2(ZC0 zc0, Continuation<? super Result<ConsumerPaymentDetails>> continuation) {
        return ((LinkApiRepository$listPaymentDetails$2) create(zc0, continuation)).invokeSuspend(Unit.INSTANCE);
    }
