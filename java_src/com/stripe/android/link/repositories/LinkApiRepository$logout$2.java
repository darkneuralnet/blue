...
@DebugMetadata(m28419c = "com.stripe.android.link.repositories.LinkApiRepository$logout$2", m28418f = "LinkApiRepository.kt", m28417i = {}, m28416l = {140}, m28415m = "invokeSuspend", m28414n = {}, m28413s = {})
/* loaded from: classes7.dex */
public final class LinkApiRepository$logout$2 extends SuspendLambda implements Function2<ZC0, Continuation<? super Result<? extends ConsumerSession>>, Object> {
    ...
    public LinkApiRepository$logout$2(LinkApiRepository linkApiRepository, String str, String str2, String str3, Continuation<? super LinkApiRepository$logout$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        LinkApiRepository$logout$2 linkApiRepository$logout$2 = new LinkApiRepository$logout$2(this.this$0, this.$consumerSessionClientSecret, this.$authSessionCookie, this.$consumerPublishableKey, continuation);
    ...
    public final Object invoke2(ZC0 zc0, Continuation<? super Result<ConsumerSession>> continuation) {
        return ((LinkApiRepository$logout$2) create(zc0, continuation)).invokeSuspend(Unit.INSTANCE);
    }
