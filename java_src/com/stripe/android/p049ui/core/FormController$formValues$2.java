...
@DebugMetadata(m28419c = "com.stripe.android.ui.core.FormController$formValues$2", m28418f = "FormController.kt", m28417i = {}, m28416l = {}, m28415m = "invokeSuspend", m28414n = {}, m28413s = {})
...
public final class FormController$formValues$2 extends SuspendLambda implements Function3<Map<IdentifierSpec, ? extends FormFieldEntry>, Set<? extends IdentifierSpec>, Continuation<? super Map<IdentifierSpec, ? extends FormFieldEntry>>, Object> {
    /* synthetic */ Object L$0;
    /* synthetic */ Object L$1;
    int label;

    public FormController$formValues$2(Continuation<? super FormController$formValues$2> continuation) {
    ...
    public final Object invoke2(Map<IdentifierSpec, FormFieldEntry> map, Set<IdentifierSpec> set, Continuation<? super Map<IdentifierSpec, FormFieldEntry>> continuation) {
        FormController$formValues$2 formController$formValues$2 = new FormController$formValues$2(continuation);
        formController$formValues$2.L$0 = map;
        formController$formValues$2.L$1 = set;
        return formController$formValues$2.invokeSuspend(Unit.INSTANCE);
    }
}
