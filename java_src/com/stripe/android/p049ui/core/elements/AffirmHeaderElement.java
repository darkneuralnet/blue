...
public final class AffirmHeaderElement implements FormElement {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AffirmHeaderElement) {
            ...
            return Intrinsics.areEqual(getIdentifier(), affirmHeaderElement.getIdentifier()) && Intrinsics.areEqual(getController(), affirmHeaderElement.getController());
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "AffirmHeaderElement(identifier=" + identifier + ", controller=" + controller + ")";
    }
