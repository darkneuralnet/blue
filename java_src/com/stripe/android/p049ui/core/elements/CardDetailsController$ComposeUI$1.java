...
/* renamed from: com.stripe.android.ui.core.elements.CardDetailsController$ComposeUI$1 */
/* loaded from: classes7.dex */
public final class CardDetailsController$ComposeUI$1 extends Lambda implements Function2<InterfaceC32720Et0, Integer, Unit> {
    ...
    final /* synthetic */ CardDetailsController $tmp0_rcvr;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CardDetailsController$ComposeUI$1(CardDetailsController cardDetailsController, boolean z, SectionFieldElement sectionFieldElement, InterfaceC41563gV2 interfaceC41563gV2, Set<IdentifierSpec> set, IdentifierSpec identifierSpec, int i, int i2, int i3) {
        super(2);
