...
public final class CardDetailsSectionElementUIKt$CardDetailsSectionElementUI$2 extends Lambda implements Function2<InterfaceC32720Et0, Integer, Unit> {
    ...
    public final void invoke(InterfaceC32720Et0 interfaceC32720Et0, int i) {
        CardDetailsSectionElementUIKt.CardDetailsSectionElementUI(this.$enabled, this.$controller, this.$hiddenIdentifiers, this.$lastTextFieldIdentifier, interfaceC32720Et0, this.$$changed | 1);
    }
}
