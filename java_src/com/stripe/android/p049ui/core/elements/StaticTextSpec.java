...
public final class StaticTextSpec extends FormItemSpec {
    ...
    @Metadata(m28433d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u000f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002HÆ\u0001¨\u0006\u0007"}, m28432d2 = {"Lcom/stripe/android/ui/core/elements/StaticTextSpec$Companion;", "", "LKj2;", "Lcom/stripe/android/ui/core/elements/StaticTextSpec;", "serializer", "<init>", "()V", "payments-ui-core_release"}, m28431k = 1, m28430mv = {1, 8, 0})
    ...
    public static final class Companion {
        ...
        public final InterfaceC34036Kj2<StaticTextSpec> serializer() {
    ...
    public /* synthetic */ StaticTextSpec(int i, @InterfaceC36694Vs5("api_path") IdentifierSpec identifierSpec, int i2, C38819bt5 c38819bt5) {
        super(null);
        if (2 != (i & 2)) {
            C52838zW3.m1275b(i, 2, StaticTextSpec$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
    ...
    @JvmStatic
    public static final void write$Self(StaticTextSpec self, InterfaceC36464Ut0 output, InterfaceC34588Ms5 serialDesc) {
        boolean z;
        Intrinsics.checkNotNullParameter(self, "self");
        Intrinsics.checkNotNullParameter(output, "output");
        Intrinsics.checkNotNullParameter(serialDesc, "serialDesc");
        if (output.mo1132s(serialDesc, 0) || !Intrinsics.areEqual(self.getApiPath(), IdentifierSpec.Companion.Generic("static_text"))) {
            z = true;
        } else {
            z = false;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StaticTextSpec) {
            ...
            return Intrinsics.areEqual(getApiPath(), staticTextSpec.getApiPath()) && this.stringResId == staticTextSpec.stringResId;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "StaticTextSpec(apiPath=" + apiPath + ", stringResId=" + i + ")";
    }
