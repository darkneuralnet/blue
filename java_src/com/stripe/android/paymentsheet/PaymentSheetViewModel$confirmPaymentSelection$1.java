...
@DebugMetadata(m28419c = "com.stripe.android.paymentsheet.PaymentSheetViewModel$confirmPaymentSelection$1", m28418f = "PaymentSheetViewModel.kt", m28417i = {0}, m28416l = {439}, m28415m = "invokeSuspend", m28414n = {"stripeIntent"}, m28413s = {"L$0"})
/* loaded from: classes7.dex */
public final class PaymentSheetViewModel$confirmPaymentSelection$1 extends SuspendLambda implements Function2<ZC0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(ZC0 zc0, Continuation<? super Unit> continuation) {
        return ((PaymentSheetViewModel$confirmPaymentSelection$1) create(zc0, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            if (value != null) {
                ...
                if (config$paymentsheet_release != null && (shippingDetails = config$paymentsheet_release.getShippingDetails()) != null) {
