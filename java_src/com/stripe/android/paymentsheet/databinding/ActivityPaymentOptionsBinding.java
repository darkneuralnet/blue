...
public final class ActivityPaymentOptionsBinding implements InterfaceC34094Kp6 {
    public final LinearLayout bottomSheet;
    public final ComposeView content;
    public final CoordinatorLayout coordinator;
    private final CoordinatorLayout rootView;

    private ActivityPaymentOptionsBinding(CoordinatorLayout coordinatorLayout, LinearLayout linearLayout, ComposeView composeView, CoordinatorLayout coordinatorLayout2) {
    ...
    public static ActivityPaymentOptionsBinding bind(View view) {
        ...
        if (linearLayout != null) {
            ...
            if (composeView != null) {
                ...
                return new ActivityPaymentOptionsBinding(coordinatorLayout, linearLayout, composeView, coordinatorLayout);
            }
        }
    ...
    public static ActivityPaymentOptionsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C19159R.C19162layout.activity_payment_options, viewGroup, false);
        if (z) {
