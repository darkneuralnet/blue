...
public final class DefaultFlowController$1$onCreate$2 extends Lambda implements Function0<String> {
    ...
    public final String invoke() {
        ...
        return ((PaymentConfiguration) y94.get()).getStripeAccountId();
    }
}
