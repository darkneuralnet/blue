...
public final class ChallengeProgressFragment extends Fragment {
    ...
    public ChallengeProgressFragment(String directoryServerName, SdkTransactionId sdkTransactionId, Integer num) {
        super(C19336R.C19339layout.stripe_progress_view_layout);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        String str = null;
        if (activity != null) {
            drawable = NA0.m94299e(activity, lookup$3ds2sdk_release.getDrawableResId$3ds2sdk_release());
        } else {
            drawable = null;
        }
        ...
        brandLogo.setContentDescription(str);
