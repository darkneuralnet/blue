...
public final class AddressTextFieldController$ComposeUI$1 extends Lambda implements Function2<InterfaceC32720Et0, Integer, Unit> {
    ...
    final /* synthetic */ AddressTextFieldController $tmp0_rcvr;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddressTextFieldController$ComposeUI$1(AddressTextFieldController addressTextFieldController, boolean z, SectionFieldElement sectionFieldElement, InterfaceC41563gV2 interfaceC41563gV2, Set<IdentifierSpec> set, IdentifierSpec identifierSpec, int i, int i2, int i3) {
        super(2);
        this.$tmp0_rcvr = addressTextFieldController;
        this.$enabled = z;
