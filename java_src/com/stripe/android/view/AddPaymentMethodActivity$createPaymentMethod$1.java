...
public final class AddPaymentMethodActivity$createPaymentMethod$1 extends Lambda implements Function1<Result<? extends PaymentMethod>, Unit> {
    ...
    public final void invoke2(Result<? extends PaymentMethod> result) {
        ...
        if (m116786exceptionOrNullimpl == null) {
            PaymentMethod paymentMethod = (PaymentMethod) m116792unboximpl;
