...
public final class PaymentMethodsActivity$setupRecyclerView$2 extends Lambda implements Function1<PaymentMethod, Unit> {
    ...
    public final void invoke2(PaymentMethod it) {
        ...
        PaymentMethodsActivity.finishWithResult$default(this.this$0, it, 0, 2, null);
    }
}
