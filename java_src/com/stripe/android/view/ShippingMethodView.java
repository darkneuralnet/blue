...
public final class ShippingMethodView extends RelativeLayout {
    ...
    public final void setShippingMethod(ShippingMethod shippingMethod) {
        ...
        String string = getContext().getString(C18606R.string.price_free);
    ...
    public ShippingMethodView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectedColorInt = companion.isColorTransparent(colorAccent) ? NA0.m94301c(context, C18606R.color.stripe_accent_color_default) : colorAccent;
        this.unselectedTextColorPrimaryInt = companion.isColorTransparent(textColorPrimary) ? NA0.m94301c(context, C18606R.color.stripe_color_text_unselected_primary_default) : textColorPrimary;
        this.unselectedTextColorSecondaryInt = companion.isColorTransparent(textColorSecondary) ? NA0.m94301c(context, C18606R.color.stripe_color_text_unselected_secondary_default) : textColorSecondary;
    }
}
