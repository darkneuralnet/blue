...
@DebugMetadata(m28419c = "kotlin.io.path.PathTreeWalk$bfsIterator$1", m28418f = "PathTreeWalk.kt", m28417i = {0, 0, 0, 0, 0, 0, 1, 1, 1}, m28416l = {SyslogConstants.LOG_LOCAL7, 190}, m28415m = "invokeSuspend", m28414n = {"$this$iterator", "queue", "entriesReader", "pathNode", "this_$iv", "path$iv", "$this$iterator", "queue", "entriesReader"}, m28413s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$0", "L$1", "L$2"})
...
public final class PathTreeWalk$bfsIterator$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:25:0x00f4 -> B:11:0x0082). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:26:0x00f6 -> B:11:0x0082). Please submit an issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            arrayDeque4.addLast(new PathNode(path, keyOf, null));
            sequenceScope = (SequenceScope) this.L$0;
            pathTreeWalk$bfsIterator$1 = this;
