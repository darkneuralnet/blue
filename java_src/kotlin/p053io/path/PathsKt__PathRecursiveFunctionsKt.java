...
public class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final void deleteRecursively(Path path) {
        ...
        if (!deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.isEmpty()) {
            C41677gh1.m37904a();
            FileSystemException m41034a = C41084fh1.m41034a("Failed to delete one or more files. See suppressed exceptions for details.");
            for (Exception exc : deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt) {
                ExceptionsKt__ExceptionsKt.addSuppressed(m41034a, exc);
            }
            throw m41034a;
        }
    }
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) {
        ...
        if (parent != null) {
            ...
            if (directoryStream != null) {
                try {
                    DirectoryStream m86965a = RJ3.m86965a(directoryStream);
                    if (SJ3.m85739a(m86965a)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream m83892a = TJ3.m83892a(m86965a);
                        fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "this.fileName");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(m83892a, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            if (secureDirectoryStream2 != null) {
                SecureDirectoryStream<Object> m83892a = TJ3.m83892a(secureDirectoryStream2);
                for (Object obj : m83892a) {
                    fileName = C41355g83.m39981a(obj).getFileName();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (directoryStream != null) {
            for (Object obj : RJ3.m86965a(directoryStream)) {
                Path entry = C41355g83.m39981a(obj);
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        ...
        try {
            ...
            readAttributes = C42651iK3.m34176a(fileAttributeView).readAttributes();
    ...
    */
    public static final Path copyToRecursively(Path path, Path target, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) {
        ...
        if (exists) {
            ...
            if (exists2) {
                ...
                if (exists3) {
                    ...
                    if (!isSymbolicLink) {
                        ...
                        if (z3) {
                            C41677gh1.m37904a();
                            throw C40279eK3.m43030a(path.toString(), target.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
                        }
                    }
                }
                z2 = false;
            ...
            PathsKt__PathUtilsKt.visitFileTree$default(path, 0, z, new PathsKt__PathRecursiveFunctionsKt$copyToRecursively$5(copyAction, path, target, onError), 1, (Object) null);
            return target;
        }
        C40872fK3.m41561a();
        throw C39687dK3.m44400a(path.toString(), target.toString(), "The source file doesn't exist.");
    }
