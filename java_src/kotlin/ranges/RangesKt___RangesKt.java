...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, T t2, T t3) {
        ...
        if (t2 != null && t3 != null) {
            if (t2.compareTo(t3) <= 0) {
                ...
                throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + t3 + " is less than minimum " + t2 + CoreConstants.DOT);
            }
    ...
    public static final byte coerceIn(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) b3) + " is less than minimum " + ((int) b2) + CoreConstants.DOT);
    }
    ...
    public static final short coerceIn(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) s3) + " is less than minimum " + ((int) s2) + CoreConstants.DOT);
    }
