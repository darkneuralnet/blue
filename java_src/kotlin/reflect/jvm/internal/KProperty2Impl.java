...
public class KProperty2Impl<D, E, V> extends KPropertyImpl<V> implements KProperty2<D, E, V> {
    ...
    public KProperty2Impl(KDeclarationContainerImpl container, String name, String signature) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(lazyThreadSafetyMode, (Function0) new KProperty2Impl$_getter$1(this));
        this._getter = lazy;
        lazy2 = LazyKt__LazyJVMKt.lazy(lazyThreadSafetyMode, (Function0) new KProperty2Impl$delegateSource$1(this));
