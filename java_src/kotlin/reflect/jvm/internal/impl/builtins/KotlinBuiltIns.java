...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor mo118092getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo118092getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (mo118092getContributedClassifier != null) {
                    ...
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo118092getContributedClassifier);
                }
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(mo118090getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(mo118090getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo118090getDeclarationDescriptor);
    }
    ...
    public static boolean isNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(SyslogConstants.LOG_LOCAL1);
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo118090getDeclarationDescriptor = kotlinType.getConstructor().mo118090getDeclarationDescriptor();
        if (mo118090getDeclarationDescriptor != null && getPrimitiveArrayType(mo118090getDeclarationDescriptor) != null) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo118090getDeclarationDescriptor = kotlinType.getConstructor().mo118090getDeclarationDescriptor();
        if ((mo118090getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo118090getDeclarationDescriptor)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        if ((mo118090getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo118090getDeclarationDescriptor, fqNameUnsafe)) {
            return true;
        }
        return false;
    }
