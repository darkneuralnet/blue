...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName((functionClassKind5.getPackageFqName().toString() + CoreConstants.DOT + functionClassKind5.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }
