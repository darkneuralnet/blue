...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    */
    ...
    public PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        for (ReceiverParameterDescriptor receiverParameterDescriptor5 : this.contextReceiverParameters) {
            ReceiverParameterDescriptor substituteContextParameterDescriptor = substituteContextParameterDescriptor(substituteTypeParameters, createSubstitutedCopy, receiverParameterDescriptor5);
