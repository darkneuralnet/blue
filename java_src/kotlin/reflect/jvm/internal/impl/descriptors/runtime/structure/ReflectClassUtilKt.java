...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(TuplesKt.m28425to(JvmClassMappingKt.getJavaObjectType(kClass), JvmClassMappingKt.getJavaPrimitiveType(kClass)));
        }
        ...
        while (it2.hasNext()) {
            ...
            arrayList2.add(TuplesKt.m28425to(JvmClassMappingKt.getJavaPrimitiveType(kClass2), JvmClassMappingKt.getJavaObjectType(kClass2)));
        }
        ...
        for (Object obj : list3) {
            ...
            arrayList3.add(TuplesKt.m28425to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
    ...
    public static final String getDesc(Class<?> cls) {
        ...
        if (cls.isPrimitive()) {
            ...
            replace$default2 = StringsKt__StringsJVMKt.replace$default(name2, (char) CoreConstants.DOT, (char) JsonPointer.SEPARATOR, false, 4, (Object) null);
            ...
            replace$default = StringsKt__StringsJVMKt.replace$default(name3, (char) CoreConstants.DOT, (char) JsonPointer.SEPARATOR, false, 4, (Object) null);
