...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f95000c;
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext outerContext, JavaPackage jPackage) {
        ...
        this.f95000c = childForClassOrPackage$default;
    ...
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f95000c.getComponents().getModule();
    }
