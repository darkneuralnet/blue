...
public final class JavaTypeAttributes extends ErasureTypeAttributes {
    ...
    public int hashCode() {
        ...
        int i2 = hashCode2 + (hashCode2 * 31) + (this.isRaw ? 1 : 0);
    ...
    public JavaTypeAttributes withNewVisitedTypeParameter(TypeParameterDescriptor typeParameter) {
        ...
        if (getVisitedTypeParameters() == null) {
            ...
            of = SetsKt___SetsKt.plus(getVisitedTypeParameters(), typeParameter);
        }
        return copy$default(this, null, null, false, false, of, null, 47, null);
    }
