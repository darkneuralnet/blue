...
public final class ClassId {
    ...
    */
    ...
    public String asString() {
        ...
        String str = this.packageFqName.asString().replace(CoreConstants.DOT, JsonPointer.SEPARATOR) + "/" + this.relativeClassName.asString();
        if (str == null) {
            $$$reportNull$$$0(14);
        }
        return str;
    ...
    public static ClassId fromString(String str, boolean z) {
        ...
        if (lastIndexOf == -1) {
            ...
            String replace = str.substring(0, lastIndexOf).replace(JsonPointer.SEPARATOR, CoreConstants.DOT);
