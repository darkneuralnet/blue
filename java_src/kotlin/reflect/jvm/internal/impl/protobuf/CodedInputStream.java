...
public final class CodedInputStream {
    ...
    */
    ...
    public String readString() throws IOException {
        ...
        int i2 = this.bufferPos;
        if (readRawVarint32 <= i - i2 && readRawVarint32 > 0) {
            String str = new String(this.buffer, i2, readRawVarint32, Constants.DEFAULT_ENCODING);
            this.bufferPos += readRawVarint32;
            return str;
        } else if (readRawVarint32 == 0) {
            return "";
        } else {
            return new String(readRawBytesSlowPath(readRawVarint32), Constants.DEFAULT_ENCODING);
        }
    }
    ...
    public String readStringRequireUtf8() throws IOException {
        ...
        if (Utf8.isValidUtf8(readRawBytesSlowPath, i, i + readRawVarint32)) {
            return new String(readRawBytesSlowPath, i, readRawVarint32, Constants.DEFAULT_ENCODING);
        }
