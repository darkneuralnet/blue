...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, CallableDescriptor a, CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor mo118090getDeclarationDescriptor = c1.mo118090getDeclarationDescriptor();
        ClassifierDescriptor mo118090getDeclarationDescriptor2 = c2.mo118090getDeclarationDescriptor();
        if ((mo118090getDeclarationDescriptor instanceof TypeParameterDescriptor) && (mo118090getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo118090getDeclarationDescriptor, (TypeParameterDescriptor) mo118090getDeclarationDescriptor2, z, new C25441xd7e650be(a, b));
        }
        return false;
    }
    ...
    public final boolean areCallableDescriptorsEquivalent(final CallableDescriptor a, final CallableDescriptor b, final boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if ((Intrinsics.areEqual(a.getContainingDeclaration(), b.getContainingDeclaration()) && (!z || !Intrinsics.areEqual(singleSource(a), singleSource(b)))) || DescriptorUtils.isLocal(a) || DescriptorUtils.isLocal(b) || !ownersEquivalent(a, b, C25440xc15c0bd8.INSTANCE, z)) {
            return false;
        }
