...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        String replace = classId.getRelativeClassName().asString().replace(CoreConstants.DOT, '$');
        if (packageFqName.isRoot()) {
            return new JvmClassName(replace);
        }
        return new JvmClassName(packageFqName.asString().replace(CoreConstants.DOT, JsonPointer.SEPARATOR) + "/" + replace);
    }
    ...
    public static JvmClassName byFqNameWithoutInnerClasses(FqName fqName) {
        ...
        JvmClassName jvmClassName = new JvmClassName(fqName.asString().replace(CoreConstants.DOT, JsonPointer.SEPARATOR));
    ...
    public FqName getFqNameForTopLevelClassMaybeWithDollars() {
        return new FqName(this.internalName.replace(JsonPointer.SEPARATOR, CoreConstants.DOT));
    }
    ...
    public FqName getPackageFqName() {
        ...
        return new FqName(this.internalName.substring(0, lastIndexOf).replace(JsonPointer.SEPARATOR, CoreConstants.DOT));
    }
