...
public final class MemberDeserializer$loadProperty$4 extends Lambda implements Function0<NullableLazyValue<? extends ConstantValue<?>>> {
    ...
    /* loaded from: classes8.dex */
    public static final class C254541 extends Lambda implements Function0<ConstantValue<?>> {
        final /* synthetic */ DeserializedPropertyDescriptor $property;
        final /* synthetic */ ProtoBuf.Property $proto;
        final /* synthetic */ MemberDeserializer this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C254541(MemberDeserializer memberDeserializer, ProtoBuf.Property property, DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
            super(0);
    ...
    public final NullableLazyValue<? extends ConstantValue<?>> invoke() {
        ...
        return deserializationContext.getStorageManager().createNullableLazyValue(new C254541(this.this$0, this.$proto, this.$property));
    }
}
