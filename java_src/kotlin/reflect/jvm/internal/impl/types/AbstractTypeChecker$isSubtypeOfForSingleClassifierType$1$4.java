...
public final class AbstractTypeChecker$isSubtypeOfForSingleClassifierType$1$4 extends Lambda implements Function1<TypeCheckerState.ForkPointContext, Unit> {
    ...
    /* loaded from: classes8.dex */
    public static final class C254781 extends Lambda implements Function0<Boolean> {
        final /* synthetic */ TypeCheckerState $state;
        ...
        public C254781(TypeCheckerState typeCheckerState, TypeSystemContext typeSystemContext, SimpleTypeMarker simpleTypeMarker, SimpleTypeMarker simpleTypeMarker2) {
            super(0);
    ...
    public final void invoke2(TypeCheckerState.ForkPointContext runForkingPoint) {
        ...
        for (SimpleTypeMarker simpleTypeMarker : this.$supertypesWithSameConstructor) {
            runForkingPoint.fork(new C254781(this.$state, this.$this_with, simpleTypeMarker, this.$superType));
        }
    }
}
