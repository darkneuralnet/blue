        ...
        TypeSubstitutor create = TypeSubstitutor.create(new TypeConstructorSubstitution() { // from class: kotlin.reflect.jvm.internal.impl.types.StarProjectionImplKt$buildStarProjectionTypeByTypeParameters$1
            ...
            public TypeProjection get(TypeConstructor key) {
                ...
                if (list.contains(key)) {
                    ClassifierDescriptor mo118090getDeclarationDescriptor = key.mo118090getDeclarationDescriptor();
                    Intrinsics.checkNotNull(mo118090getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.TypeParameterDescriptor");
                    return TypeUtils.makeStarProjection((TypeParameterDescriptor) mo118090getDeclarationDescriptor);
                }
                return null;
            }
        });
