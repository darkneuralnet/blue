...
public final class WebSocketProtocol {
    ...
    public final String acceptHeader(String key) {
        ...
        return M70.f22644e.m95794d(Intrinsics.stringPlus(key, ACCEPT_MAGIC)).m95801r().mo43600a();
    }
    ...
    public final void toggleMask(C42488i30.C23107a cursor, byte[] key) {
        Intrinsics.checkNotNullParameter(cursor, "cursor");
        Intrinsics.checkNotNullParameter(key, "key");
        int length = key.length;
        int i = 0;
        do {
            byte[] bArr = cursor.f86663f;
            int i2 = cursor.f86664g;
            int i3 = cursor.f86665h;
            if (bArr != null) {
                while (i2 < i3) {
                    int i4 = i % length;
