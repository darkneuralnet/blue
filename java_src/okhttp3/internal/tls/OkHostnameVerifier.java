...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean isAscii(String str) {
        return str.length() == ((int) C44064ki6.m28579b(str, 0, 0, 3, null));
    }
            ...
            if (!startsWith$default) {
                ...
                if (!endsWith$default) {
                    if (!(str2 == null || str2.length() == 0)) {
                        startsWith$default2 = StringsKt__StringsJVMKt.startsWith$default(str2, InstructionFileId.DOT, false, 2, null);
                        if (!startsWith$default2) {
                            ...
                            if (!endsWith$default2) {
                                endsWith$default3 = StringsKt__StringsJVMKt.endsWith$default(str, InstructionFileId.DOT, false, 2, null);
                                if (!endsWith$default3) {
                                    str = Intrinsics.stringPlus(str, InstructionFileId.DOT);
                                }
                                String str3 = str;
                                endsWith$default4 = StringsKt__StringsJVMKt.endsWith$default(str2, InstructionFileId.DOT, false, 2, null);
                                if (!endsWith$default4) {
                                    str2 = Intrinsics.stringPlus(str2, InstructionFileId.DOT);
                                }
