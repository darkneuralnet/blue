    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public DateTime withMaximumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e)) {
                    return new DateTime(getChronology().getZone().previousTransition(getMillis() + CoreConstants.MILLIS_IN_ONE_DAY), getChronology());
                }
                throw e;
            }
        }
        ...
        public DateTime withMinimumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e)) {
                    return new DateTime(getChronology().getZone().nextTransition(getMillis() - CoreConstants.MILLIS_IN_ONE_DAY), getChronology());
                }
                throw e;
            }
        }
