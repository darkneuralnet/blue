...
public final class Period extends BasePeriod {
    ...
    public Days toStandardDays() {
        ...
        return Days.days(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd((((getMillis() + (getSeconds() * 1000)) + (getMinutes() * 60000)) + (getHours() * CoreConstants.MILLIS_IN_ONE_HOUR)) / CoreConstants.MILLIS_IN_ONE_DAY, getDays()), getWeeks() * 7)));
    }

    public Duration toStandardDuration() {
        checkYearsAndMonths("Duration");
        return new Duration(getMillis() + (getSeconds() * 1000) + (getMinutes() * 60000) + (getHours() * CoreConstants.MILLIS_IN_ONE_HOUR) + (getDays() * CoreConstants.MILLIS_IN_ONE_DAY) + (getWeeks() * CoreConstants.MILLIS_IN_ONE_WEEK));
    }
    ...
    public Weeks toStandardWeeks() {
        ...
        return Weeks.weeks(FieldUtils.safeToInt(getWeeks() + (((((getMillis() + (getSeconds() * 1000)) + (getMinutes() * 60000)) + (getHours() * CoreConstants.MILLIS_IN_ONE_HOUR)) + (getDays() * CoreConstants.MILLIS_IN_ONE_DAY)) / CoreConstants.MILLIS_IN_ONE_WEEK)));
    }
    ...
    public Period normalizedStandard(PeriodType periodType) {
        PeriodType periodType2 = DateTimeUtils.getPeriodType(periodType);
        Period period = new Period(getMillis() + (getSeconds() * 1000) + (getMinutes() * 60000) + (getHours() * CoreConstants.MILLIS_IN_ONE_HOUR) + (getDays() * CoreConstants.MILLIS_IN_ONE_DAY) + (getWeeks() * CoreConstants.MILLIS_IN_ONE_WEEK), periodType2, ISOChronology.getInstanceUTC());
        int years = getYears();
