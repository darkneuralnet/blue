...
public abstract class AbstractC35419Qg8 {
    /* renamed from: d */
    public static void m88192d(CharSequence charSequence, ByteBuffer byteBuffer) {
    ...
    /* renamed from: a */
    public abstract int mo37892a(int i, byte[] bArr, int i2, int i3);

    /* renamed from: b */
    public abstract int mo37891b(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* renamed from: c */
    public abstract void mo37890c(CharSequence charSequence, ByteBuffer byteBuffer);

    /* renamed from: e */
    public final boolean m88191e(byte[] bArr, int i, int i2) {
        return mo37892a(0, bArr, i, i2) == 0;
    }
}
