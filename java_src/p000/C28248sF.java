...
@Metadata(m28433d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0013\u0010\u0014J \u0010\t\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J(\u0010\u000e\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016R\u0018\u0010\u0012\u001a\u0004\u0018\u00010\u000f8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, m28432d2 = {"LsF;", "Landroidx/recyclerview/widget/RecyclerView$o;", "Landroid/graphics/Canvas;", "c", "Landroidx/recyclerview/widget/RecyclerView;", "parent", "Landroidx/recyclerview/widget/RecyclerView$z;", TransferTable.COLUMN_STATE, "", "onDrawOver", "Landroid/graphics/Rect;", "outRect", "Landroid/view/View;", "view", "getItemOffsets", "Landroid/graphics/drawable/Drawable;", "b", "Landroid/graphics/drawable/Drawable;", "divider", "<init>", "()V", "servicecenter_release"}, m28431k = 1, m28430mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nBatchSearchItemDecoration.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BatchSearchItemDecoration.kt\nco/bird/android/feature/servicecenter/batches/batchsearch/BatchSearchItemDecoration\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,59:1\n1549#2:60\n1620#2,3:61\n1855#2,2:64\n*S KotlinDebug\n*F\n+ 1 BatchSearchItemDecoration.kt\nco/bird/android/feature/servicecenter/batches/batchsearch/BatchSearchItemDecoration\n*L\n21#1:60\n21#1:61,3\n22#1:64,2\n*E\n"})
/* renamed from: sF */
/* loaded from: classes3.dex */
public final class C28248sF extends RecyclerView.AbstractC11854o {

    /* renamed from: b */
    public Drawable f108510b;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.C11872z state) {
        ...
        if (childAdapterPosition != -1 && (adapter = parent.getAdapter()) != null) {
            ...
            if (itemViewType == C45268mk4.item_button_secondary && childAdapterPosition != 0) {
                outRect.top = parent.getContext().getResources().getDimensionPixelSize(C37044Xf4.activity_vertical_margin_small);
            }
        }
    }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.C11872z state) {
        ...
        if (this.f108510b == null) {
            this.f108510b = NA0.m94299e(parent.getContext(), C33309Hg4.divider_light_gray);
        }
        ...
        for (View view : arrayList) {
            ...
            if (i2 == C45268mk4.item_button_secondary) {
                ...
                Drawable drawable = this.f108510b;
                if (drawable != null) {
                ...
                int i3 = i + bottom;
                Drawable drawable2 = this.f108510b;
                if (drawable2 != null) {
                    drawable2.setBounds(dimensionPixelSize, bottom, width, i3);
                }
                Drawable drawable3 = this.f108510b;
                if (drawable3 != null) {
                    drawable3.draw(c);
                }
            }
