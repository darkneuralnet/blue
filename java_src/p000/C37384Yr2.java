...
public class C37384Yr2 extends Fragment {
    ...
    private final Runnable mRequestFocus = new RunnableC10040a();
    private final AdapterView.OnItemClickListener mOnClickListener = new C10041b();

    /* renamed from: Yr2$a */
    /* loaded from: classes.dex */
    public class RunnableC10040a implements Runnable {
        public RunnableC10040a() {
        }

        @Override // java.lang.Runnable
        public void run() {
            ListView listView = C37384Yr2.this.mList;
    ...
    /* renamed from: Yr2$b */
    /* loaded from: classes.dex */
    public class C10041b implements AdapterView.OnItemClickListener {
        public C10041b() {
        }

        @Override // android.widget.AdapterView.OnItemClickListener
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            C37384Yr2.this.onListItemClick((ListView) adapterView, view, i, j);
        }
    }
