        ...
        if (m40591a != null) {
            ...
            if (adapter != null) {
                ...
                if (this.f50184b == 0) {
                    ...
                    this.f50184b = C40788fB0.m41774h(context, C37044Xf4.activity_vertical_margin);
                }
                int i = 0;
                if (itemViewType == C32634Ej4.item_repair_instructions) {
                    Context context2 = parent.getContext();
                    Intrinsics.checkNotNullExpressionValue(context2, "parent.context");
                    outRect.top = (int) C49347td3.m12002a(24, context2);
                    Context context3 = parent.getContext();
                    Intrinsics.checkNotNullExpressionValue(context3, "parent.context");
                    outRect.bottom = (int) C49347td3.m12002a(4, context3);
                } else {
                    if (itemViewType == C32634Ej4.item_repair_category || itemViewType == C32634Ej4.item_quick_links_section) {
                        z = true;
                    } else {
                        z = false;
                    }
                    if (z) {
                        ...
                        outRect.top = (int) C49347td3.m12002a(12, context4);
                    }
                }
                if (intValue == 0) {
                    outRect.top = this.f50184b;
                    return;
                }
