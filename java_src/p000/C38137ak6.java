...
public class C38137ak6 extends CM4 {

    /* renamed from: c */
    public static boolean f51110c = false;

    /* renamed from: b */
    public final WeakReference<Context> f51111b;

    public C38137ak6(Context context, Resources resources) {
        super(resources);
        this.f51111b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m70804b() {
        return f51110c;
    }

    /* renamed from: c */
    public static boolean m70803c() {
        m70804b();
        return false;
    }

    @Override // p000.CM4, android.content.res.Resources
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = this.f51111b.get();
        if (context != null) {
            return C46228oM4.m21280g().m21268s(context, this, i);
        }
        return m112292a(i);
    }
