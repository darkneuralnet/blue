...
public class C50396vO5 {

    /* renamed from: a */
    public static final Map<String, String> f113992a;

    /* renamed from: b */
    public static final Map<String, String> f113993b;

    /* renamed from: c */
    public static final Map<String, String> f113994c;
    ...
    static {
        ...
        f113992a = Collections.unmodifiableMap(hashMap);
        ...
        f113993b = Collections.unmodifiableMap(hashMap2);
        ...
        f113994c = Collections.unmodifiableMap(hashMap3);
    }
    ...
    /* renamed from: a */
    public static String m8755a(UUID uuid) {
        String m8752d = m8752d(uuid);
        if (m8752d != null) {
            return f113993b.get(m8752d);
        }
        return null;
    }

    /* renamed from: b */
    public static String m8754b(UUID uuid) {
        String m8752d = m8752d(uuid);
        if (m8752d != null) {
            return f113994c.get(m8752d);
        }
        return null;
    }

    /* renamed from: c */
    public static String m8753c(UUID uuid) {
        String m8752d = m8752d(uuid);
        if (m8752d != null) {
            return f113992a.get(m8752d);
        }
        return null;
    }

    /* renamed from: d */
    public static String m8752d(UUID uuid) {
    ...
    /* renamed from: e */
    public static boolean m8751e(String str) {
