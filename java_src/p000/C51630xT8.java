...
public final class C51630xT8 implements Parcelable.Creator<PolygonOptions> {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                case 2:
                    ...
                    break;
                case 3:
                    SafeParcelReader.readList(parcel, readHeader, arrayList, C51630xT8.class.getClassLoader());
                    break;
                case 4:
