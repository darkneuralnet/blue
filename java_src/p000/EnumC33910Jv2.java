...
public enum EnumC33910Jv2 implements InterfaceC33442Hv2 {
    ...
    EnumC33910Jv2(String str) {
        this.f18768b = str;
    }

    @Override // p000.InterfaceC33442Hv2
    /* renamed from: t2 */
    public String mo99563t2(Locale locale) {
        try {
            String replaceAll = EnumC33910Jv2.class.getName().replaceAll("\\.", "/");
