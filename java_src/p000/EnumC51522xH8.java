...
public enum EnumC51522xH8 implements InterfaceC39754dR7 {
    NO_ERROR(0),
    ...
    CAMERAX_SOURCE_ERROR(Constants.BUCKET_REDIRECT_STATUS_CODE),
    ...
    CODE_SCANNER_APP_NAME_UNAVAILABLE(Constants.BUCKET_ACCESS_FORBIDDEN_STATUS_CODE),
    CODE_SCANNER_TASK_IN_PROGRESS(Constants.NO_SUCH_BUCKET_STATUS_CODE),
