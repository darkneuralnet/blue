...
public enum IH8 implements InterfaceC39754dR7 {
    UNKNOWN_EVENT(0),
    ...
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(C11925l.AbstractC11930e.DEFAULT_DRAG_ANIMATION_DURATION),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(Constants.BUCKET_ACCESS_FORBIDDEN_STATUS_CODE),
    OPTIONAL_MODULE_LANGUAGE_ID_INFERENCE(Constants.NO_SUCH_BUCKET_STATUS_CODE),
    ...
    @Override // p000.InterfaceC39754dR7
