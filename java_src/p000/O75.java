...
@Metadata(m28433d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u0012\u0010\u0004\u001a\u00020\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001¨\u0006\u0005"}, m28432d2 = {"Lco/bird/android/model/wire/WireFrequentFlyerProgress;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "Landroid/graphics/drawable/Drawable;", C17296a.f69688o, "ride-end-summary_release"}, m28431k = 2, m28430mv = {1, 8, 0})
/* renamed from: O75 */
...
public final class O75 {
    ...
    /* renamed from: a */
    public static final Drawable m92876a(WireFrequentFlyerProgress wireFrequentFlyerProgress, Context context) {
        Intrinsics.checkNotNullParameter(wireFrequentFlyerProgress, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        if (C5828a.$EnumSwitchMapping$0[wireFrequentFlyerProgress.getProgressType().ordinal()] == 1) {
