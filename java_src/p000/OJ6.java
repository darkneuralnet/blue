...
public final class OJ6 {
    ...
    /* renamed from: a */
    public static final Map<Integer, String> f26383a;

    /* renamed from: b */
    public static final Map<Integer, String> f26384b;
    ...
    /* renamed from: a */
    public static String m92415a(int i) {
        Map<Integer, String> map = f26383a;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            String str = map.get(valueOf);
            String str2 = f26384b.get(valueOf);
