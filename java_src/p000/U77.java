...
public final class U77 implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    arrayList2 = SafeParcelReader.createTypedList(parcel, readHeader, zboq.CREATOR);
                    break;
                default:
        ...
        return new zboi(str, rect, arrayList, str2, f, f2, arrayList2);
    }
