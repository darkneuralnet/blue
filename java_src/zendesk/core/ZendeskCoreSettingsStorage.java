...
class ZendeskCoreSettingsStorage implements CoreSettingsStorage {
    ...
    public BlipsSettings getBlipsSettings() {
        ...
        C33694Ix2.m101457b(LOG_TAG, "Unable to load blips settings, returning defaults.", new Object[0]);
    ...
    public CoreSettings getCoreSettings() {
        ...
        C33694Ix2.m101457b(LOG_TAG, "Unable to load Core SDK Settings, returning default settings.", new Object[0]);
