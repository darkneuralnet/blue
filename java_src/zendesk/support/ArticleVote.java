...
public class ArticleVote {
    ...
    public boolean equals(Object obj) {
        ...
        Long l = this.f121941id;
        if (l == null ? articleVote.f121941id != null : !l.equals(articleVote.f121941id)) {
            return false;
        }
        String str = this.url;
    ...
    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.f121941id, this.url, this.userId, this.value, this.itemId, this.itemType, this.createdAt, this.updatedAt});
    }
}
