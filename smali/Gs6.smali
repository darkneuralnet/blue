...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v5}, LBR5;->c()Landroid/util/Size;
    ...
    invoke-virtual {v6}, LBR5;->c()Landroid/util/Size;
    ...
    check-cast p6, Landroidx/camera/core/p;
    ...
    invoke-static/range {v2 .. v7}, LGs6;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    check-cast p5, Landroidx/camera/core/p;
...
.method public static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, LGs6;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p0, p1}, LGs6;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, LGs6;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method public static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v1, p1}, LGs6;->e(FF)F
    ...
    invoke-static {v3, p1}, LGs6;->e(FF)F
...
.method public static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v2, p1}, LGs6;->f(FF)F
    ...
    invoke-static {p0, p1}, LGs6;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p4}, LGs6;->h(ZI)Z

    move-result p2

    invoke-static {p2, p5, p0, p1}, LGs6;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
