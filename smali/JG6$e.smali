...
.method public constructor <init>(LJG6;LEb5;)V
    ...
    iput-object p1, p0, LJG6$e;->d:LJG6;
...
.method public bridge synthetic i(LqV5;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, LJG6$e;->p(LqV5;LHG6;)V

    return-void
.end method

.method public p(LqV5;LHG6;)V
    .locals 10
    ...
    invoke-virtual {p2}, Llz0;->d()LS73;

    move-result-object v8

    invoke-static {v8}, LPG6;->g(LS73;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, LoV5;->S0(IJ)V

    invoke-virtual {p2}, Llz0;->g()Z

    move-result v6

    int-to-long v8, v6

    invoke-interface {p1, v5, v8, v9}, LoV5;->S0(IJ)V

    invoke-virtual {p2}, Llz0;->h()Z
    ...
    invoke-virtual {p2}, Llz0;->b()J

    move-result-wide v2

    invoke-interface {p1, v1, v2, v3}, LoV5;->S0(IJ)V

    invoke-virtual {p2}, Llz0;->a()J

    move-result-wide v1

    invoke-interface {p1, v0, v1, v2}, LoV5;->S0(IJ)V

    invoke-virtual {p2}, Llz0;->c()Ljava/util/Set;

    move-result-object p2

    invoke-static {p2}, LPG6;->i(Ljava/util/Set;)[B
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, LoV5;->X0(I[B)V
