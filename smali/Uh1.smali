...
# static fields
.field public static final c:Ljava/lang/String; = "Uh1"
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LUh1;->d:Ljava/lang/ThreadLocal;

    new-instance v0, LUh1$b;

    invoke-direct {v0}, LUh1$b;-><init>()V

    sput-object v0, LUh1;->e:Ljava/lang/ThreadLocal;

    new-instance v0, LUh1$c;

    invoke-direct {v0}, LUh1$c;-><init>()V

    sput-object v0, LUh1;->f:Ljava/lang/ThreadLocal;

    invoke-static {}, LUh1;->n()Ljava/util/List;

    move-result-object v0

    sput-object v0, LUh1;->g:Ljava/util/List;
    ...
    sput-object v0, LUh1;->h:Ljava/util/List;
...
.method public static c(Ljava/lang/String;)Ljava/util/Date;
    ...
    sget-object v0, LUh1;->d:Ljava/lang/ThreadLocal;
...
.method public static d(Ljava/lang/String;)Ljava/util/Date;
    ...
    sget-object v0, LUh1;->f:Ljava/lang/ThreadLocal;
...
.method public static e(Ljava/lang/String;)Ljava/util/Date;
    ...
    sget-object v0, LUh1;->e:Ljava/lang/ThreadLocal;
...
.method public static h(Ljava/io/File;)LUh1;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {p0}, LUh1;->i(Ljava/lang/String;)LUh1;
...
.method public static i(Ljava/lang/String;)LUh1;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v1, p0}, LXh1;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, LUh1;-><init>(LXh1;)V

    return-object v0
.end method

.method public static j(Landroidx/camera/core/i;)LUh1;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, Landroidx/camera/core/i;->A0()[Landroidx/camera/core/i$a;
    ...
    invoke-interface {p0}, Landroidx/camera/core/i$a;->e()Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, LUh1;->k(Ljava/io/InputStream;)LUh1;
...
.method public static k(Ljava/io/InputStream;)LUh1;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v1, p0}, LXh1;-><init>(Ljava/io/InputStream;)V
...
.method public A()V
    ...
    :cond_0
    iget-object v0, p0, LUh1;->a:LXh1;

    invoke-virtual {v0}, LXh1;->W()V
...
.method public final a()V
    ...
    invoke-static {v0, v1}, LUh1;->f(J)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, LUh1;->a:LXh1;

    const-string v4, "DateTime"

    invoke-virtual {v3, v4, v2}, LXh1;->b0(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_0
    invoke-static {v2}, LUh1;->d(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object v1, p0, LUh1;->a:LXh1;

    const-string v2, "SubSecTime"

    invoke-virtual {v1, v2, v0}, LXh1;->b0(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public b(Landroid/location/Location;)V
    ...
    invoke-virtual {v0, p1}, LXh1;->c0(Landroid/location/Location;)V

    return-void
.end method

.method public g(LUh1;)V
    .locals 4

    new-instance v0, Ljava/util/ArrayList;

    sget-object v1, LUh1;->g:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    sget-object v1, LUh1;->h:Ljava/util/List;
    ...
    iget-object v2, p0, LUh1;->a:LXh1;

    invoke-virtual {v2, v1}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p1, LUh1;->a:LXh1;

    invoke-virtual {v3, v1}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v1, v2}, LXh1;->b0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public o()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public p()I
    ...
    invoke-virtual {v0, v1, v2}, LXh1;->i(Ljava/lang/String;I)I
...
.method public q()Landroid/location/Location;
    ...
    iget-object v1, v0, LUh1;->a:LXh1;

    const-string v2, "GPSProcessingMethod"

    invoke-virtual {v1, v2}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, v0, LUh1;->a:LXh1;

    invoke-virtual {v2}, LXh1;->m()[D

    move-result-object v2

    iget-object v3, v0, LUh1;->a:LXh1;

    const-wide/16 v4, 0x0

    invoke-virtual {v3, v4, v5}, LXh1;->f(D)D
    ...
    invoke-virtual {v3, v8, v4, v5}, LXh1;->h(Ljava/lang/String;D)D
    ...
    invoke-virtual {v3, v10}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v11, v0, LUh1;->a:LXh1;

    const-string v12, "GPSDateStamp"

    invoke-virtual {v11, v12}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    iget-object v12, v0, LUh1;->a:LXh1;

    const-string v13, "GPSTimeStamp"

    invoke-virtual {v12, v13}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v0, v11, v12}, LUh1;->y(Ljava/lang/String;Ljava/lang/String;)J
    ...
    sget-object v1, LUh1;->c:Ljava/lang/String;
    ...
    invoke-static {v8, v9}, LUh1$d;->a(D)LUh1$d$a;

    move-result-object v1

    invoke-virtual {v1}, LUh1$d$a;->a()D
    ...
    :cond_8
    invoke-static {v8, v9}, LUh1$d;->b(D)LUh1$d$a;
    ...
    :cond_9
    invoke-static {v8, v9}, LUh1$d;->c(D)LUh1$d$a;
...
.method public t()J
    ...
    invoke-virtual {p0, v0}, LUh1;->x(Ljava/lang/String;)J
    ...
    invoke-virtual {v2, v3}, LXh1;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, LUh1;->q()Landroid/location/Location;

    move-result-object v3

    aput-object v3, v1, v2

    invoke-virtual {p0}, LUh1;->t()J
    ...
    invoke-virtual {p0}, LUh1;->o()Ljava/lang/String;
...
.method public final x(Ljava/lang/String;)J
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, LUh1;->d(Ljava/lang/String;)Ljava/util/Date;
...
.method public final y(Ljava/lang/String;Ljava/lang/String;)J
    ...
    :try_start_0
    invoke-static {p1}, LUh1;->c(Ljava/lang/String;)Ljava/util/Date;
    ...
    :try_start_1
    invoke-static {p2}, LUh1;->e(Ljava/lang/String;)Ljava/util/Date;
    ...
    invoke-virtual {p0, p1}, LUh1;->x(Ljava/lang/String;)J
...
.method public z(I)V
    ...
    sget-object v0, LUh1;->c:Ljava/lang/String;
    ...
    invoke-virtual {p1, v1, v0}, LXh1;->b0(Ljava/lang/String;Ljava/lang/String;)V
