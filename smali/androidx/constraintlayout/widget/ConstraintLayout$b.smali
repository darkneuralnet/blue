...
.method public final a()V
    ...
    invoke-virtual {v2, v3}, Landroidx/constraintlayout/widget/ConstraintHelper;->x(Landroidx/constraintlayout/widget/ConstraintLayout;)V
...
.method public final b(Liz0;LOE$a;)V
    .locals 17
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Liz0;->X()I
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->l0()Z

    move-result v3

    if-nez v3, :cond_1

    iput v5, v2, LOE$a;->e:I

    iput v5, v2, LOE$a;->f:I

    iput v5, v2, LOE$a;->g:I

    return-void

    :cond_1
    invoke-virtual/range {p1 .. p1}, Liz0;->M()Liz0;
    ...
    :cond_2
    iget-object v3, v2, LOE$a;->a:Liz0$b;

    iget-object v4, v2, LOE$a;->b:Liz0$b;

    iget v6, v2, LOE$a;->c:I

    iget v7, v2, LOE$a;->d:I
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->u()Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->p0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->D()I
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->q0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->W()I
    ...
    invoke-static {v9, v11}, Lhy3;->b(II)Z
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->r()I
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->E()I
    ...
    invoke-virtual/range {p1 .. p1}, Liz0;->F()I
    ...
    iput v3, v2, LOE$a;->e:I

    invoke-virtual/range {p1 .. p1}, Liz0;->z()I

    move-result v3

    iput v3, v2, LOE$a;->f:I

    invoke-virtual/range {p1 .. p1}, Liz0;->r()I

    move-result v1

    iput v1, v2, LOE$a;->g:I
    ...
    :goto_c
    sget-object v11, Liz0$b;->e:Liz0$b;

    if-eq v4, v11, :cond_1e

    sget-object v12, Liz0$b;->b:Liz0$b;
    ...
    invoke-virtual {v9, v8, v6, v7}, Landroidx/constraintlayout/widget/VirtualLayout;->C(Lzu6;II)V
    ...
    :goto_14
    invoke-virtual {v1, v6, v7}, Liz0;->Z0(II)V
    ...
    invoke-static {v6, v0}, Lhy3;->b(II)Z
    ...
    :goto_1c
    iget v3, v2, LOE$a;->c:I

    if-ne v15, v3, :cond_33

    iget v3, v2, LOE$a;->d:I
    ...
    iput-boolean v1, v2, LOE$a;->i:Z

    :cond_35
    iput v15, v2, LOE$a;->e:I

    iput v5, v2, LOE$a;->f:I

    iput-boolean v0, v2, LOE$a;->h:Z

    iput v14, v2, LOE$a;->g:I
