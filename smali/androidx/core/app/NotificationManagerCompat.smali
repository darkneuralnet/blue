...
.method public createNotificationChannel(LPb3;)V
    .locals 0

    invoke-virtual {p1}, LPb3;->a()Landroid/app/NotificationChannel;
...
.method public createNotificationChannel(Landroid/app/NotificationChannel;)V
    ...
    invoke-static {v0, p1}, Lda3;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    :cond_0
    return-void
.end method

.method public createNotificationChannelGroup(LZb3;)V
    .locals 0

    invoke-virtual {p1}, LZb3;->b()Landroid/app/NotificationChannelGroup;
...
.method public createNotificationChannelGroup(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-static {v0, p1}, LXc3;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannelGroup;)V
...
.method public createNotificationChannelGroups(Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, LWc3;->a(Landroid/app/NotificationManager;Ljava/util/List;)V
...
.method public createNotificationChannelGroupsCompat(Ljava/util/List;)V
    ...
    invoke-virtual {v1}, LZb3;->b()Landroid/app/NotificationChannelGroup;
    ...
    invoke-static {p1, v0}, LWc3;->a(Landroid/app/NotificationManager;Ljava/util/List;)V
...
.method public createNotificationChannelsCompat(Ljava/util/List;)V
    ...
    invoke-virtual {v1}, LPb3;->a()Landroid/app/NotificationChannel;
    ...
    invoke-static {p1, v0}, LRc3;->a(Landroid/app/NotificationManager;Ljava/util/List;)V
...
.method public deleteNotificationChannel(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, LZc3;->a(Landroid/app/NotificationManager;Ljava/lang/String;)V
...
.method public deleteNotificationChannelGroup(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, LTc3;->a(Landroid/app/NotificationManager;Ljava/lang/String;)V
...
.method public deleteUnlistedNotificationChannels(Ljava/util/Collection;)V
    ...
    invoke-static {v0}, LSc3;->a(Landroid/app/NotificationManager;)Ljava/util/List;
    ...
    invoke-static {v1}, Lpb3;->a(Landroid/app/NotificationChannel;)Ljava/lang/String;
    ...
    invoke-static {v1}, LIb3;->a(Landroid/app/NotificationChannel;)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, LZc3;->a(Landroid/app/NotificationManager;Ljava/lang/String;)V
...
.method public getNotificationChannel(Ljava/lang/String;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {v0, p1, p2}, LVc3;->a(Landroid/app/NotificationManager;Ljava/lang/String;Ljava/lang/String;)Landroid/app/NotificationChannel;
...
.method public getNotificationChannelCompat(Ljava/lang/String;)LPb3;
    .locals 2
    ...
    invoke-direct {v0, p1}, LPb3;-><init>(Landroid/app/NotificationChannel;)V
...
.method public getNotificationChannelCompat(Ljava/lang/String;Ljava/lang/String;)LPb3;
    .locals 2
    ...
    invoke-direct {p2, p1}, LPb3;-><init>(Landroid/app/NotificationChannel;)V
...
.method public getNotificationChannelGroup(Ljava/lang/String;)Landroid/app/NotificationChannelGroup;
    ...
    invoke-static {v0, p1}, Lad3;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannelGroup;
    ...
    invoke-static {v1}, LUc3;->a(Ljava/lang/Object;)Landroid/app/NotificationChannelGroup;

    move-result-object v1

    invoke-static {v1}, LQb3;->a(Landroid/app/NotificationChannelGroup;)Ljava/lang/String;
...
.method public getNotificationChannelGroupCompat(Ljava/lang/String;)LZb3;
    .locals 2
    ...
    invoke-direct {v0, p1}, LZb3;-><init>(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-direct {v0, p1, v1}, LZb3;-><init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
...
.method public getNotificationChannelGroups()Ljava/util/List;
    ...
    invoke-static {v0}, LYc3;->a(Landroid/app/NotificationManager;)Ljava/util/List;
...
.method public getNotificationChannelGroupsCompat()Ljava/util/List;
    ...
    invoke-static {v4}, LUc3;->a(Ljava/lang/Object;)Landroid/app/NotificationChannelGroup;
    ...
    invoke-direct {v5, v4}, LZb3;-><init>(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-direct {v5, v4, v0}, LZb3;-><init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
...
.method public getNotificationChannelsCompat()Ljava/util/List;
    ...
    invoke-static {v2}, LYb3;->a(Ljava/lang/Object;)Landroid/app/NotificationChannel;

    move-result-object v2

    new-instance v3, LPb3;

    invoke-direct {v3, v2}, LPb3;-><init>(Landroid/app/NotificationChannel;)V
