...
.method public static C0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->B0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    :cond_1
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->H0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method public static H0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 4
...
.method public final A0(LN96;)V
    ...
    invoke-static {v1}, Landroidx/transition/ChangeImageTransform;->C0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method public final F0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 4
    ...
    invoke-direct {v1}, Landroidx/transition/d$a;-><init>()V
...
.method public final G0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    .locals 5
    ...
    sget-object v3, LqN2;->a:Landroid/graphics/Matrix;
...
.method public k(LN96;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeImageTransform;->A0(LN96;)V
...
.method public r(Landroid/view/ViewGroup;LN96;LN96;)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object p2, p2, LN96;->a:Ljava/util/Map;
    ...
    iget-object v3, p3, LN96;->a:Ljava/util/Map;
    ...
    :cond_5
    iget-object p1, p3, LN96;->b:Landroid/view/View;
    ...
    sget-object p2, LqN2;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    sget-object v2, LqN2;->a:Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->F0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeImageTransform;->G0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
