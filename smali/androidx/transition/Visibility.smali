...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v0, v1, v1}, LHb6;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method public final A0(LN96;)V
    ...
    iget-object v1, p1, LN96;->b:Landroid/view/View;
...
.method public B0()I
    ...
    iget v0, p0, Landroidx/transition/Visibility;->P:I

    return v0
.end method

.method public final C0(LN96;LN96;)Landroidx/transition/Visibility$c;
    .locals 7
    ...
    iget-object v6, p1, LN96;->a:Ljava/util/Map;
    ...
    iget-object v6, p2, LN96;->a:Ljava/util/Map;
...
.method public F0(Landroid/view/ViewGroup;LN96;ILN96;I)Landroid/animation/Animator;
    .locals 2
    ...
    iget-object p3, p4, LN96;->b:Landroid/view/View;
    ...
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->D(Landroid/view/View;Z)LN96;

    move-result-object v1

    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->U(Landroid/view/View;Z)LN96;

    move-result-object p3

    invoke-virtual {p0, v1, p3}, Landroidx/transition/Visibility;->C0(LN96;LN96;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual {p0, p1, p3, p2, p4}, Landroidx/transition/Visibility;->G0(Landroid/view/ViewGroup;Landroid/view/View;LN96;LN96;)Landroid/animation/Animator;
...
.method public H0(Landroid/view/ViewGroup;LN96;ILN96;I)Landroid/animation/Animator;
    .locals 17
    ...
    :cond_1
    iget-object v5, v2, LN96;->b:Landroid/view/View;

    if-eqz v3, :cond_2

    iget-object v8, v3, LN96;->b:Landroid/view/View;
    ...
    :goto_0
    sget v9, LUg4;->save_overlay_view:I
    ...
    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->U(Landroid/view/View;Z)LN96;

    move-result-object v14

    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->D(Landroid/view/View;Z)LN96;

    move-result-object v15

    invoke-virtual {v0, v14, v15}, Landroidx/transition/Visibility;->C0(LN96;LN96;)Landroidx/transition/Visibility$c;
    ...
    iget-boolean v13, v0, Landroidx/transition/Transition;->x:Z
    ...
    iget-object v4, v2, LN96;->a:Ljava/util/Map;
    ...
    invoke-static/range {p1 .. p1}, Llr6;->b(Landroid/view/ViewGroup;)Lir6;

    move-result-object v4

    invoke-interface {v4, v10}, Lir6;->c(Landroid/view/View;)V

    :cond_b
    invoke-virtual {v0, v1, v10, v2, v3}, Landroidx/transition/Visibility;->I0(Landroid/view/ViewGroup;Landroid/view/View;LN96;LN96;)Landroid/animation/Animator;
    ...
    invoke-interface {v1, v10}, Lir6;->d(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/transition/Transition;->d(Landroidx/transition/Transition$f;)Landroidx/transition/Transition;
    ...
    invoke-static {v8, v11}, LXt6;->i(Landroid/view/View;I)V

    invoke-virtual {v0, v1, v8, v2, v3}, Landroidx/transition/Visibility;->I0(Landroid/view/ViewGroup;Landroid/view/View;LN96;LN96;)Landroid/animation/Animator;
    ...
    invoke-static {v1, v2}, LCf;->a(Landroid/animation/Animator;Landroid/animation/AnimatorListenerAdapter;)V

    invoke-virtual {v0, v2}, Landroidx/transition/Transition;->d(Landroidx/transition/Transition$f;)Landroidx/transition/Transition;

    goto :goto_8

    :cond_f
    invoke-static {v8, v5}, LXt6;->i(Landroid/view/View;I)V
...
.method public S()[Ljava/lang/String;
    ...
    sget-object v0, Landroidx/transition/Visibility;->Q:[Ljava/lang/String;

    return-object v0
.end method

.method public V(LN96;LN96;)Z
    .locals 4
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Landroidx/transition/Visibility;->C0(LN96;LN96;)Landroidx/transition/Visibility$c;
...
.method public k(LN96;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/Visibility;->A0(LN96;)V
...
.method public r(Landroid/view/ViewGroup;LN96;LN96;)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/transition/Visibility;->C0(LN96;LN96;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/transition/Visibility;->F0(Landroid/view/ViewGroup;LN96;ILN96;I)Landroid/animation/Animator;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/Visibility;->H0(Landroid/view/ViewGroup;LN96;ILN96;I)Landroid/animation/Animator;
