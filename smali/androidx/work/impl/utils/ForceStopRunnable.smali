...
.method public constructor <init>(Landroid/content/Context;LaD6;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LaD6;

    invoke-virtual {p2}, LaD6;->q()LTZ3;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:LTZ3;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LaD6;

    invoke-static {v0, v1}, LgY5;->i(Landroid/content/Context;LaD6;)Z
    ...
    :try_start_0
    invoke-interface {v2}, LIG6;->t()Ljava/util/List;
    ...
    sget-object v9, LUC6$a;->b:LUC6$a;

    iget-object v10, v8, LHG6;->a:Ljava/lang/String;

    invoke-interface {v2, v9, v10}, LIG6;->j(LUC6$a;Ljava/lang/String;)I

    iget-object v8, v8, LHG6;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, LIG6;->o(Ljava/lang/String;J)I

    goto :goto_1

    :cond_1
    invoke-interface {v3}, LzG6;->a()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LaD6;

    invoke-virtual {v0}, LaD6;->y()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LaD6;

    invoke-virtual {v0}, LaD6;->q()LTZ3;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LTZ3;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:LTZ3;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, LTZ3;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LaD6;

    invoke-virtual {v2}, LaD6;->s()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, LTw1;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->d:LTZ3;

    invoke-virtual {v2}, LTZ3;->a()J
    ...
    invoke-static {v6}, LUw1;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, LVw1;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, LWw1;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, LBx2;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-static {v0}, LMC6;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-virtual {v2, v3, v1, v0}, LBx2;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->e()Lrz0;
    ...
    invoke-virtual {v1, v3, v4, v2}, LBx2;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-interface {v0, v2}, Lrz0;->accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, LBx2;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, LBx2;->c(Ljava/lang/String;Ljava/lang/String;)V
