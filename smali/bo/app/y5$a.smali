.class public final Lbo/app/y5$a;
...
.method public synthetic constructor <init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-direct {p0}, Lbo/app/y5$a;-><init>()V
...
.method public final a(Landroid/content/SharedPreferences;)Ljava/util/Map;
    ...
    new-instance v13, Lbo/app/y5$a$h;

    invoke-direct {v13, v0, v6}, Lbo/app/y5$a$h;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v10, Lk20$a;->e:Lk20$a;

    new-instance v13, Lbo/app/y5$a$i;

    invoke-direct {v13, v6}, Lbo/app/y5$a$i;-><init>(Ljava/lang/String;)V
...
.method public final a(Ljava/util/List;)Lkotlin/Pair;
    ...
    check-cast v3, Lbo/app/y2;

    invoke-interface {v3}, Lbo/app/y2;->m()Z
    ...
    new-instance v10, Lbo/app/y5$a$j;

    invoke-direct {v10, v3}, Lbo/app/y5$a$j;-><init>(Lbo/app/y2;)V
    ...
    :cond_1
    invoke-interface {v3}, Lbo/app/y2;->b()Ljava/util/List;
    ...
    check-cast v5, Lbo/app/k4;

    invoke-virtual {v5}, Lbo/app/k4;->b()Ljava/lang/String;
    ...
    new-instance v13, Lbo/app/y5$a$k;

    invoke-direct {v13, v3, v6}, Lbo/app/y5$a$k;-><init>(Lbo/app/y2;Ljava/lang/String;)V
...
.method public final a(Landroid/content/SharedPreferences$Editor;Ljava/util/Map;Ljava/util/Set;Ljava/util/Map;)V
    ...
    new-instance v12, Lbo/app/y5$a$d;

    invoke-direct {v12, v5}, Lbo/app/y5$a$d;-><init>(Ljava/lang/String;)V
    ...
    new-instance v13, Lbo/app/y5$a$e;

    invoke-direct {v13, v6, v5}, Lbo/app/y5$a$e;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lc20;->a(Ljava/io/File;)V
...
.method public final a(Ljava/io/File;Ljava/util/Map;Ljava/util/Map;)V
    ...
    new-instance v5, Lbo/app/y5$a$a;

    invoke-direct {v5, p1}, Lbo/app/y5$a$a;-><init>([Ljava/io/File;)V
    ...
    sget-object v1, Lbo/app/y5;->e:Lbo/app/y5$a;
    ...
    new-instance v5, Lbo/app/y5$a$b;

    invoke-direct {v5, p2}, Lbo/app/y5$a$b;-><init>(Ljava/io/File;)V
    ...
    invoke-static {p2}, Lc20;->a(Ljava/io/File;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    sget-object v5, Lbo/app/y5$a$c;->b:Lbo/app/y5$a$c;
...
.method public final b(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v8, Lbo/app/y5$a$g;

    invoke-direct {v8, v0, p1}, Lbo/app/y5$a$g;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;Ljava/lang/String;)V
