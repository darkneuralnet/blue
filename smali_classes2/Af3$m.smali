...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LAf3;->setCurrentLocation(Lco/bird/android/model/wire/WireLocation;D)V
.end annotation
...
# direct methods
.method public constructor <init>(Lco/bird/android/model/wire/WireLocation;LAf3;D)V
    .locals 0

    iput-object p1, p0, LAf3$m;->g:Lco/bird/android/model/wire/WireLocation;

    iput-object p2, p0, LAf3$m;->h:LAf3;

    iput-wide p3, p0, LAf3$m;->i:D
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, LAf3$m;->invoke(LcD1;)V
...
.method public final invoke(LcD1;)V
    ...
    iget-object v1, p0, LAf3$m;->g:Lco/bird/android/model/wire/WireLocation;

    invoke-virtual {v1}, Lco/bird/android/model/wire/WireLocation;->getLatitude()D

    move-result-wide v1

    iget-object v3, p0, LAf3$m;->g:Lco/bird/android/model/wire/WireLocation;
    ...
    iget-object v1, p0, LAf3$m;->h:LAf3;

    invoke-static {v1}, LAf3;->access$getCircleMarker$p(LAf3;)Lxj0;
    ...
    iget-object v3, p0, LAf3$m;->h:LAf3;
    ...
    invoke-static {v1, v2}, LAf3;->access$setLocationMarker$p(LAf3;LfM2;)V
    ...
    iget-object v2, p0, LAf3$m;->h:LAf3;
    ...
    invoke-static {v1, v0}, LAf3;->access$setCircleMarker$p(LAf3;Lxj0;)V
    ...
    invoke-static {v1}, LAf3;->access$getLocationMarker$p(LAf3;)LfM2;
    ...
    :goto_1
    iget-object v0, p0, LAf3$m;->h:LAf3;

    invoke-static {v0}, LAf3;->access$getBinding$p(LAf3;)LZf3;

    move-result-object v0

    iget-object v0, v0, LZf3;->c:Landroid/widget/LinearLayout;
