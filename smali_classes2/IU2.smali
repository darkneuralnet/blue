...
.annotation runtime Lkotlin/Metadata;
    d1 = {
        "\u0000R\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0008\n\u0000\n\u0002\u0010\u000b\n\u0002\u0008\u0002\n\u0002\u0018\u0002\n\u0002\u0008\u0005\n\u0002\u0018\u0002\n\u0002\u0008\u0002\n\u0002\u0018\u0002\n\u0002\u0008\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0008\u0007\n\u0002\u0018\u0002\n\u0002\u0008\u0004\n\u0002\u0018\u0002\n\u0002\u0008\u0008\n\u0002\u0018\u0002\n\u0002\u0008\u0007\u0008\u0007\u0018\u00002\u00020\u0001B#\u0008\u0007\u0012\u000e\u0008\u0001\u0010\u0018\u001a\u0008\u0012\u0004\u0012\u00020\u00140\u0013\u0012\u0008\u0008\u0001\u0010\u0011\u001a\u00020\u0010\u00a2\u0006\u0004\u0008/\u00100J\u0018\u0010\u0006\u001a\u00020\u00002\u0008\u0008\u0001\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004J\u0016\u0010\t\u001a\u00020\u00002\u0006\u0010\u0008\u001a\u00020\u00072\u0006\u0010\u0005\u001a\u00020\u0004J\u000e\u0010\u000b\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u0004J\u0006\u0010\u000c\u001a\u00020\u0000J\u0006\u0010\u000e\u001a\u00020\rJ\u0006\u0010\u000f\u001a\u00020\rJ\u0010\u0010\u0012\u001a\u00020\u00072\u0006\u0010\u0011\u001a\u00020\u0010H\u0002R\u001d\u0010\u0018\u001a\u0008\u0012\u0004\u0012\u00020\u00140\u00138\u0006\u00a2\u0006\u000c\n\u0004\u0008\u000e\u0010\u0015\u001a\u0004\u0008\u0016\u0010\u0017R\u0017\u0010\u0011\u001a\u00020\u00108\u0006\u00a2\u0006\u000c\n\u0004\u0008\u000b\u0010\u0019\u001a\u0004\u0008\u001a\u0010\u001bR\u0017\u0010 \u001a\u00020\u001c8\u0006\u00a2\u0006\u000c\n\u0004\u0008\u000c\u0010\u001d\u001a\u0004\u0008\u001e\u0010\u001fR\u0016\u0010#\u001a\u00020!8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\u0008\u0012\u0010\"R$\u0010)\u001a\u0004\u0018\u00010\u00078\u0000@\u0000X\u0080\u000e\u00a2\u0006\u0012\n\u0004\u0008\u0006\u0010$\u001a\u0004\u0008%\u0010&\"\u0004\u0008\'\u0010(R\u001a\u0010.\u001a\u00020*8\u0000X\u0080\u0004\u00a2\u0006\u000c\n\u0004\u0008\t\u0010+\u001a\u0004\u0008,\u0010-\u00a8\u00061"
    }
    d2 = {
        "LIU2;",
        "",
...
.method public constructor <init>(Lcom/uber/autodispose/lifecycle/LifecycleScopeProvider;Landroid/content/Context;)V
    ...
    iput-object p1, p0, LIU2;->a:Lcom/uber/autodispose/lifecycle/LifecycleScopeProvider;

    iput-object p2, p0, LIU2;->b:Landroid/content/Context;
    ...
    iput-object v1, p0, LIU2;->c:Lcom/afollestad/materialdialogs/MaterialDialog;

    new-instance p1, Landroid/widget/FrameLayout;

    invoke-direct {p1, p2}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, LIU2;->d:Landroid/widget/FrameLayout;

    new-instance p1, Ltu0;

    invoke-direct {p1}, Ltu0;-><init>()V

    iput-object p1, p0, LIU2;->f:Ltu0;
    ...
    invoke-virtual {p1, p2}, Lcom/afollestad/materialdialogs/internal/message/DialogContentLayout;->setCustomView(Landroid/view/View;)V

    const/4 v2, 0x0

    iget-object v3, p0, LIU2;->d:Landroid/widget/FrameLayout;
...
# virtual methods
.method public final a()LDU2;
    .locals 1

    new-instance v0, LDU2;

    invoke-direct {v0, p0}, LDU2;-><init>(LIU2;)V

    return-object v0
.end method

.method public final b(Z)LIU2;
    .locals 1

    iget-object v0, p0, LIU2;->c:Lcom/afollestad/materialdialogs/MaterialDialog;
...
.method public final c()LIU2;
    .locals 2

    iget-object v0, p0, LIU2;->e:Landroid/view/View;

    if-nez v0, :cond_0

    iget-object v0, p0, LIU2;->b:Landroid/content/Context;

    invoke-virtual {p0, v0}, LIU2;->d(Landroid/content/Context;)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, LIU2;->e:Landroid/view/View;

    iget-object v1, p0, LIU2;->d:Landroid/widget/FrameLayout;
...
.method public final d(Landroid/content/Context;)Landroid/view/View;
    ...
    sget v4, Lrg4;->ic_close:I

    sget v5, Lrf4;->navigationBackgroundColor:I

    sget v6, LDf4;->white:I

    invoke-static {p1, v6}, LfB0;->f(Landroid/content/Context;I)I

    move-result v6

    invoke-static {p1, v4, v5, v6, v1}, LfB0;->m(Landroid/content/Context;IIIZ)Landroid/graphics/drawable/Drawable;
...
.method public final e(IZ)LIU2;
    ...
    invoke-virtual {v0, v1}, Lcom/afollestad/materialdialogs/internal/message/DialogContentLayout;->setCustomView(Landroid/view/View;)V

    iget-object v2, p0, LIU2;->c:Lcom/afollestad/materialdialogs/MaterialDialog;
    ...
    invoke-static/range {v2 .. v10}, Lcom/afollestad/materialdialogs/customview/DialogCustomViewExtKt;->customView$default(Lcom/afollestad/materialdialogs/MaterialDialog;Ljava/lang/Integer;Landroid/view/View;ZZZZILjava/lang/Object;)Lcom/afollestad/materialdialogs/MaterialDialog;

    return-object p0
.end method

.method public final f(Landroid/view/View;Z)LIU2;
    .locals 1
    ...
    iget-object p2, p0, LIU2;->e:Landroid/view/View;

    if-eqz p2, :cond_0

    iget-object v0, p0, LIU2;->d:Landroid/widget/FrameLayout;

    invoke-virtual {v0, p2}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_0
    iget-object p2, p0, LIU2;->d:Landroid/widget/FrameLayout;

    invoke-virtual {p2, p1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p1, p0, LIU2;->e:Landroid/view/View;
...
.method public final h()Ltu0;
    .locals 1

    iget-object v0, p0, LIU2;->f:Ltu0;
...
.method public final j()Lcom/uber/autodispose/lifecycle/LifecycleScopeProvider;
    ...
    iget-object v0, p0, LIU2;->a:Lcom/uber/autodispose/lifecycle/LifecycleScopeProvider;
...
.method public final k()LDU2;
    ...
    invoke-virtual {p0}, LIU2;->a()LDU2;

    move-result-object v0

    invoke-virtual {v0}, LDU2;->o()V
