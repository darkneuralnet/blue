...
.method public constructor <init>(LJQ;Le13;LEa;)V
    ...
    iput-object p1, p0, LFQ;->e:LJQ;

    iput-object p2, p0, LFQ;->f:Le13;

    iput-object p3, p0, LFQ;->g:LEa;

    return-void
.end method

.method public static final synthetic access$getAnalyticsManager$p(LFQ;)LEa;
    .locals 0

    iget-object p0, p0, LFQ;->g:LEa;

    return-object p0
.end method

.method public static final synthetic access$getNavigator$p(LFQ;)Le13;
    .locals 0

    iget-object p0, p0, LFQ;->f:Le13;
...
.method public static synthetic m(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Laf6;
    .locals 0

    invoke-static {p0, p1}, LFQ;->t(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Laf6;
...
.method public static synthetic n(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LFQ;->w(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public static synthetic o(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LFQ;->v(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public static synthetic p(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LFQ;->u(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public static synthetic q(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LFQ;->f(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public static synthetic r(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LFQ;->g(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V

    return-void
.end method

.method public static final t(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Laf6;
    .locals 1
...
.method public bridge synthetic consume(Lrx4;)V
    ...
    invoke-virtual {p0, p1}, LFQ;->s(LGQ;)V

    return-void
.end method

.method public s(LGQ;)V
    .locals 4
    ...
    invoke-direct {v1, p0}, LFQ$a;-><init>(LFQ;)V

    new-instance v2, LzQ;

    invoke-direct {v2, v1}, LzQ;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v1, p0}, LFQ$b;-><init>(LFQ;)V

    new-instance v2, LAQ;

    invoke-direct {v2, v1}, LAQ;-><init>(Lkotlin/jvm/functions/Function1;)V

    invoke-virtual {v0, v2}, Lio/reactivex/c;->B(Lio/reactivex/functions/g;)Lio/reactivex/c;

    move-result-object v0

    const-string v1, "override fun consume(ren\u2026me,\n        )\n      }\n  }"
    ...
    sget-object v2, LFQ$c;->g:LFQ$c;

    new-instance v3, LBQ;

    invoke-direct {v3, v2}, LBQ;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v2, p0}, LFQ$d;-><init>(LFQ;)V

    new-instance v3, LCQ;

    invoke-direct {v3, v2}, LCQ;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v2, p0}, LFQ$e;-><init>(Ljava/lang/Object;)V

    new-instance v3, LDQ;

    invoke-direct {v3, v2}, LDQ;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-interface {p1}, LGQ;->g4()Lio/reactivex/Observable;
    ...
    invoke-direct {v0, p0}, LFQ$f;-><init>(LFQ;)V

    new-instance v1, LEQ;

    invoke-direct {v1, v0}, LEQ;-><init>(Lkotlin/jvm/functions/Function1;)V
