...
.method public b(LG6;)Ljava/lang/String;
    ...
    sget v1, LBj4;->item_preload_v2_option:I
    ...
    :cond_2
    sget p1, LBj4;->item_preload_v2_autoreload_section:I

    if-ne v0, p1, :cond_3

    const-string v2, "auto_reload_section"
...
.method public c(LG6;LG6;)Z
    ...
    invoke-virtual {v2}, LDs;->g()Z

    move-result v2

    invoke-virtual {p2}, LDs;->g()Z
    ...
    invoke-virtual {p2}, LDs;->e()Ljava/lang/String;
    ...
    invoke-virtual {p2}, LDs;->f()Ljava/lang/String;
