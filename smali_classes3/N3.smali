...
# direct methods
.method public constructor <init>(Landroidx/constraintlayout/widget/ConstraintLayout;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/CheckBox;Landroid/widget/CheckBox;Landroid/widget/CheckBox;Landroid/widget/CheckBox;Landroid/widget/Button;Landroidx/cardview/widget/CardView;Landroid/widget/Button;Lcom/airbnb/lottie/LottieAnimationView;Landroid/widget/ScrollView;Landroid/widget/TextView;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LN3;->a:Landroidx/constraintlayout/widget/ConstraintLayout;

    iput-object p2, p0, LN3;->b:Landroid/widget/TextView;

    iput-object p3, p0, LN3;->c:Landroid/widget/TextView;

    iput-object p4, p0, LN3;->d:Landroid/widget/CheckBox;

    iput-object p5, p0, LN3;->e:Landroid/widget/CheckBox;

    iput-object p6, p0, LN3;->f:Landroid/widget/CheckBox;

    iput-object p7, p0, LN3;->g:Landroid/widget/CheckBox;

    iput-object p8, p0, LN3;->h:Landroid/widget/Button;

    iput-object p9, p0, LN3;->i:Landroidx/cardview/widget/CardView;

    iput-object p10, p0, LN3;->j:Landroid/widget/Button;

    iput-object p11, p0, LN3;->k:Lcom/airbnb/lottie/LottieAnimationView;

    iput-object p12, p0, LN3;->l:Landroid/widget/ScrollView;

    iput-object p13, p0, LN3;->m:Landroid/widget/TextView;
...
.method public static d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)LN3;
    ...
    sget v0, Lij4;->activity_helmet_lease_unlock_tutorial:I
...
.method public b()Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iget-object v0, p0, LN3;->a:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public bridge synthetic getRoot()Landroid/view/View;
    ...
    invoke-virtual {p0}, LN3;->b()Landroidx/constraintlayout/widget/ConstraintLayout;
