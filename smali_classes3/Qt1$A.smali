...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "c",
        "(Lco/bird/api/response/OperatorBirdResponse;)Lio/reactivex/h;"
    }
    k = 0x3
    mv = {
        0x1,
...
.method public static synthetic a(LQt1;Lco/bird/android/model/persistence/Bird;)Lio/reactivex/K;
    .locals 0

    invoke-static {p0, p1}, LQt1$A;->d(LQt1;Lco/bird/android/model/persistence/Bird;)Lio/reactivex/K;
...
.method public static synthetic b(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LQt1$A;->e(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V

    return-void
.end method

.method public static final d(LQt1;Lco/bird/android/model/persistence/Bird;)Lio/reactivex/K;
    .locals 1
    ...
    invoke-static {p0}, LQt1;->access$getOperatorManager$p(LQt1;)Lom3;
...
# virtual methods
.method public final c(Lco/bird/api/response/OperatorBirdResponse;)Lio/reactivex/h;
    .locals 3
    ...
    invoke-interface {p1, v0}, Lom3;->S0(Ljava/lang/String;)Lio/reactivex/c;

    move-result-object p1

    iget-object v0, p0, LQt1$A;->g:LQt1;

    iget-object v1, p0, LQt1$A;->h:Lco/bird/android/model/persistence/Bird;

    new-instance v2, LZt1;

    invoke-direct {v2, v0, v1}, LZt1;-><init>(LQt1;Lco/bird/android/model/persistence/Bird;)V
    ...
    iget-object v1, p0, LQt1$A;->g:LQt1;

    invoke-direct {v0, v1}, LQt1$A$a;-><init>(LQt1;)V

    new-instance v1, Lau1;

    invoke-direct {v1, v0}, Lau1;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, LQt1$A;->c(Lco/bird/api/response/OperatorBirdResponse;)Lio/reactivex/h;
