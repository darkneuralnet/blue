...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "b",
        "(Lco/bird/android/model/itemlease/ItemLease;)Lio/reactivex/K;"
    }
    k = 0x3
    mv = {
        0x1,
...
.method public constructor <init>(LRK1;)V
    ...
    iput-object p1, p0, LRK1$t;->g:LRK1;
...
.method public static synthetic a(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Z
    ...
    invoke-static {p0, p1}, LRK1$t;->invoke$lambda$0(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Z
...
# virtual methods
.method public final b(Lco/bird/android/model/itemlease/ItemLease;)Lio/reactivex/K;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v0, "detected active lease created for lock, waiting for smartlock unlock event before closing"

    invoke-static {v0, p1}, Lg46;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object p1, p0, LRK1$t;->g:LRK1;

    invoke-static {p1}, LRK1;->access$getSmartLockManager$p(LRK1;)LhF5;

    move-result-object p1

    iget-object v0, p0, LRK1$t;->g:LRK1;
    ...
    invoke-interface {p1, v0}, LhF5;->d(Ljava/lang/String;)Lio/reactivex/k;

    move-result-object p1

    sget-object v0, LRK1$t$a;->g:LRK1$t$a;

    new-instance v1, LUK1;

    invoke-direct {v1, v0}, LUK1;-><init>(Lkotlin/jvm/functions/Function1;)V

    invoke-virtual {p1, v1}, Lio/reactivex/k;->S(Lio/reactivex/functions/q;)Lio/reactivex/k;

    move-result-object p1

    invoke-virtual {p1}, Lio/reactivex/k;->V()Lio/reactivex/F;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, LRK1$t;->b(Lco/bird/android/model/itemlease/ItemLease;)Lio/reactivex/K;
