...
# direct methods
.method public constructor <init>(LaM;Le13;)V
    .locals 3
    ...
    invoke-direct {v0, v1, v2, v1}, LVd0;-><init>(Ljava/util/List;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {p0, v0}, Lf1;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LTd0;->e:LaM;

    iput-object p2, p0, LTd0;->f:Le13;

    return-void
.end method

.method public static final synthetic access$getNavigator$p(LTd0;)Le13;
    .locals 0

    iget-object p0, p0, LTd0;->f:Le13;
...
.method public static synthetic m(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lio/reactivex/K;
    ...
    invoke-static {p0, p1}, LTd0;->r(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lio/reactivex/K;
...
.method public static synthetic n(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LTd0;->s(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public static synthetic o(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LTd0;->g(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public static synthetic p(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, LTd0;->t(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)V
...
.method public bridge synthetic consume(Lrx4;)V
    ...
    invoke-virtual {p0, p1}, LTd0;->q(LUd0;)V
...
.method public q(LUd0;)V
    ...
    invoke-interface {p1}, LUd0;->K8()Lio/reactivex/Observable;

    move-result-object v0

    new-instance v1, LTd0$a;

    iget-object v2, p0, LTd0;->e:LaM;

    invoke-direct {v1, v2}, LTd0$a;-><init>(Ljava/lang/Object;)V

    new-instance v2, LPd0;

    invoke-direct {v2, v1}, LPd0;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    const-string v1, "renderer.birdId()\n      \u2026ByBirdId)\n      .retry(3)"
    ...
    new-instance v2, LTd0$b;

    invoke-direct {v2, p0}, LTd0$b;-><init>(LTd0;)V

    new-instance v3, LQd0;

    invoke-direct {v3, v2}, LQd0;-><init>(Lkotlin/jvm/functions/Function1;)V

    new-instance v2, LTd0$c;

    invoke-direct {v2, p0}, LTd0$c;-><init>(LTd0;)V

    new-instance v4, LRd0;

    invoke-direct {v4, v2}, LRd0;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-interface {p1}, LUd0;->Z3()Lio/reactivex/Observable;
    ...
    invoke-direct {v0, p0}, LTd0$d;-><init>(LTd0;)V

    new-instance v1, LSd0;

    invoke-direct {v1, v0}, LSd0;-><init>(Lkotlin/jvm/functions/Function1;)V
