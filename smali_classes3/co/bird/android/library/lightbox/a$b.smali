...
.field public final c:Lco/bird/android/library/lightbox/a$b;
...
.method public constructor <init>(LlG2;Lco/bird/android/core/mvp/BaseActivity;)V
    ...
    iput-object p0, p0, Lco/bird/android/library/lightbox/a$b;->c:Lco/bird/android/library/lightbox/a$b;

    iput-object p1, p0, Lco/bird/android/library/lightbox/a$b;->a:LlG2;

    iput-object p2, p0, Lco/bird/android/library/lightbox/a$b;->b:Lco/bird/android/core/mvp/BaseActivity;

    invoke-virtual {p0, p1, p2}, Lco/bird/android/library/lightbox/a$b;->b(LlG2;Lco/bird/android/core/mvp/BaseActivity;)V

    return-void
.end method

.method public synthetic constructor <init>(LlG2;Lco/bird/android/core/mvp/BaseActivity;LwL0;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lco/bird/android/library/lightbox/a$b;-><init>(LlG2;Lco/bird/android/core/mvp/BaseActivity;)V
...
.method public a(Lco/bird/android/library/lightbox/LightboxActivity;)V
    ...
    invoke-virtual {p0, p1}, Lco/bird/android/library/lightbox/a$b;->c(Lco/bird/android/library/lightbox/LightboxActivity;)Lco/bird/android/library/lightbox/LightboxActivity;
...
.method public final b(LlG2;Lco/bird/android/core/mvp/BaseActivity;)V
    ...
    iput-object p1, p0, Lco/bird/android/library/lightbox/a$b;->d:LY94;

    invoke-static {p1}, Lco/bird/android/library/lightbox/b;->a(LY94;)Lco/bird/android/library/lightbox/b;
    ...
    iput-object p1, p0, Lco/bird/android/library/lightbox/a$b;->e:LY94;

    return-void
.end method

.method public final c(Lco/bird/android/library/lightbox/LightboxActivity;)Lco/bird/android/library/lightbox/LightboxActivity;
    .locals 1

    iget-object v0, p0, Lco/bird/android/library/lightbox/a$b;->a:LlG2;
    ...
    invoke-virtual {p0}, Lco/bird/android/library/lightbox/a$b;->d()LSq2;

    move-result-object v0

    invoke-static {p1, v0}, LOq2;->b(Lco/bird/android/library/lightbox/LightboxActivity;LQq2;)V

    return-object p1
.end method

.method public final d()LSq2;
    .locals 4

    new-instance v0, LSq2;

    iget-object v1, p0, Lco/bird/android/library/lightbox/a$b;->e:LY94;
    ...
    invoke-virtual {p0}, Lco/bird/android/library/lightbox/a$b;->e()LUq2;

    move-result-object v2

    iget-object v3, p0, Lco/bird/android/library/lightbox/a$b;->a:LlG2;
    ...
    invoke-direct {v0, v1, v2, v3}, LSq2;-><init>(Lcom/uber/autodispose/ScopeProvider;LTq2;Le13;)V

    return-object v0
.end method

.method public final e()LUq2;
    .locals 2

    new-instance v0, LUq2;

    iget-object v1, p0, Lco/bird/android/library/lightbox/a$b;->b:Lco/bird/android/core/mvp/BaseActivity;

    invoke-direct {v0, v1}, LUq2;-><init>(Lco/bird/android/core/mvp/BaseActivity;)V
