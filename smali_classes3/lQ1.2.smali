...
.method public b(LG6;)Ljava/lang/String;
    ...
    sget v1, LNj4;->item_id_tools_landing_option:I
    ...
    :cond_2
    sget v1, LNj4;->item_id_tools_pending_swap_title:I

    if-ne v0, v1, :cond_3

    const-string v3, "swap_title"

    goto :goto_0

    :cond_3
    sget v1, LNj4;->item_id_tools_pending_swap:I
    ...
    :cond_4
    check-cast v2, Lco/bird/android/model/persistence/BrainSwapRecord;

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Lco/bird/android/model/persistence/BrainSwapRecord;->getBirdId()Ljava/lang/String;
