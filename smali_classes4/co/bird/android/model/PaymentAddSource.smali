...
.field public static final enum PRELOAD_V2_OPTIONS_SCREEN:Lco/bird/android/model/PaymentAddSource;

.field public static final enum PRELOAD_V2_SCREEN:Lco/bird/android/model/PaymentAddSource;
...
.method private static final synthetic $values()[Lco/bird/android/model/PaymentAddSource;
    ...
    sget-object v2, Lco/bird/android/model/PaymentAddSource;->PRELOAD_SCREEN:Lco/bird/android/model/PaymentAddSource;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lco/bird/android/model/PaymentAddSource;->PRELOAD_V2_SCREEN:Lco/bird/android/model/PaymentAddSource;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    sget-object v2, Lco/bird/android/model/PaymentAddSource;->PRELOAD_V2_OPTIONS_SCREEN:Lco/bird/android/model/PaymentAddSource;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    sget-object v2, Lco/bird/android/model/PaymentAddSource;->PAYMENT_SETTINGS_SCREEN:Lco/bird/android/model/PaymentAddSource;

    aput-object v2, v0, v1

    const/4 v1, 0x4

    sget-object v2, Lco/bird/android/model/PaymentAddSource;->RIDE_PASS_PURCHASE:Lco/bird/android/model/PaymentAddSource;

    aput-object v2, v0, v1

    const/4 v1, 0x5

    sget-object v2, Lco/bird/android/model/PaymentAddSource;->QUICK_PAYMENT_SCREEN:Lco/bird/android/model/PaymentAddSource;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, Lco/bird/android/model/PaymentAddSource;->BIRD_PLUS_PURCHASE:Lco/bird/android/model/PaymentAddSource;
...
.method public static constructor <clinit>()V
    ...
    const-string v1, "PRELOAD_V2_SCREEN"

    const/4 v2, 0x1

    invoke-direct {v0, v1, v2}, Lco/bird/android/model/PaymentAddSource;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lco/bird/android/model/PaymentAddSource;->PRELOAD_V2_SCREEN:Lco/bird/android/model/PaymentAddSource;

    new-instance v0, Lco/bird/android/model/PaymentAddSource;

    const-string v1, "PRELOAD_V2_OPTIONS_SCREEN"

    const/4 v2, 0x2

    invoke-direct {v0, v1, v2}, Lco/bird/android/model/PaymentAddSource;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lco/bird/android/model/PaymentAddSource;->PRELOAD_V2_OPTIONS_SCREEN:Lco/bird/android/model/PaymentAddSource;
