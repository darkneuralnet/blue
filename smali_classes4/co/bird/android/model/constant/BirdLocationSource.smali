...
.method private static final synthetic $values()[Lco/bird/android/model/constant/BirdLocationSource;
    ...
    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->GPS_TRACK:Lco/bird/android/model/constant/BirdLocationSource;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->BLE_TRACE:Lco/bird/android/model/constant/BirdLocationSource;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->BEACON_TRACE:Lco/bird/android/model/constant/BirdLocationSource;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->BEAK_TRACE:Lco/bird/android/model/constant/BirdLocationSource;
    ...
    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->USER_SCAN:Lco/bird/android/model/constant/BirdLocationSource;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->PREDICTION:Lco/bird/android/model/constant/BirdLocationSource;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, Lco/bird/android/model/constant/BirdLocationSource;->UNKNOWN:Lco/bird/android/model/constant/BirdLocationSource;
