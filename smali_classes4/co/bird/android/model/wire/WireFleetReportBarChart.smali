...
.method public constructor <init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    iput-object p3, p0, Lco/bird/android/model/wire/WireFleetReportBarChart;->values:Ljava/util/List;

    return-void
.end method

.method public static synthetic copy$default(Lco/bird/android/model/wire/WireFleetReportBarChart;Ljava/util/List;Ljava/util/List;Ljava/util/List;ILjava/lang/Object;)Lco/bird/android/model/wire/WireFleetReportBarChart;
    .locals 0
    ...
    iget-object p3, p0, Lco/bird/android/model/wire/WireFleetReportBarChart;->values:Ljava/util/List;

    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Lco/bird/android/model/wire/WireFleetReportBarChart;->copy(Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lco/bird/android/model/wire/WireFleetReportBarChart;
...
.method public final component3()Ljava/util/List;
    ...
    iget-object v0, p0, Lco/bird/android/model/wire/WireFleetReportBarChart;->values:Ljava/util/List;

    return-object v0
.end method

.method public final copy(Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lco/bird/android/model/wire/WireFleetReportBarChart;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p3}, Lco/bird/android/model/wire/WireFleetReportBarChart;-><init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lco/bird/android/model/wire/WireFleetReportBarChart;->lines:Ljava/util/List;
    ...
    :cond_3
    iget-object v1, p0, Lco/bird/android/model/wire/WireFleetReportBarChart;->values:Ljava/util/List;

    iget-object p1, p1, Lco/bird/android/model/wire/WireFleetReportBarChart;->values:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lco/bird/android/model/wire/WireFleetReportBarChart;->values:Ljava/util/List;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "WireFleetReportBarChart(yAxis="
