...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->enableBirdPay:Z

    iget-boolean v2, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->showBirdPayOnMap:Z

    iget-boolean v3, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->enablePaymentPassthrough:Z

    iget-boolean v4, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->enableTapToPay:Z

    iget-object v5, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->nearbyQueryRadius:Ljava/lang/Double;

    iget-object v6, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->bannerHelpArticleId:Ljava/lang/String;

    iget-object v7, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->autopayRequiredForOvercharge:Ljava/lang/Boolean;

    iget-object v8, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->nearbyQueryUsesMapCenter:Ljava/lang/Boolean;

    iget-boolean v9, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->showMerchantInfoOnPinTap:Z

    iget-boolean v10, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->enableTipping:Z

    iget-object v11, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->merchantPinSize:Ljava/lang/Double;

    iget-object v12, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->tutorialConfig:Lco/bird/android/model/wire/configs/BirdPayTutorialConfig;

    iget-object v13, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->bannerProminenceThreshold:Ljava/lang/Double;

    iget-object v14, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->antifraudReceiptColor:Ljava/lang/Integer;

    iget-object v15, v0, Lco/bird/android/model/wire/configs/BirdPayConfig;->detailsScreenHeader:Ljava/lang/String;
    ...
    const-string v15, "BirdPayConfig(enableBirdPay="
