...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lco/bird/api/response/PropertyReport;->birdId:Ljava/lang/String;

    iget-object v3, p0, Lco/bird/api/response/PropertyReport;->cannotAccessReportId:Ljava/lang/String;

    iget-object v4, p0, Lco/bird/api/response/PropertyReport;->roleId:Ljava/lang/String;

    iget-object v5, p0, Lco/bird/api/response/PropertyReport;->location:Lco/bird/android/model/wire/WireLocation;

    iget-object v6, p0, Lco/bird/api/response/PropertyReport;->status:Lco/bird/android/model/PropertyReportStatus;

    iget-object v7, p0, Lco/bird/api/response/PropertyReport;->createdAt:Lorg/joda/time/DateTime;

    iget-object v8, p0, Lco/bird/api/response/PropertyReport;->updatedAt:Lorg/joda/time/DateTime;

    iget-object v9, p0, Lco/bird/api/response/PropertyReport;->resolvedAt:Lorg/joda/time/DateTime;

    iget-object v10, p0, Lco/bird/api/response/PropertyReport;->action:Lco/bird/android/model/PropertyReportAction;

    iget-object v11, p0, Lco/bird/api/response/PropertyReport;->nextStep:Lco/bird/android/model/PropertyReportNextStep;

    iget-object v12, p0, Lco/bird/api/response/PropertyReport;->notes:Ljava/lang/String;

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "PropertyReport(id="
