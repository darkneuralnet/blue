...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, v0, Lco/bird/api/response/WireBirdPlusDisplay;->heroImage:Lco/bird/android/model/wire/WireLegacyAsset;

    iget-object v2, v0, Lco/bird/api/response/WireBirdPlusDisplay;->heroAnimation:Lco/bird/android/model/wire/WireLegacyAsset;

    iget-object v3, v0, Lco/bird/api/response/WireBirdPlusDisplay;->heroPillLabel:Ljava/lang/String;

    iget-object v4, v0, Lco/bird/api/response/WireBirdPlusDisplay;->heroMessage:Ljava/lang/String;

    iget-object v5, v0, Lco/bird/api/response/WireBirdPlusDisplay;->bannerIcon:Lco/bird/android/model/wire/WireLegacyAsset;

    iget-object v6, v0, Lco/bird/api/response/WireBirdPlusDisplay;->bannerTitle:Ljava/lang/String;

    iget-object v7, v0, Lco/bird/api/response/WireBirdPlusDisplay;->bannerMessage:Ljava/lang/String;

    iget-object v8, v0, Lco/bird/api/response/WireBirdPlusDisplay;->planPreviewTitle:Ljava/lang/String;

    iget-object v9, v0, Lco/bird/api/response/WireBirdPlusDisplay;->planPreviewMessage:Ljava/lang/String;

    iget-object v10, v0, Lco/bird/api/response/WireBirdPlusDisplay;->planName:Ljava/lang/String;

    iget-object v11, v0, Lco/bird/api/response/WireBirdPlusDisplay;->purchasedHeroTopImage:Lco/bird/android/model/wire/WireLegacyAsset;

    iget-object v12, v0, Lco/bird/api/response/WireBirdPlusDisplay;->purchasedMessage:Ljava/lang/String;

    iget-object v13, v0, Lco/bird/api/response/WireBirdPlusDisplay;->purchasedHeroBottomImage:Lco/bird/android/model/wire/WireLegacyAsset;

    iget-object v14, v0, Lco/bird/api/response/WireBirdPlusDisplay;->purchasedHeroAnimation:Lco/bird/android/model/wire/WireLegacyAsset;

    iget-object v15, v0, Lco/bird/api/response/WireBirdPlusDisplay;->purchasedHeroTopColor:Ljava/lang/Integer;

    move-object/from16 v16, v15

    iget-object v15, v0, Lco/bird/api/response/WireBirdPlusDisplay;->purchasedHeroBottomColor:Ljava/lang/Integer;
    ...
    const-string v15, "WireBirdPlusDisplay(heroImage="
