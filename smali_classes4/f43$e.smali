...
.method public constructor <init>(Lf43;LEb5;)V
    ...
    iput-object p1, p0, Lf43$e;->d:Lf43;
...
.method public e()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR IGNORE `nest_markers` SET `id` = ?,`location` = ?,`capacity` = ?,`state` = ?,`icon` = ?,`secondary_icon` = ?,`secondary_icon_color` = ?,`secondary_icon_background_color` = ?,`prominence` = ?,`updated_at` = ?,`available_space_details` = ? WHERE `id` = ?"
...
.method public bridge synthetic i(LqV5;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lf43$e;->m(LqV5;Lco/bird/android/model/persistence/NestMarker;)V
...
.method public m(LqV5;Lco/bird/android/model/persistence/NestMarker;)V
    ...
    :cond_2
    iget-object v0, p0, Lf43$e;->d:Lf43;
    ...
    invoke-static {v0}, Ld43;->b(Ljava/util/List;)Ljava/lang/String;
