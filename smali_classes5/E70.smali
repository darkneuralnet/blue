...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LE70;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static b(Ljava/io/InputStream;)Ljava/nio/ByteBuffer;
    ...
    sget-object v2, LE70;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    sget-object p0, LE70;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-static {p0}, LE70;->d(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
...
.method public static c(Ljava/nio/ByteBuffer;)LE70$b;
    .locals 3
    ...
    invoke-direct {v0, v1, v2, p0}, LE70$b;-><init>([BII)V
...
.method public static e(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {p0}, LE70;->c(Ljava/nio/ByteBuffer;)LE70$b;

    move-result-object v0

    if-eqz v0, :cond_0

    iget v1, v0, LE70$b;->a:I

    if-nez v1, :cond_0

    iget v1, v0, LE70$b;->b:I

    iget-object v0, v0, LE70$b;->c:[B
...
.method public static g(Ljava/nio/ByteBuffer;)Ljava/io/InputStream;
    ...
    invoke-direct {v0, p0}, LE70$a;-><init>(Ljava/nio/ByteBuffer;)V
