...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, LFC7;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_0

    invoke-static {}, LFC7;->b()Ljava/lang/ClassLoader;

    move-result-object v1

    sput-object v1, LFC7;->a:Ljava/lang/ClassLoader;
...
.method public static declared-synchronized b()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, LFC7;->b:Ljava/lang/Thread;

    const/4 v2, 0x0

    if-nez v1, :cond_1

    invoke-static {}, LFC7;->c()Ljava/lang/Thread;

    move-result-object v1

    sput-object v1, LFC7;->b:Ljava/lang/Thread;
    ...
    :try_start_2
    sget-object v3, LFC7;->b:Ljava/lang/Thread;
...
.method public static declared-synchronized c()Ljava/lang/Thread;
    ...
    invoke-direct {v1, v8, v4}, LYe7;-><init>(Ljava/lang/ThreadGroup;Ljava/lang/String;)V
    :try_end_3
