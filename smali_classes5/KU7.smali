...
# direct methods
.method public static a(LXa8;)LxT7;
    .locals 8
    ...
    invoke-virtual {p0}, LXa8;->n()Z

    move-result v2

    const/4 v3, 0x1

    invoke-virtual {p0, v3}, LXa8;->l(Z)V

    :try_start_0
    invoke-static {p0}, Lb08;->a(LXa8;)LxT7;
    ...
    invoke-virtual {p0, v2}, LXa8;->l(Z)V
...
.method public static b(Ljava/lang/String;)LxT7;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/gms/internal/mlkit_vision_object_detection_bundled/zzcq;
    ...
    invoke-direct {p0, v0}, LXa8;-><init>(Ljava/io/Reader;)V

    invoke-static {p0}, LKU7;->a(LXa8;)LxT7;

    move-result-object v0

    instance-of v1, v0, LVT7;
