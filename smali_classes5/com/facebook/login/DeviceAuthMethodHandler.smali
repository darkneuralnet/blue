...
.method public o(Lcom/facebook/login/LoginClient$Request;)I
    ...
    invoke-virtual {p0, p1}, Lcom/facebook/login/DeviceAuthMethodHandler;->u(Lcom/facebook/login/LoginClient$Request;)V
...
.method public p()Lcom/facebook/login/DeviceAuthDialog;
    .locals 1
...
.method public t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;LI1;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v11}, Lcom/facebook/AccessToken;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;LI1;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V

    iget-object v1, v0, Lcom/facebook/login/LoginMethodHandler;->c:Lcom/facebook/login/LoginClient;

    invoke-virtual {v1}, Lcom/facebook/login/LoginClient;->r()Lcom/facebook/login/LoginClient$Request;
    ...
    invoke-virtual {v2, v1}, Lcom/facebook/login/LoginClient;->h(Lcom/facebook/login/LoginClient$Result;)V
...
.method public final u(Lcom/facebook/login/LoginClient$Request;)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/facebook/login/DeviceAuthMethodHandler;->p()Lcom/facebook/login/DeviceAuthDialog;
    ...
    invoke-virtual {v1, p1}, Lcom/facebook/login/DeviceAuthDialog;->Aa(Lcom/facebook/login/LoginClient$Request;)V
