...
.method public constructor <init>(Ljr2;)V
    ...
    iput-object p1, p0, Ljr2$b;->c:Ljr2;
    ...
    iput-object p1, p0, Ljr2$b;->a:Landroid/graphics/Path;

    return-void
.end method

.method public synthetic constructor <init>(Ljr2;Ljr2$a;)V
    .locals 0

    invoke-direct {p0, p1}, Ljr2$b;-><init>(Ljr2;)V
...
# virtual methods
.method public a(LMO1;ZZ)V
    .locals 9

    invoke-interface {p1}, LMO1;->x()I

    move-result v0

    invoke-interface {p1}, LMO1;->w0()F

    move-result v1

    invoke-interface {p1}, LMO1;->R()F
    ...
    iget-object v6, p0, Ljr2$b;->b:[Landroid/graphics/Bitmap;

    aput-object v4, v6, v3

    iget-object v4, p0, Ljr2$b;->c:Ljr2;

    iget-object v4, v4, LRS0;->c:Landroid/graphics/Paint;

    invoke-interface {p1, v3}, LMO1;->O(I)I
    ...
    iget-object v4, p0, Ljr2$b;->a:Landroid/graphics/Path;
    ...
    iget-object v6, p0, Ljr2$b;->c:Ljr2;

    iget-object v6, v6, LRS0;->c:Landroid/graphics/Paint;
    ...
    iget-object v4, v4, Ljr2;->j:Landroid/graphics/Paint;
...
.method public b(I)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Ljr2$b;->b:[Landroid/graphics/Bitmap;
...
.method public c(LMO1;)Z
    ...
    iput-object p1, p0, Ljr2$b;->b:[Landroid/graphics/Bitmap;
