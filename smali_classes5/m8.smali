...
.method public constructor <init>(Landroid/content/Context;JZZ)V
    ...
    iput-object p5, p0, Lm8;->d:Ljava/lang/Object;
    ...
    :cond_0
    iput-object p1, p0, Lm8;->f:Landroid/content/Context;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lm8;->c:Z

    iput-wide p2, p0, Lm8;->g:J

    return-void
.end method

.method public static a(Landroid/content/Context;)Lm8$a;
    .locals 9
    .annotation build Lcom/google/android/gms/common/annotation/KeepForSdk;
    .end annotation
    ...
    invoke-direct/range {v0 .. v5}, Lm8;-><init>(Landroid/content/Context;JZZ)V
    ...
    invoke-virtual {v8, p0}, Lm8;->d(Z)V

    const/4 p0, -0x1

    invoke-virtual {v8, p0}, Lm8;->f(I)Lm8$a;
    ...
    invoke-virtual/range {v0 .. v7}, Lm8;->e(Lm8$a;ZFJLjava/lang/String;Ljava/lang/Throwable;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v8}, Lm8;->c()V
...
.method public final c()V
    ...
    :try_start_0
    iget-object v0, p0, Lm8;->f:Landroid/content/Context;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lm8;->a:Lcom/google/android/gms/common/BlockingServiceConnection;
    :try_end_0
    ...
    iget-object v1, p0, Lm8;->f:Landroid/content/Context;

    iget-object v2, p0, Lm8;->a:Lcom/google/android/gms/common/BlockingServiceConnection;
    ...
    iput-boolean v0, p0, Lm8;->c:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lm8;->b:LSe8;

    iput-object v0, p0, Lm8;->a:Lcom/google/android/gms/common/BlockingServiceConnection;
...
.method public final d(Z)V
    ...
    :try_start_4
    iput-object v1, p0, Lm8;->a:Lcom/google/android/gms/common/BlockingServiceConnection;
    :try_end_4
    ...
    invoke-static {v0}, LL68;->c5(Landroid/os/IBinder;)LSe8;
    ...
    iput-boolean v4, p0, Lm8;->c:Z

    if-eqz p1, :cond_3

    invoke-virtual {p0}, Lm8;->g()V
...
.method public final e(Lm8$a;ZFJLjava/lang/String;Ljava/lang/Throwable;)Z
    .locals 2
    .annotation build Lcom/google/android/gms/common/util/VisibleForTesting;
    .end annotation
    ...
    invoke-direct {p1, p0, p2}, Lvf7;-><init>(Lm8;Ljava/util/Map;)V
...
.method public final f(I)Lm8$a;
    ...
    :try_start_0
    iget-boolean p1, p0, Lm8;->c:Z

    if-nez p1, :cond_2

    iget-object p1, p0, Lm8;->d:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v0, p0, Lm8;->e:LQC7;

    if-eqz v0, :cond_1

    iget-boolean v0, v0, LQC7;->e:Z
    ...
    :try_start_2
    invoke-virtual {p0, p1}, Lm8;->d(Z)V
    :try_end_2
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lm8;->a:Lcom/google/android/gms/common/BlockingServiceConnection;

    invoke-static {p1}, Lcom/google/android/gms/common/internal/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Lm8;->b:LSe8;
    ...
    iget-object v0, p0, Lm8;->b:LSe8;

    invoke-interface {v0}, LSe8;->zzc()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lm8;->b:LSe8;

    const/4 v2, 0x1

    invoke-interface {v1, v2}, LSe8;->H(Z)Z

    move-result v1

    invoke-direct {p1, v0, v1}, Lm8$a;-><init>(Ljava/lang/String;Z)V
    :try_end_6
...
.method public final g()V
    ...
    :try_start_0
    iget-object v1, p0, Lm8;->e:LQC7;

    if-eqz v1, :cond_0

    iget-object v1, v1, LQC7;->d:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-direct {v3, p0, v1, v2}, LQC7;-><init>(Lm8;J)V

    iput-object v3, p0, Lm8;->e:LQC7;
