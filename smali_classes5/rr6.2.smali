...
# static fields
.field public static final e:Ljava/lang/String; = "rr6"

.field public static f:Lrr6;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object v0, p0, Lrr6;->b:Ljava/lang/ref/WeakReference;

    const/4 p1, 0x0

    iput-object p1, p0, Lrr6;->d:Ljava/lang/String;
    ...
    iput-object p1, p0, Lrr6;->a:Landroid/os/Handler;

    sput-object p0, Lrr6;->f:Lrr6;

    return-void
.end method

.method public static synthetic a(Lrr6;)Ljava/lang/ref/WeakReference;
    .locals 3
    ...
    :cond_0
    :try_start_0
    iget-object p0, p0, Lrr6;->b:Ljava/lang/ref/WeakReference;
    :try_end_0
...
.method public static synthetic b(Lrr6;)Landroid/os/Handler;
    .locals 3
    ...
    :cond_0
    :try_start_0
    iget-object p0, p0, Lrr6;->a:Landroid/os/Handler;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic c()Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    sget-object v0, Lrr6;->e:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic d(Lrr6;Ljava/lang/String;)V
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, p1}, Lrr6;->l(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic e(Lrr6;)Ljava/util/Timer;
    .locals 3
    ...
    :cond_0
    :try_start_0
    iget-object p0, p0, Lrr6;->c:Ljava/util/Timer;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic f(Lrr6;Ljava/util/Timer;)Ljava/util/Timer;
    .locals 3
    ...
    :cond_0
    :try_start_0
    iput-object p1, p0, Lrr6;->c:Ljava/util/Timer;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic g(Lrr6;)Ljava/lang/String;
    .locals 3
...
.method public static synthetic h(Lrr6;Ljava/lang/String;)Ljava/lang/String;
    .locals 3
...
.method public static i(Ljava/lang/String;Lcom/facebook/AccessToken;Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/GraphRequest;
    ...
    invoke-static {}, LWi;->d()Ljava/lang/String;
    ...
    invoke-static {}, LRl0;->i()Ljava/lang/String;
    ...
    new-instance p0, Lrr6$d;

    invoke-direct {p0}, Lrr6$d;-><init>()V
...
.method public j(Lcom/facebook/GraphRequest;Ljava/lang/String;)V
    ...
    sget-object v2, Lrr6;->e:Ljava/lang/String;

    const-string v3, "Successfully send UI component tree to server"

    invoke-static {p1, v2, v3}, LFx2;->g(LSx2;Ljava/lang/String;Ljava/lang/String;)V

    iput-object p2, p0, Lrr6;->d:Ljava/lang/String;
    ...
    invoke-static {p1}, LRl0;->o(Ljava/lang/Boolean;)V

    goto :goto_0

    :cond_3
    sget-object p2, Lrr6;->e:Ljava/lang/String;
...
.method public k()V
    ...
    invoke-direct {v0, p0}, Lrr6$a;-><init>(Lrr6;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    new-instance v2, Lrr6$b;

    invoke-direct {v2, p0, v0}, Lrr6$b;-><init>(Lrr6;Ljava/util/TimerTask;)V
    ...
    :try_start_2
    sget-object v1, Lrr6;->e:Ljava/lang/String;
...
.method public final l(Ljava/lang/String;)V
    ...
    new-instance v1, Lrr6$c;

    invoke-direct {v1, p0, p1}, Lrr6$c;-><init>(Lrr6;Ljava/lang/String;)V
...
.method public m()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lrr6;->b:Ljava/lang/ref/WeakReference;
    ...
    :cond_1
    iget-object v0, p0, Lrr6;->c:Ljava/util/Timer;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-object v0, p0, Lrr6;->c:Ljava/util/Timer;
    :try_end_1
