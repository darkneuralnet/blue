...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzbc;)V
    ...
    iput-object v0, p0, LBC7;->b:Lcom/google/android/libraries/barhopper/RecognitionOptions;

    iput-object p1, p0, LBC7;->a:Landroid/content/Context;
...
.method public static d5(LY49;Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzap;
    .locals 10
    ...
    invoke-virtual {p0}, LY49;->M()I

    move-result v2

    invoke-virtual {p0}, LY49;->K()I

    move-result v3

    invoke-virtual {p0}, LY49;->H()I

    move-result v4

    invoke-virtual {p0}, LY49;->I()I

    move-result v5

    invoke-virtual {p0}, LY49;->J()I

    move-result v6

    invoke-virtual {p0}, LY49;->L()I

    move-result v7

    invoke-virtual {p0}, LY49;->P()Z
...
# virtual methods
.method public final E4(LWO1;Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzbu;)Ljava/util/List;
    .locals 54
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzbu;->s()I
    ...
    invoke-virtual {v0, v2, v1}, LBC7;->e5(Ljava/nio/ByteBuffer;Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzbu;)LAy;
    ...
    :cond_3
    iget-object v2, v0, LBC7;->c:Lcom/google/android/libraries/barhopper/BarhopperV3;
    ...
    iget-object v6, v0, LBC7;->b:Lcom/google/android/libraries/barhopper/RecognitionOptions;

    invoke-virtual {v2, v5, v6}, Lcom/google/android/libraries/barhopper/BarhopperV3;->d(Landroid/graphics/Bitmap;Lcom/google/android/libraries/barhopper/RecognitionOptions;)LAy;
    ...
    invoke-virtual {v6, v7, v8, v9}, LsY1;->e(III)Landroid/graphics/Matrix;

    move-result-object v6

    invoke-virtual {v2}, LAy;->J()Ljava/util/List;
    ...
    invoke-virtual {v7}, LuQ7;->V()Ljava/util/List;
    ...
    invoke-virtual {v9, v4}, Lzi7;->o(I)Lzi7;
    ...
    invoke-virtual {v9, v4}, Lzi7;->p(I)Lzi7;

    invoke-virtual {v9}, Lk58;->j()LV78;

    move-result-object v4

    check-cast v4, Lrj7;

    invoke-virtual {v7, v14, v4}, LLC7;->o(ILrj7;)LLC7;

    invoke-virtual {v7}, Lk58;->j()LV78;
    ...
    :cond_5
    invoke-virtual {v7}, LuQ7;->a0()Z

    move-result v4

    if-eqz v4, :cond_6

    invoke-virtual {v7}, LuQ7;->O()LDx9;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzat;

    invoke-virtual {v4}, LDx9;->M()I

    move-result v11

    add-int/2addr v11, v3

    invoke-virtual {v4}, LDx9;->J()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v4}, LDx9;->L()Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v4}, LDx9;->K()Ljava/lang/String;
    ...
    :goto_5
    invoke-virtual {v7}, LuQ7;->c0()Z

    move-result v4

    if-eqz v4, :cond_7

    invoke-virtual {v7}, LuQ7;->J()LdT7;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzaw;

    invoke-virtual {v4}, LdT7;->K()I

    move-result v11

    add-int/2addr v11, v3

    invoke-virtual {v4}, LdT7;->J()Ljava/lang/String;
    ...
    :goto_6
    invoke-virtual {v7}, LuQ7;->d0()Z

    move-result v4

    if-eqz v4, :cond_8

    invoke-virtual {v7}, LuQ7;->Q()Lkl7;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzax;

    invoke-virtual {v4}, Lkl7;->J()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v4}, Lkl7;->K()Ljava/lang/String;
    ...
    :goto_7
    invoke-virtual {v7}, LuQ7;->f0()Z

    move-result v4

    if-eqz v4, :cond_9

    invoke-virtual {v7}, LuQ7;->S()Les7;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzaz;

    invoke-virtual {v4}, Les7;->K()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v4}, Les7;->J()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v4}, Les7;->L()I
    ...
    :goto_8
    invoke-virtual {v7}, LuQ7;->e0()Z

    move-result v4

    if-eqz v4, :cond_a

    invoke-virtual {v7}, LuQ7;->R()LRn7;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzay;

    invoke-virtual {v4}, LRn7;->J()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v4}, LRn7;->K()Ljava/lang/String;
    ...
    :goto_9
    invoke-virtual {v7}, LuQ7;->b0()Z

    move-result v4

    if-eqz v4, :cond_b

    invoke-virtual {v7}, LuQ7;->P()LEh7;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzau;

    invoke-virtual {v4}, LEh7;->H()D

    move-result-wide v11

    invoke-virtual {v4}, LEh7;->I()D
    ...
    :goto_a
    invoke-virtual {v7}, LuQ7;->X()Z

    move-result v4

    if-eqz v4, :cond_e

    invoke-virtual {v7}, LuQ7;->L()Lwd9;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzaq;

    invoke-virtual {v4}, Lwd9;->P()Ljava/lang/String;

    move-result-object v31

    invoke-virtual {v4}, Lwd9;->L()Ljava/lang/String;

    move-result-object v32

    invoke-virtual {v4}, Lwd9;->M()Ljava/lang/String;

    move-result-object v33

    invoke-virtual {v4}, Lwd9;->N()Ljava/lang/String;

    move-result-object v34

    invoke-virtual {v4}, Lwd9;->O()Ljava/lang/String;

    move-result-object v35

    invoke-virtual {v4}, Lwd9;->I()LY49;

    move-result-object v11

    invoke-virtual {v7}, LuQ7;->T()LgZ7;

    move-result-object v12

    invoke-virtual {v12}, LgZ7;->x()Z
    ...
    invoke-virtual {v12}, LgZ7;->F()Ljava/lang/String;
    ...
    invoke-static {v11, v12, v13}, LBC7;->d5(LY49;Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzap;

    move-result-object v36

    invoke-virtual {v4}, Lwd9;->H()LY49;
    ...
    invoke-virtual {v11}, LgZ7;->F()Ljava/lang/String;
    ...
    invoke-static {v4, v11, v12}, LBC7;->d5(LY49;Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzap;
    ...
    :goto_d
    invoke-virtual {v7}, LuQ7;->Y()Z

    move-result v4

    if-eqz v4, :cond_16

    invoke-virtual {v7}, LuQ7;->M()LHl9;

    move-result-object v4

    new-instance v9, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzar;

    invoke-virtual {v4}, LHl9;->H()LER7;
    ...
    invoke-virtual {v11}, LER7;->K()Ljava/lang/String;

    move-result-object v32

    invoke-virtual {v11}, LER7;->O()Ljava/lang/String;

    move-result-object v33

    invoke-virtual {v11}, LER7;->N()Ljava/lang/String;

    move-result-object v34

    invoke-virtual {v11}, LER7;->J()Ljava/lang/String;

    move-result-object v35

    invoke-virtual {v11}, LER7;->M()Ljava/lang/String;

    move-result-object v36

    invoke-virtual {v11}, LER7;->L()Ljava/lang/String;

    move-result-object v37

    invoke-virtual {v11}, LER7;->P()Ljava/lang/String;
    ...
    :goto_e
    invoke-virtual {v4}, LHl9;->K()Ljava/lang/String;

    move-result-object v33

    invoke-virtual {v4}, LHl9;->L()Ljava/lang/String;

    move-result-object v34

    invoke-virtual {v4}, LHl9;->O()Ljava/util/List;
    ...
    invoke-virtual/range {v17 .. v17}, LdT7;->J()Ljava/lang/String;
    ...
    :goto_10
    invoke-virtual {v4}, LHl9;->N()Ljava/util/List;
    ...
    invoke-virtual {v15}, LDx9;->J()Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v17}, LDx9;->L()Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v17}, LDx9;->K()Ljava/lang/String;
    ...
    :goto_12
    invoke-virtual {v4}, LHl9;->P()Ljava/util/List;
    ...
    invoke-virtual {v4}, LHl9;->M()Ljava/util/List;
    ...
    invoke-virtual {v12}, LaR7;->I()Ljava/util/List;
    ...
    :goto_15
    invoke-virtual {v7}, LuQ7;->Z()Z

    move-result v3

    if-eqz v3, :cond_17

    invoke-virtual {v7}, LuQ7;->N()LQq9;

    move-result-object v3

    new-instance v4, Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzas;

    invoke-virtual {v3}, LQq9;->O()Ljava/lang/String;

    move-result-object v40

    invoke-virtual {v3}, LQq9;->Q()Ljava/lang/String;

    move-result-object v41

    invoke-virtual {v3}, LQq9;->W()Ljava/lang/String;

    move-result-object v42

    invoke-virtual {v3}, LQq9;->U()Ljava/lang/String;

    move-result-object v43

    invoke-virtual {v3}, LQq9;->R()Ljava/lang/String;

    move-result-object v44

    invoke-virtual {v3}, LQq9;->L()Ljava/lang/String;

    move-result-object v45

    invoke-virtual {v3}, LQq9;->J()Ljava/lang/String;

    move-result-object v46

    invoke-virtual {v3}, LQq9;->K()Ljava/lang/String;

    move-result-object v47

    invoke-virtual {v3}, LQq9;->M()Ljava/lang/String;

    move-result-object v48

    invoke-virtual {v3}, LQq9;->V()Ljava/lang/String;

    move-result-object v49

    invoke-virtual {v3}, LQq9;->S()Ljava/lang/String;

    move-result-object v50

    invoke-virtual {v3}, LQq9;->P()Ljava/lang/String;

    move-result-object v51

    invoke-virtual {v3}, LQq9;->N()Ljava/lang/String;

    move-result-object v52

    invoke-virtual {v3}, LQq9;->T()Ljava/lang/String;
    ...
    :goto_17
    invoke-virtual {v7}, LuQ7;->U()Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lrj7;->H()I
    ...
    invoke-virtual/range {v16 .. v16}, Lrj7;->I()I
...
.method public final e5(Ljava/nio/ByteBuffer;Lcom/google/android/gms/internal/mlkit_vision_barcode_bundled/zzbu;)LAy;
    .locals 3

    iget-object v0, p0, LBC7;->c:Lcom/google/android/libraries/barhopper/BarhopperV3;
    ...
    iget-object v2, p0, LBC7;->b:Lcom/google/android/libraries/barhopper/RecognitionOptions;

    invoke-virtual {v0, v1, p2, p1, v2}, Lcom/google/android/libraries/barhopper/BarhopperV3;->b(IILjava/nio/ByteBuffer;Lcom/google/android/libraries/barhopper/RecognitionOptions;)LAy;
    ...
    invoke-virtual {v0, v1, p2, p1, v2}, Lcom/google/android/libraries/barhopper/BarhopperV3;->c(II[BLcom/google/android/libraries/barhopper/RecognitionOptions;)LAy;
    ...
    invoke-virtual {v0, p1, p2, v1, v2}, Lcom/google/android/libraries/barhopper/BarhopperV3;->c(II[BLcom/google/android/libraries/barhopper/RecognitionOptions;)LAy;
...
.method public final zzc()V
    ...
    iput-object v0, p0, LBC7;->c:Lcom/google/android/libraries/barhopper/BarhopperV3;

    invoke-static {}, LyA8;->H()Lvt8;

    move-result-object v0

    invoke-static {}, LHe8;->H()LB68;
    ...
    invoke-static {}, LiQ7;->H()LwC7;

    move-result-object v6

    invoke-virtual {v6, v3}, LwC7;->r(I)LwC7;

    invoke-virtual {v6, v3}, LwC7;->t(I)LwC7;

    move v7, v2

    :goto_1
    sget-object v8, LBC7;->d:[I

    aget v8, v8, v4

    if-ge v7, v8, :cond_1

    sget-object v8, LBC7;->e:[[D
    ...
    invoke-virtual {v6, v10}, LwC7;->o(F)LwC7;

    mul-float/2addr v9, v8

    invoke-virtual {v6, v9}, LwC7;->p(F)LwC7;
    ...
    invoke-virtual {v1, v6}, LB68;->o(LwC7;)LB68;
    ...
    :cond_2
    invoke-virtual {v0, v1}, Lvt8;->o(LB68;)Lvt8;

    :try_start_0
    iget-object v1, p0, LBC7;->a:Landroid/content/Context;
    ...
    :try_start_1
    iget-object v2, p0, LBC7;->a:Landroid/content/Context;
    ...
    :try_start_2
    iget-object v3, p0, LBC7;->a:Landroid/content/Context;
    ...
    :try_start_3
    iget-object v4, p0, LBC7;->c:Lcom/google/android/libraries/barhopper/BarhopperV3;
    ...
    invoke-static {}, LBy;->H()LFN8;

    move-result-object v5

    invoke-static {v1}, LgZ7;->D(Ljava/io/InputStream;)LgZ7;

    move-result-object v6

    invoke-virtual {v0, v6}, Lvt8;->p(LgZ7;)Lvt8;

    invoke-virtual {v5, v0}, LFN8;->o(Lvt8;)LFN8;

    invoke-static {}, LU49;->H()LvZ8;

    move-result-object v0

    invoke-static {v2}, LgZ7;->D(Ljava/io/InputStream;)LgZ7;

    move-result-object v6

    invoke-virtual {v0, v6}, LvZ8;->o(LgZ7;)LvZ8;

    invoke-static {v3}, LgZ7;->D(Ljava/io/InputStream;)LgZ7;

    move-result-object v6

    invoke-virtual {v0, v6}, LvZ8;->p(LgZ7;)LvZ8;

    invoke-virtual {v5, v0}, LFN8;->p(LvZ8;)LFN8;

    invoke-virtual {v5}, Lk58;->j()LV78;

    move-result-object v0

    check-cast v0, LBy;

    invoke-virtual {v4, v0}, Lcom/google/android/libraries/barhopper/BarhopperV3;->a(LBy;)V
    :try_end_3
    ...
    :try_start_8
    invoke-static {v0, v3}, Lef7;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :try_start_a
    invoke-static {v0, v2}, Lef7;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :try_start_c
    invoke-static {v0, v1}, Lef7;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
