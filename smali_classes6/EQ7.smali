...
# static fields
.field public static final a:Ljava/lang/String; = "EQ7"
...
.method public static a(Landroid/content/Context;LbM2$a;)Lue8;
    .locals 3
    ...
    sget-object v0, LEQ7;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p1}, LEQ7;->c(Landroid/content/Context;LbM2$a;)Landroid/content/Context;
    ...
    invoke-static {v0}, LEQ7;->d(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lo68;-><init>(Landroid/os/IBinder;)V

    move-object v0, v1

    :goto_0
    sput-object v0, LEQ7;->c:Lue8;
    ...
    invoke-interface {v0, p0, p1}, Lue8;->O0(LWO1;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0

    sget-object p0, LEQ7;->c:Lue8;
...
.method public static c(Landroid/content/Context;LbM2$a;)Landroid/content/Context;
    .locals 2

    sget-object v0, LEQ7;->b:Landroid/content/Context;
    ...
    :try_start_1
    sget-object p1, LEQ7;->a:Ljava/lang/String;
    ...
    invoke-static {p1, p0}, LEQ7;->b(Ljava/lang/Exception;Landroid/content/Context;)Landroid/content/Context;
    ...
    :cond_3
    invoke-static {v1, p0}, LEQ7;->b(Ljava/lang/Exception;Landroid/content/Context;)Landroid/content/Context;

    move-result-object p0

    :goto_2
    sput-object p0, LEQ7;->b:Landroid/content/Context;
