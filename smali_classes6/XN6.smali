...
.method public static a(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    ...
    invoke-static {p0, v0}, LXN6;->h(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
...
.method public static b(Ljava/nio/ByteBuffer;)J
    ...
    invoke-static {p0}, LXN6;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v0}, LXN6;->j(Ljava/nio/ByteBuffer;I)J
...
.method public static g(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    :try_start_0
    invoke-static {v1}, LXN6;->a(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    ...
    :goto_0
    invoke-static {v11}, LXN6;->b(Ljava/nio/ByteBuffer;)J
    ...
    invoke-static {v11}, LXN6;->d(Ljava/nio/ByteBuffer;)J
    ...
    invoke-static {v0, v2}, LXN6;->r(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct/range {v3 .. v11}, LfN6;-><init>(Ljava/nio/ByteBuffer;JJJLjava/nio/ByteBuffer;)V

    invoke-virtual {v1}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object v2

    invoke-static {v2, v0}, LXN6;->k(Ljava/nio/channels/FileChannel;LfN6;)[[Ljava/security/cert/X509Certificate;
...
.method public static h(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    invoke-static {p1}, LXN6;->i(Ljava/nio/ByteBuffer;)V
...
.method public static k(Ljava/nio/channels/FileChannel;LfN6;)[[Ljava/security/cert/X509Certificate;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
    ...
    :try_start_1
    invoke-static {p1}, LfN6;->a(LfN6;)Ljava/nio/ByteBuffer;

    move-result-object v2

    invoke-static {v2}, LXN6;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v4, v0, v1}, LXN6;->l(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {p1}, LfN6;->b(LfN6;)J

    move-result-wide v2

    invoke-static {p1}, LfN6;->c(LfN6;)J

    move-result-wide v4

    invoke-static {p1}, LfN6;->d(LfN6;)J

    move-result-wide v6

    invoke-static {p1}, LfN6;->e(LfN6;)Ljava/nio/ByteBuffer;

    move-result-object v8

    move-object v1, p0

    invoke-static/range {v0 .. v8}, LXN6;->m(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
...
.method public static l(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static/range {p0 .. p0}, LXN6;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {p0 .. p0}, LXN6;->t(Ljava/nio/ByteBuffer;)[B
    ...
    :try_start_0
    invoke-static {v1}, LXN6;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v4}, LXN6;->o(I)I

    move-result v11

    invoke-static {v7}, LXN6;->o(I)I
    ...
    :cond_2
    invoke-static {v10}, LXN6;->t(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {v0}, LXN6;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v8}, LXN6;->t(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {v1}, LXN6;->p(I)Ljava/lang/String;
    ...
    invoke-static {v0}, LXN6;->t(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-direct {v7, v5, v4}, LDN6;-><init>(Ljava/security/cert/X509Certificate;[B)V
...
.method public static m(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    ...
    invoke-direct/range {v1 .. v6}, LRM6;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    invoke-direct/range {v5 .. v10}, LRM6;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    invoke-static {v2, p2, p3}, LXN6;->c(Ljava/nio/ByteBuffer;J)V

    new-instance v3, LUK6;

    invoke-direct {v3, v2}, LUK6;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v5}, LXN6;->n([I[LhM6;)[[B
...
.method public static n([I[LhM6;)[[B
    .locals 26
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v4, v10}, LXN6;->u(I[B)V
    ...
    invoke-static {v13}, LXN6;->p(I)Ljava/lang/String;
    ...
    invoke-static {v1, v4}, LXN6;->u(I[B)V
    ...
    :try_start_1
    invoke-interface {v3, v6, v7, v8, v1}, LhM6;->a([Ljava/security/MessageDigest;JI)V
    :try_end_1
    ...
    invoke-static {v2}, LXN6;->p(I)Ljava/lang/String;
...
.method public static s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v0}, LXN6;->r(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
