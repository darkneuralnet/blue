...
.method public static synthetic a(LYU5;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/common/util/concurrent/Callables;->lambda$threadRenaming$2(LYU5;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
...
.method public static asAsyncCallable(Ljava/util/concurrent/Callable;Lcom/google/common/util/concurrent/ListeningExecutorService;)Lcom/google/common/util/concurrent/AsyncCallable;
    ...
    invoke-direct {v0, p1, p0}, LF80;-><init>(Lcom/google/common/util/concurrent/ListeningExecutorService;Ljava/util/concurrent/Callable;)V

    return-object v0
.end method

.method public static synthetic b(LYU5;Ljava/lang/Runnable;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/google/common/util/concurrent/Callables;->lambda$threadRenaming$3(LYU5;Ljava/lang/Runnable;)V
...
.method private static synthetic lambda$threadRenaming$2(LYU5;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-interface {p0}, LYU5;->get()Ljava/lang/Object;
...
.method private static synthetic lambda$threadRenaming$3(LYU5;Ljava/lang/Runnable;)V
    .locals 2
...
.method public static returning(Ljava/lang/Object;)Ljava/util/concurrent/Callable;
    ...
    invoke-direct {v0, p0}, LC80;-><init>(Ljava/lang/Object;)V

    return-object v0
.end method

.method public static threadRenaming(Ljava/lang/Runnable;LYU5;)Ljava/lang/Runnable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0}, LD80;-><init>(LYU5;Ljava/lang/Runnable;)V

    return-object v0
.end method

.method public static threadRenaming(Ljava/util/concurrent/Callable;LYU5;)Ljava/util/concurrent/Callable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p1, p0}, LE80;-><init>(LYU5;Ljava/util/concurrent/Callable;)V
