...
# static fields
.field private static final INNER_FUTURE:LwA1;
...
.field protected final inputs:LVY1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LVY1<",
            "Lcom/google/common/util/concurrent/ClosingFuture<",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/common/util/concurrent/ClosingFuture$Combiner;->INNER_FUTURE:LwA1;
...
.method private constructor <init>(ZLjava/lang/Iterable;)V
    ...
    invoke-static {p2}, LVY1;->x(Ljava/lang/Iterable;)LVY1;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/util/concurrent/ClosingFuture$Combiner;->inputs:LVY1;
...
.method private futureCombiner()Lcom/google/common/util/concurrent/Futures$FutureCombiner;
    ...
    invoke-direct {p0}, Lcom/google/common/util/concurrent/ClosingFuture$Combiner;->inputFutures()LVY1;
...
.method private inputFutures()LVY1;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/common/util/concurrent/ClosingFuture$Combiner;->inputs:LVY1;

    invoke-static {v0}, Lnv1;->e(Ljava/lang/Iterable;)Lnv1;

    move-result-object v0

    sget-object v1, Lcom/google/common/util/concurrent/ClosingFuture$Combiner;->INNER_FUTURE:LwA1;

    invoke-virtual {v0, v1}, Lnv1;->o(LwA1;)Lnv1;

    move-result-object v0

    invoke-virtual {v0}, Lnv1;->j()LVY1;
