...
.field private final futures:LVY1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LVY1<",
...
# direct methods
.method private constructor <init>(ZLVY1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p2, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->futures:LVY1;

    return-void
.end method

.method public synthetic constructor <init>(ZLVY1;Lcom/google/common/util/concurrent/Futures$1;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/common/util/concurrent/Futures$FutureCombiner;-><init>(ZLVY1;)V
...
.method public call(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iget-object v1, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->futures:LVY1;

    iget-boolean v2, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->allMustSucceed:Z

    invoke-direct {v0, v1, v2, p2, p1}, Lcom/google/common/util/concurrent/CombinedFuture;-><init>(LQY1;ZLjava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)V
...
.method public callAsync(Lcom/google/common/util/concurrent/AsyncCallable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v0, v1, v2, p2, p1}, Lcom/google/common/util/concurrent/CombinedFuture;-><init>(LQY1;ZLjava/util/concurrent/Executor;Lcom/google/common/util/concurrent/AsyncCallable;)V
