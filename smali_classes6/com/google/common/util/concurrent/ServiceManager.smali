...
# instance fields
.field private final services:LVY1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LVY1<",
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-static {p1}, LVY1;->x(Ljava/lang/Iterable;)LVY1;
    ...
    invoke-static {p1}, LVY1;->F(Ljava/lang/Object;)LVY1;
    ...
    invoke-direct {v0, p1}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;-><init>(LQY1;)V
    ...
    iput-object p1, p0, Lcom/google/common/util/concurrent/ServiceManager;->services:LVY1;

    new-instance v1, Ljava/lang/ref/WeakReference;

    invoke-direct {v1, v0}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-virtual {p1}, LVY1;->j()Lre6;
    ...
    invoke-static {v2, v3, v0}, LEZ3;->j(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method public isHealthy()Z
    ...
    iget-object v0, p0, Lcom/google/common/util/concurrent/ServiceManager;->services:LVY1;
...
.method public bridge synthetic servicesByState()LYY1;
    .locals 1

    invoke-virtual {p0}, Lcom/google/common/util/concurrent/ServiceManager;->servicesByState()LdZ1;
...
.method public servicesByState()LdZ1;
    ...
    invoke-virtual {v0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->servicesByState()LdZ1;
...
.method public startAsync()Lcom/google/common/util/concurrent/ServiceManager;
    ...
    invoke-static {v1, v2, p0}, LEZ3;->w(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method public startupTimes()LXY1;
    ...
    invoke-virtual {v0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->startupTimes()LXY1;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v0}, LKV2;->b(Ljava/lang/Class;)LKV2$b;

    move-result-object v0

    iget-object v1, p0, Lcom/google/common/util/concurrent/ServiceManager;->services:LVY1;

    const-class v2, Lcom/google/common/util/concurrent/ServiceManager$NoOpService;

    invoke-static {v2}, LJZ3;->g(Ljava/lang/Class;)LIZ3;

    move-result-object v2

    invoke-static {v2}, LJZ3;->i(LIZ3;)LIZ3;

    move-result-object v2

    invoke-static {v1, v2}, Lkm0;->b(Ljava/util/Collection;LIZ3;)Ljava/util/Collection;
