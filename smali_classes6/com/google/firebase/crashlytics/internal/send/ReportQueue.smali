...
.field private final transport:LR96;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LR96<",
...
# direct methods
.method public constructor <init>(DDJLR96;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
    .locals 0
    ...
    iput-object p7, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:LR96;
...
.method public constructor <init>(LR96;Lcom/google/firebase/crashlytics/internal/settings/Settings;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;-><init>(DDJLR96;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
...
.method private synthetic lambda$flushScheduledReportsIfAble$0(Ljava/util/concurrent/CountDownLatch;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:LR96;

    sget-object v1, LN24;->d:LN24;

    invoke-static {v0, v1}, LXw1;->a(LR96;LN24;)V
    :try_end_0
...
.method private sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:LR96;
    ...
    invoke-static {v2}, Lyg1;->f(Ljava/lang/Object;)Lyg1;
    ...
    invoke-interface {v1, v2, v3}, LR96;->b(Lyg1;Lla6;)V
