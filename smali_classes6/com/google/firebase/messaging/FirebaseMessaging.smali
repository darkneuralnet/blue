...
.field private static store:Lcom/google/firebase/messaging/e;

.field static syncExecutor:Ljava/util/concurrent/ScheduledExecutorService;

.field static transportFactory:LU96;
...
.field private final firebaseApp:LAm1;

.field private final fis:LSm1;

.field private final gmsRpc:LZC1;

.field private final iid:LUm1;
...
.field private final metadata:LET2;

.field private final requestDeduplicator:Lcom/google/firebase/messaging/d;
...
.method public constructor <init>(LAm1;LUm1;LSm1;LU96;LiT5;LET2;LZC1;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V
    .locals 1
    ...
    sput-object p4, Lcom/google/firebase/messaging/FirebaseMessaging;->transportFactory:LU96;

    iput-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LAm1;

    iput-object p2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->iid:LUm1;

    iput-object p3, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->fis:LSm1;

    new-instance p3, Lcom/google/firebase/messaging/FirebaseMessaging$a;

    invoke-direct {p3, p0, p5}, Lcom/google/firebase/messaging/FirebaseMessaging$a;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;LiT5;)V
    ...
    iput-object p6, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->metadata:LET2;

    iput-object p8, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->taskExecutor:Ljava/util/concurrent/Executor;

    iput-object p7, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->gmsRpc:LZC1;
    ...
    iput-object p5, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->requestDeduplicator:Lcom/google/firebase/messaging/d;
    ...
    invoke-direct {p1, p0}, LYm1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V

    invoke-interface {p2, p1}, LUm1;->b(LUm1$a;)V

    :cond_1
    new-instance p1, LZm1;

    invoke-direct {p1, p0}, LZm1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V

    invoke-interface {p9, p1}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    invoke-static {}, LUj1;->g()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object p1

    invoke-static {p0, p6, p7, p3, p1}, LO56;->f(Lcom/google/firebase/messaging/FirebaseMessaging;LET2;LZC1;Landroid/content/Context;Ljava/util/concurrent/ScheduledExecutorService;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {p2, p0}, Lan1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V
    ...
    invoke-direct {p1, p0}, Lbn1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V
...
.method public constructor <init>(LAm1;LUm1;LX94;LX94;LSm1;LU96;LiT5;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v8, v0}, LET2;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/messaging/FirebaseMessaging;-><init>(LAm1;LUm1;LX94;LX94;LSm1;LU96;LiT5;LET2;)V

    return-void
.end method

.method public constructor <init>(LAm1;LUm1;LX94;LX94;LSm1;LU96;LiT5;LET2;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v5}, LZC1;-><init>(LAm1;LET2;LX94;LX94;LSm1;)V

    invoke-static {}, LUj1;->f()Ljava/util/concurrent/ExecutorService;

    move-result-object v8

    invoke-static {}, LUj1;->c()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v9

    invoke-static {}, LUj1;->b()Ljava/util/concurrent/Executor;
    ...
    invoke-direct/range {v0 .. v10}, Lcom/google/firebase/messaging/FirebaseMessaging;-><init>(LAm1;LUm1;LSm1;LU96;LiT5;LET2;LZC1;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method public static synthetic a(Lcom/google/firebase/messaging/FirebaseMessaging;Ljava/lang/String;Lcom/google/firebase/messaging/e$a;)Lcom/google/android/gms/tasks/Task;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$blockingGetToken$10(Ljava/lang/String;Lcom/google/firebase/messaging/e$a;)Lcom/google/android/gms/tasks/Task;
...
.method public static synthetic access$000(Lcom/google/firebase/messaging/FirebaseMessaging;)LAm1;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LAm1;
...
.method public static synthetic b(Lcom/google/firebase/messaging/FirebaseMessaging;Ljava/lang/String;Lcom/google/firebase/messaging/e$a;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$blockingGetToken$9(Ljava/lang/String;Lcom/google/firebase/messaging/e$a;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
...
.method public static declared-synchronized clearStoreForTest()V
    ...
    :try_start_0
    sput-object v1, Lcom/google/firebase/messaging/FirebaseMessaging;->store:Lcom/google/firebase/messaging/e;
    :try_end_0
...
.method public static clearTransportFactoryForTest()V
    ...
    sput-object v0, Lcom/google/firebase/messaging/FirebaseMessaging;->transportFactory:LU96;

    return-void
.end method

.method public static synthetic d(Ljava/lang/String;LO56;)Lcom/google/android/gms/tasks/Task;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$unsubscribeFromTopic$8(Ljava/lang/String;LO56;)Lcom/google/android/gms/tasks/Task;
...
.method public static synthetic f(Lcom/google/firebase/messaging/FirebaseMessaging;LO56;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$new$2(LO56;)V
...
.method public static declared-synchronized getInstance()Lcom/google/firebase/messaging/FirebaseMessaging;
    ...
    invoke-static {v1}, Lcom/google/firebase/messaging/FirebaseMessaging;->getInstance(LAm1;)Lcom/google/firebase/messaging/FirebaseMessaging;
...
.method public static declared-synchronized getInstance(LAm1;)Lcom/google/firebase/messaging/FirebaseMessaging;
    .locals 2
...
.method private static declared-synchronized getStore(Landroid/content/Context;)Lcom/google/firebase/messaging/e;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/FirebaseMessaging;->store:Lcom/google/firebase/messaging/e;
    ...
    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/FirebaseMessaging;->store:Lcom/google/firebase/messaging/e;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private getSubtype()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LAm1;
...
.method public static getTransportFactory()LU96;
    .locals 1

    sget-object v0, Lcom/google/firebase/messaging/FirebaseMessaging;->transportFactory:LU96;
...
.method private invokeOnTokenRefresh(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LAm1;

    invoke-virtual {v2}, LAm1;->l()Ljava/lang/String;
    ...
    invoke-direct {p1, v1}, LTj1;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1, v0}, LTj1;->i(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;

    :cond_1
    return-void
.end method

.method public static synthetic j(Ljava/lang/String;LO56;)Lcom/google/android/gms/tasks/Task;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$subscribeToTopic$7(Ljava/lang/String;LO56;)Lcom/google/android/gms/tasks/Task;
...
.method private synthetic lambda$blockingGetToken$10(Ljava/lang/String;Lcom/google/firebase/messaging/e$a;)Lcom/google/android/gms/tasks/Task;
    .locals 3

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->gmsRpc:LZC1;

    invoke-virtual {v0}, LZC1;->f()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0, p1, p2}, LXm1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Ljava/lang/String;Lcom/google/firebase/messaging/e$a;)V
...
.method private synthetic lambda$blockingGetToken$9(Ljava/lang/String;Lcom/google/firebase/messaging/e$a;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    .locals 3
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessaging;->getStore(Landroid/content/Context;)Lcom/google/firebase/messaging/e;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->metadata:LET2;

    invoke-virtual {v2}, LET2;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, p1, p3, v2}, Lcom/google/firebase/messaging/e;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private synthetic lambda$deleteToken$5(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->iid:LUm1;

    iget-object v1, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LAm1;

    invoke-static {v1}, LET2;->c(LAm1;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "FCM"

    invoke-interface {v0, v1, v2}, LUm1;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private synthetic lambda$deleteToken$6(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    invoke-virtual {v0}, LZC1;->c()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {v2}, LET2;->c(LAm1;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/google/firebase/messaging/e;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method private synthetic lambda$new$2(LO56;)V
    .locals 1
...
.method private synthetic lambda$new$3()V
    ...
    invoke-static {v0}, Lfa4;->c(Landroid/content/Context;)V

    return-void
.end method

.method private static synthetic lambda$subscribeToTopic$7(Ljava/lang/String;LO56;)Lcom/google/android/gms/tasks/Task;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p1, p0}, LO56;->r(Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
...
.method private static synthetic lambda$unsubscribeFromTopic$8(Ljava/lang/String;LO56;)Lcom/google/android/gms/tasks/Task;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p1, p0}, LO56;->u(Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
...
.method private startSyncIfNecessary()V
    ...
    invoke-interface {v0}, LUm1;->getToken()Ljava/lang/String;
...
.method public blockingGetToken()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, LUm1;->c()Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->requestDeduplicator:Lcom/google/firebase/messaging/d;

    new-instance v3, Ldn1;

    invoke-direct {v3, p0, v1, v0}, Ldn1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Ljava/lang/String;Lcom/google/firebase/messaging/e$a;)V
...
.method public deleteToken()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0, v0}, Len1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    invoke-static {}, LUj1;->e()Ljava/util/concurrent/ExecutorService;

    move-result-object v1

    new-instance v2, Lfn1;

    invoke-direct {v2, p0, v0}, Lfn1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public getToken()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0, v0}, Lgn1;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public getTokenWithoutTriggeringSync()Lcom/google/firebase/messaging/e$a;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/firebase/messaging/e;->e(Ljava/lang/String;Ljava/lang/String;)Lcom/google/firebase/messaging/e$a;
...
.method public isGmsCorePresent()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->metadata:LET2;
...
.method public isNotificationDelegationEnabled()Z
    ...
    invoke-static {v0}, Lfa4;->d(Landroid/content/Context;)Z
...
.method public setNotificationDelegationEnabled(Z)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {v0, v1, p1}, Lfa4;->f(Ljava/util/concurrent/Executor;Landroid/content/Context;Z)Lcom/google/android/gms/tasks/Task;
...
.method public subscribeToTopic(Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, p1}, Lcn1;-><init>(Ljava/lang/String;)V
...
.method public declared-synchronized syncWithDelaySecondsInternal(J)V
    ...
    invoke-direct {v2, p0, v0, v1}, LAX5;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;J)V
...
.method public tokenNeedsRefresh(Lcom/google/firebase/messaging/e$a;)Z
    ...
    invoke-virtual {v0}, LET2;->a()Ljava/lang/String;
...
.method public unsubscribeFromTopic(Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, p1}, LWm1;-><init>(Ljava/lang/String;)V
