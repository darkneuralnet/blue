...
.method public static a()Z
    ...
    invoke-virtual {v2}, LAm1;->j()Landroid/content/Context;
...
.method public static b(LBT2$b;Landroid/content/Intent;)LBT2;
    .locals 4
    ...
    invoke-virtual {v0, v1}, LBT2$a;->m(I)LBT2$a;

    move-result-object v0

    invoke-virtual {v0, p0}, LBT2$a;->e(LBT2$b;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->f(Ljava/lang/String;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->i(Ljava/lang/String;)LBT2$a;

    move-result-object p0

    sget-object v0, LBT2$d;->d:LBT2$d;

    invoke-virtual {p0, v0}, LBT2$a;->k(LBT2$d;)LBT2$a;

    move-result-object p0

    invoke-static {p1}, Lcom/google/firebase/messaging/b;->k(Landroid/os/Bundle;)LBT2$c;

    move-result-object v0

    invoke-virtual {p0, v0}, LBT2$a;->h(LBT2$c;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->g(Ljava/lang/String;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->l(Ljava/lang/String;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->c(Ljava/lang/String;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->b(Ljava/lang/String;)LBT2$a;
    ...
    invoke-virtual {p0, v0}, LBT2$a;->d(Ljava/lang/String;)LBT2$a;
    ...
    invoke-virtual {p0, v0, v1}, LBT2$a;->j(J)LBT2$a;

    :cond_7
    invoke-virtual {p0}, LBT2$a;->a()LBT2;
...
.method public static f(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/firebase/installations/a;->q(LAm1;)Lcom/google/firebase/installations/a;
...
.method public static k(Landroid/os/Bundle;)LBT2$c;
    .locals 0
    ...
    sget-object p0, LBT2$c;->f:LBT2$c;

    goto :goto_0

    :cond_0
    sget-object p0, LBT2$c;->d:LBT2$c;
...
.method public static n(Landroid/os/Bundle;)J
    ...
    invoke-virtual {p0}, Lpn1;->c()Ljava/lang/String;
...
.method public static v(Landroid/content/Intent;)V
    ...
    sget-object v0, LBT2$b;->d:LBT2$b;

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()LU96;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/b;->w(LBT2$b;Landroid/content/Intent;LU96;)V

    :cond_1
    return-void
.end method

.method public static w(LBT2$b;Landroid/content/Intent;LU96;)V
    .locals 4
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->b(LBT2$b;Landroid/content/Intent;)LBT2;
    ...
    invoke-direct {v3}, LAT2;-><init>()V

    invoke-interface {p2, p1, v1, v2, v3}, LU96;->a(Ljava/lang/String;Ljava/lang/Class;LPc1;LC96;)LR96;

    move-result-object p1

    invoke-static {}, LCT2;->b()LCT2$a;

    move-result-object p2

    invoke-virtual {p2, p0}, LCT2$a;->b(LBT2;)LCT2$a;

    move-result-object p0

    invoke-virtual {p0}, LCT2$a;->a()LCT2;
    ...
    invoke-interface {p1, p0}, LR96;->a(Lyg1;)V
    :try_end_0
...
.method public static x(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, v2}, LAm1;->i(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, p0, v1}, Lba;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static z(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, LAm1;->i(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v2, v1, p0}, Lba;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v2, p0, v1}, Lba;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
