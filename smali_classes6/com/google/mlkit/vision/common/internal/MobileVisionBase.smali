...
# static fields
.field public static final g:Lcom/google/android/gms/common/internal/GmsLogger;
...
.field public final d:Lcom/google/android/gms/tasks/CancellationTokenSource;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->g:Lcom/google/android/gms/common/internal/GmsLogger;
...
.method public constructor <init>(LLE2;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->c:LLE2;
    ...
    invoke-virtual {p1, p2, v1, v0}, LcV2;->a(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lcom/google/android/gms/tasks/CancellationToken;)Lcom/google/android/gms/tasks/Task;

    move-result-object p1

    sget-object p2, LoQ7;->a:LoQ7;
...
# virtual methods
.method public declared-synchronized a(Lg32;)Lcom/google/android/gms/tasks/Task;
    .locals 3
    .annotation build Lcom/google/android/gms/common/annotation/KeepForSdk;
    .end annotation
    ...
    iget-object v0, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->c:LLE2;

    iget-object v1, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->e:Ljava/util/concurrent/Executor;

    new-instance v2, Lgf7;

    invoke-direct {v2, p0, p1}, Lgf7;-><init>(Lcom/google/mlkit/vision/common/internal/MobileVisionBase;Lg32;)V
    ...
    invoke-virtual {v0, v1, v2, p1}, LcV2;->a(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lcom/google/android/gms/tasks/CancellationToken;)Lcom/google/android/gms/tasks/Task;
...
.method public final synthetic b(Lg32;)Ljava/lang/Object;
    .locals 6
    ...
    invoke-static {v1}, LAY8;->d(Ljava/lang/String;)LAY8;

    move-result-object v1

    invoke-virtual {v1}, LAY8;->a()LAY8;

    :try_start_0
    iget-object v2, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->c:LLE2;

    invoke-virtual {v2, p1}, LLE2;->i(LNE2;)Ljava/lang/Object;

    move-result-object p1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v1}, LAY8;->close()V
...
.method public declared-synchronized close()V
    ...
    invoke-virtual {v0, v1}, LcV2;->e(Ljava/util/concurrent/Executor;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
