...
# static fields
.field public static final i:Lio/reactivex/internal/operators/mixed/d$a$a;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/operators/mixed/d$a;->i:Lio/reactivex/internal/operators/mixed/d$a$a;
...
.method public constructor <init>(Lio/reactivex/f;Lio/reactivex/functions/o;Z)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->b:Lio/reactivex/f;

    iput-object p2, p0, Lio/reactivex/internal/operators/mixed/d$a;->c:Lio/reactivex/functions/o;

    iput-boolean p3, p0, Lio/reactivex/internal/operators/mixed/d$a;->d:Z
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public a(LoT5;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/mixed/d$a;->h:LoT5;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->h:LoT5;

    iget-object v0, p0, Lio/reactivex/internal/operators/mixed/d$a;->b:Lio/reactivex/f;
...
.method public b()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/mixed/d$a;->f:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v1, Lio/reactivex/internal/operators/mixed/d$a;->i:Lio/reactivex/internal/operators/mixed/d$a$a;
...
.method public c(Lio/reactivex/internal/operators/mixed/d$a$a;)V
    .locals 2
    ...
    iget-boolean p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->g:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->e:Lio/reactivex/internal/util/c;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->b:Lio/reactivex/f;
...
.method public d(Lio/reactivex/internal/operators/mixed/d$a$a;Ljava/lang/Throwable;)V
    .locals 2
    ...
    iget-boolean p1, p0, Lio/reactivex/internal/operators/mixed/d$a;->d:Z
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/mixed/d$a;->b:Lio/reactivex/f;
    ...
    :cond_0
    invoke-virtual {p0}, Lio/reactivex/internal/operators/mixed/d$a;->dispose()V
...
.method public dispose()V
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/mixed/d$a;->b()V
...
.method public onComplete()V
    ...
    iput-boolean v0, p0, Lio/reactivex/internal/operators/mixed/d$a;->g:Z
    ...
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/mixed/d$a;->b:Lio/reactivex/f;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/mixed/d$a;->c:Lio/reactivex/functions/o;
    ...
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/mixed/d$a;->f:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lio/reactivex/internal/operators/mixed/d$a$a;

    sget-object v2, Lio/reactivex/internal/operators/mixed/d$a;->i:Lio/reactivex/internal/operators/mixed/d$a$a;
    ...
    :cond_1
    iget-object v2, p0, Lio/reactivex/internal/operators/mixed/d$a;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v1}, Lio/reactivex/internal/operators/mixed/d$a$a;->a()V
