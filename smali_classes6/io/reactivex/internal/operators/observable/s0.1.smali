...
.method public constructor <init>(Lio/reactivex/B;Lio/reactivex/B;Lio/reactivex/functions/o;Lio/reactivex/functions/o;Lio/reactivex/functions/c;)V
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/s0;->c:Lio/reactivex/B;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/s0;->d:Lio/reactivex/functions/o;

    iput-object p4, p0, Lio/reactivex/internal/operators/observable/s0;->e:Lio/reactivex/functions/o;

    iput-object p5, p0, Lio/reactivex/internal/operators/observable/s0;->f:Lio/reactivex/functions/c;
...
.method public subscribeActual(Lio/reactivex/D;)V
    ...
    new-instance v0, Lio/reactivex/internal/operators/observable/s0$a;

    iget-object v1, p0, Lio/reactivex/internal/operators/observable/s0;->d:Lio/reactivex/functions/o;

    iget-object v2, p0, Lio/reactivex/internal/operators/observable/s0;->e:Lio/reactivex/functions/o;

    iget-object v3, p0, Lio/reactivex/internal/operators/observable/s0;->f:Lio/reactivex/functions/c;

    invoke-direct {v0, p1, v1, v2, v3}, Lio/reactivex/internal/operators/observable/s0$a;-><init>(Lio/reactivex/D;Lio/reactivex/functions/o;Lio/reactivex/functions/o;Lio/reactivex/functions/c;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/observable/s0$a;->d:Lio/reactivex/disposables/b;
    ...
    iget-object v0, v0, Lio/reactivex/internal/operators/observable/s0$a;->d:Lio/reactivex/disposables/b;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/s0;->c:Lio/reactivex/B;
