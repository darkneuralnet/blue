...
.method public final declared-synchronized a(Landroid/content/Context;)Landroid/content/Context;
    ...
    :try_start_1
    iget-object v0, p0, LkN6;->c:LJN6;

    invoke-virtual {v0}, LJN6;->a()Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, LkN6;->a:Landroid/content/Context;
    :try_end_2
...
.method public final declared-synchronized b(Landroid/content/Context;)Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;
    ...
    :try_start_0
    iget-object v0, p0, LkN6;->b:Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;

    if-nez v0, :cond_2

    invoke-virtual {p0, p1}, LkN6;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p1}, LkN6;->c(Ljava/lang/ClassLoader;)Landroid/os/IBinder;
    ...
    invoke-direct {v0, p1}, LIJ6;-><init>(Landroid/os/IBinder;)V

    move-object p1, v0

    :goto_0
    iput-object p1, p0, LkN6;->b:Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;

    :cond_2
    iget-object p1, p0, LkN6;->b:Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
