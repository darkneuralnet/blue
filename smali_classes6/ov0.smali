...
.method public constructor <init>(LXA0;LoL3;)V
    ...
    iput-boolean v0, p0, Lov0;->a:Z

    iput-object p1, p0, Lov0;->b:LXA0;

    iput-object p2, p0, Lov0;->c:LoL3;

    return-void
.end method

.method public static synthetic a(Lov0;Ljava/lang/String;Z)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lov0;->f(Ljava/lang/String;Z)V
...
# virtual methods
.method public b()LSy3;
    .locals 5

    invoke-virtual {p0}, Lov0;->d()V

    iget-object v0, p0, Lov0;->b:LXA0;

    const-string v1, "com.paypal.otc.config.file"

    invoke-virtual {v0, v1}, LXA0;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    :try_start_0
    invoke-virtual {p0, v0}, Lov0;->c(Ljava/lang/String;)LSy3;
    ...
    :catch_0
    :try_start_1
    invoke-virtual {p0, v1}, Lov0;->c(Ljava/lang/String;)LSy3;
    ...
    invoke-virtual {p0, v1, v2}, Lov0;->f(Ljava/lang/String;Z)V
...
.method public final c(Ljava/lang/String;)LSy3;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Llv0;->e(Lorg/json/JSONObject;)LSy3;
...
.method public d()V
    ...
    iput-object v0, p0, Lov0;->d:Ljava/util/Date;

    iget-object v0, p0, Lov0;->c:LoL3;

    new-instance v1, Lov0$a;

    invoke-direct {v1, p0}, Lov0$a;-><init>(Lov0;)V

    const-string v2, "https://www.paypalobjects.com/webstatic/otc/otc-config.android.json"

    invoke-virtual {v0, v2, v1}, LyN1;->a(Ljava/lang/String;LHN1;)V
...
.method public final e()Z
    ...
    iget-object v1, p0, Lov0;->b:LXA0;

    const-string v2, "com.paypal.otc.config.lastUpdated.timestamp"

    const-wide/16 v3, 0x0

    invoke-virtual {v1, v2, v3, v4}, LXA0;->c(Ljava/lang/String;J)J
    ...
    iget-object v2, p0, Lov0;->d:Ljava/util/Date;
    ...
    :goto_0
    iget-object v2, p0, Lov0;->b:LXA0;

    const-string v5, "com.paypal.otc.config.isDefault"

    invoke-virtual {v2, v5, v4}, LXA0;->a(Ljava/lang/String;Z)Z
...
.method public final f(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v1, p1}, LXA0;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lov0;->b:LXA0;
    ...
    invoke-virtual {p1, v0, v1, v2}, LXA0;->e(Ljava/lang/String;J)V

    iget-object p1, p0, Lov0;->b:LXA0;

    const-string v0, "com.paypal.otc.config.isDefault"

    invoke-virtual {p1, v0, p2}, LXA0;->g(Ljava/lang/String;Z)V
