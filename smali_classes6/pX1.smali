...
.method public static j(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0}, LpX1;->k(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1, p2}, LpX1;->m([BII)[B
    ...
    invoke-static {p0, p3, p1, p2}, LpX1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public d(Landroid/media/Image;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, v0, v1}, LpX1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public e(Lg32;Z)Ljava/nio/ByteBuffer;
    .locals 17
    .annotation build Lcom/google/android/gms/common/annotation/KeepForSdk;
    .end annotation
    ...
    invoke-virtual/range {p1 .. p1}, Lg32;->e()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1, v0}, LpX1;->k(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v3, v0, v1, v2}, LpX1;->i([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0}, LpX1;->a(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
...
.method public f(Lg32;)Landroid/graphics/Bitmap;
    .locals 3
    .annotation build Lcom/google/android/gms/common/annotation/KeepForSdk;
    .end annotation
    ...
    invoke-static {v0, v1, v2, p1}, LpX1;->j(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, v1, v2}, LpX1;->i([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, LpX1;->h(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v2, p1}, LpX1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public h(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1}, LpX1;->b(Ljava/nio/ByteBuffer;)[B

    move-result-object p1

    invoke-static {p1, p2, p3}, LpX1;->m([BII)[B
    ...
    invoke-static {p1, p4, p2, p3}, LpX1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public i([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {v5 .. v10}, LpX1;->n(Landroid/media/Image$Plane;II[BII)V
    ...
    invoke-static/range {v0 .. v5}, LpX1;->n(Landroid/media/Image$Plane;II[BII)V
