...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lyp0;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2, p1, p3}, Lyp0;->f(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-static {p1}, Lyp0;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    :cond_1
    invoke-static {}, Lyp0;->g()I

    move-result p1

    const/high16 p3, 0x40000000    # 2.0f

    invoke-static {p3}, Lyp0;->l(I)I
...
.method public static b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2}, Lyp0;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    invoke-static {p0, p1, p2}, Lyp0;->c(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method public static d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)Lyp0$a;
    .locals 5
    ...
    invoke-virtual {v3, p3}, Lac3$e;->m(Ljava/lang/CharSequence;)Lac3$e;
    ...
    invoke-virtual {v3, p3}, Lac3$e;->l(Ljava/lang/CharSequence;)Lac3$e;
    ...
    invoke-virtual {v3, p3}, Lac3$e;->D(Lac3$i;)Lac3$e;
    ...
    invoke-static {v2, v1, v0, p3, p4}, Lyp0;->m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I

    move-result p3

    invoke-virtual {v3, p3}, Lac3$e;->B(I)Lac3$e;

    invoke-static {v0, p2, v1}, Lyp0;->n(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/res/Resources;)Landroid/net/Uri;

    move-result-object p3

    if-eqz p3, :cond_2

    invoke-virtual {v3, p3}, Lac3$e;->C(Landroid/net/Uri;)Lac3$e;

    :cond_2
    invoke-static {p0, p2, v0, v2}, Lyp0;->a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;

    move-result-object p3

    invoke-virtual {v3, p3}, Lac3$e;->k(Landroid/app/PendingIntent;)Lac3$e;

    invoke-static {p0, p1, p2}, Lyp0;->b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;

    move-result-object p0

    if-eqz p0, :cond_3

    invoke-virtual {v3, p0}, Lac3$e;->q(Landroid/app/PendingIntent;)Lac3$e;
    ...
    invoke-static {p1, p0, p4}, Lyp0;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    invoke-virtual {v3, p0}, Lac3$e;->j(I)Lac3$e;
    ...
    invoke-virtual {v3, p0}, Lac3$e;->g(Z)Lac3$e;
    ...
    invoke-virtual {v3, p0}, Lac3$e;->u(Z)Lac3$e;
    ...
    invoke-virtual {v3, p0}, Lac3$e;->F(Ljava/lang/CharSequence;)Lac3$e;
    ...
    invoke-virtual {v3, p0}, Lac3$e;->x(I)Lac3$e;
    ...
    invoke-virtual {v3, p1}, Lac3$e;->A(Z)Lac3$e;

    invoke-virtual {p0}, Ljava/lang/Long;->longValue()J

    move-result-wide p3

    invoke-virtual {v3, p3, p4}, Lac3$e;->I(J)Lac3$e;
    ...
    invoke-virtual {v3, p0}, Lac3$e;->G([J)Lac3$e;
    ...
    invoke-virtual {v3, p4, p1, p0}, Lac3$e;->t(III)Lac3$e;

    :cond_b
    invoke-static {p2}, Lyp0;->i(Lcom/google/firebase/messaging/c;)I

    move-result p0

    invoke-virtual {v3, p0}, Lac3$e;->p(I)Lac3$e;

    new-instance p0, Lyp0$a;

    invoke-static {p2}, Lyp0;->o(Lcom/google/firebase/messaging/c;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, v3, p1, p3}, Lyp0$a;-><init>(Lac3$e;Ljava/lang/String;I)V

    return-object p0
.end method

.method public static e(Landroid/content/Context;Lcom/google/firebase/messaging/c;)Lyp0$a;
    .locals 2
    ...
    invoke-static {v0, v1}, Lyp0;->j(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {p0, v1, v0}, Lyp0;->k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, p0, p1, v1, v0}, Lyp0;->d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)Lyp0$a;
...
.method public static g()I
    ...
    sget-object v0, Lyp0;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lea3;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {p1, p0, p2}, Lha3;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p0

    invoke-static {v0, p0}, Lda3;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
...
.method public static m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {p1, v0}, Lyp0;->p(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p1, p3}, Lyp0;->p(Landroid/content/res/Resources;I)Z
...
.method public static p(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p0}, Lxp0;->a(Ljava/lang/Object;)Z
