...
# instance fields
.field final synthetic $defaultReturnUrl:Lcom/stripe/android/payments/DefaultReturnUrl;

.field final synthetic $lazyRegistry:Ldagger/Lazy;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ldagger/Lazy<",
...
.method public final invoke(Lcom/stripe/android/view/AuthActivityStarterHost;)Lcom/stripe/android/PaymentBrowserAuthStarter;
    ...
    invoke-virtual {v0}, Lcom/stripe/android/payments/core/authentication/DefaultPaymentAuthenticatorRegistry;->getPaymentBrowserAuthLauncher$payments_core_release()LB5;
    ...
    invoke-direct {p1, v0}, Lcom/stripe/android/PaymentBrowserAuthStarter$Modern;-><init>(LB5;)V
