...
.method private final parsePublicKey(Ljava/lang/Object;)Ljava/security/interfaces/ECPublicKey;
    ...
    invoke-static {p1}, LQ81;->w(Ljava/util/Map;)LQ81;
    ...
    :cond_2
    invoke-static {p1}, LQ81;->v(Ljava/lang/String;)LQ81;

    move-result-object p1

    :goto_1
    invoke-virtual {p1}, LQ81;->x()Ljava/security/interfaces/ECPublicKey;
...
.method public parse(Lorg/json/JSONObject;)Lcom/stripe/android/stripe3ds2/transaction/AcsData;
    ...
    invoke-static {v0}, LMg2;->m(Ljava/lang/String;)Ljava/util/Map;
