...
.method public static constructor <clinit>()V
    ...
    invoke-static {v2, v1}, Lh83;->a(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {v1, v0}, Lh83;->a(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method public final tryRelativeTo(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {p2}, LvJ3;->a(Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object p2

    invoke-static {p1}, LvJ3;->a(Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object p1

    invoke-static {p2, p1}, LzJ3;->a(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object v0

    invoke-static {p2}, LAJ3;->a(Ljava/nio/file/Path;)I

    move-result v1

    invoke-static {p1}, LAJ3;->a(Ljava/nio/file/Path;)I
    ...
    invoke-static {p2, v3}, LBJ3;->a(Ljava/nio/file/Path;I)Ljava/nio/file/Path;
    ...
    invoke-static {p1, v3}, LBJ3;->a(Ljava/nio/file/Path;I)Ljava/nio/file/Path;
    ...
    invoke-static {v0}, LwJ3;->a(Ljava/nio/file/Path;)Ljava/nio/file/FileSystem;

    move-result-object p2

    invoke-static {p2}, LxJ3;->a(Ljava/nio/file/FileSystem;)Ljava/lang/String;
    ...
    invoke-static {p2, p1, v0}, LyJ3;->a(Ljava/nio/file/FileSystem;Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
