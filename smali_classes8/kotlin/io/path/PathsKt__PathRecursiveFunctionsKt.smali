...
.method public static final copyToRecursively(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZLkotlin/jvm/functions/Function3;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, v0}, LCJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, v1}, LCJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p1, v1}, LCJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p1}, LaK3;->a(Ljava/nio/file/Path;)Z
    ...
    invoke-static {p1}, LwJ3;->a(Ljava/nio/file/Path;)Ljava/nio/file/FileSystem;
    ...
    invoke-static {p1, v1}, LZJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v1

    new-array v0, v0, [Ljava/nio/file/LinkOption;

    invoke-static {p0, v0}, LZJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v0

    invoke-static {v1, v0}, LYJ3;->a(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    ...
    :cond_4
    invoke-static {p1}, Leh1;->a(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {v1, v3}, LCJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {v1, v3}, LZJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v1

    new-array v3, v0, [Ljava/nio/file/LinkOption;

    invoke-static {p0, v3}, LZJ3;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v3

    invoke-static {v1, v3}, LYJ3;->a(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    ...
    invoke-static {p0, p1, p2}, LeK3;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/nio/file/FileSystemException;
    ...
    invoke-static {p0, p1, p2}, LdK3;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/nio/file/NoSuchFileException;
...
.method private static final copyToRecursively$destination$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {p1, p0}, LXJ3;->a(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/Path;
...
.method public static final deleteRecursively(Ljava/nio/file/Path;)V
    ...
    invoke-static {v0}, Lfh1;->a(Ljava/lang/String;)Ljava/nio/file/FileSystemException;
...
.method private static final deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;)Ljava/util/List;
    ...
    invoke-static {p0}, Leh1;->a(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    :try_start_0
    invoke-static {v4}, LnK3;->a(Ljava/nio/file/Path;)Ljava/nio/file/DirectoryStream;
    ...
    :try_start_1
    invoke-static {v5}, LRJ3;->a(Ljava/lang/Object;)Ljava/nio/file/DirectoryStream;

    move-result-object v6

    invoke-static {v6}, LSJ3;->a(Ljava/lang/Object;)Z
    ...
    invoke-static {v6}, LTJ3;->a(Ljava/lang/Object;)Ljava/nio/file/SecureDirectoryStream;
...
.method private static final enterDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    invoke-static {}, LRW0;->a()Ljava/nio/file/LinkOption;
    ...
    invoke-static {p0, p1, v0}, LUJ3;->a(Ljava/nio/file/SecureDirectoryStream;Ljava/lang/Object;[Ljava/nio/file/LinkOption;)Ljava/nio/file/SecureDirectoryStream;
    ...
    :try_start_1
    invoke-static {p0}, LTJ3;->a(Ljava/lang/Object;)Ljava/nio/file/SecureDirectoryStream;

    move-result-object p1

    invoke-static {p1}, LVJ3;->a(Ljava/nio/file/SecureDirectoryStream;)Ljava/util/Iterator;
    ...
    invoke-static {v2}, Lg83;->a(Ljava/lang/Object;)Ljava/nio/file/Path;

    move-result-object v2

    invoke-static {v2}, Ldh1;->a(Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method private static final handleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    :try_start_1
    invoke-static {p0, p1}, LlK3;->a(Ljava/nio/file/SecureDirectoryStream;Ljava/lang/Object;)V
    ...
    :cond_0
    invoke-static {p0, p1}, LmK3;->a(Ljava/nio/file/SecureDirectoryStream;Ljava/lang/Object;)V
...
.method private static final insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    :try_start_0
    invoke-static {p0}, LnK3;->a(Ljava/nio/file/Path;)Ljava/nio/file/DirectoryStream;
    ...
    invoke-static {v1}, LWJ3;->a(Ljava/nio/file/DirectoryStream;)Ljava/util/Iterator;
...
.method private static final insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    invoke-static {p0, v0}, LQW0;->a(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method private static final varargs isDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, p1, v0, p2}, LhK3;->a(Ljava/nio/file/SecureDirectoryStream;Ljava/lang/Object;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;

    move-result-object p0

    invoke-static {p0}, LiK3;->a(Ljava/lang/Object;)Ljava/nio/file/attribute/BasicFileAttributeView;

    move-result-object p0

    invoke-static {p0}, LjK3;->a(Ljava/nio/file/attribute/BasicFileAttributeView;)Ljava/nio/file/attribute/BasicFileAttributes;

    move-result-object p0

    invoke-static {p0}, LkK3;->a(Ljava/nio/file/attribute/BasicFileAttributes;)Z
...
.method private static final toFileVisitResult$PathsKt__PathRecursiveFunctionsKt(Lkotlin/io/path/CopyActionResult;)Ljava/nio/file/FileVisitResult;
    ...
    invoke-static {}, LbK3;->a()Ljava/nio/file/FileVisitResult;
    ...
    :cond_1
    invoke-static {}, LQJ3;->a()Ljava/nio/file/FileVisitResult;
    ...
    :cond_2
    invoke-static {}, LgK3;->a()Ljava/nio/file/FileVisitResult;
