...
.method public g(Landroid/bluetooth/le/ScanResult;)Lno/nordicsemi/android/support/v18/scanner/ScanResult;
    ...
    invoke-static {p1}, LrX;->a(Landroid/bluetooth/le/ScanResult;)I

    move-result v0

    shl-int/lit8 v0, v0, 0x5

    invoke-static {p1}, LsX;->a(Landroid/bluetooth/le/ScanResult;)Z
    ...
    invoke-static {p1}, LtX;->a(Landroid/bluetooth/le/ScanResult;)I

    move-result v5

    invoke-static {p1}, LuX;->a(Landroid/bluetooth/le/ScanResult;)I

    move-result v6

    invoke-static {p1}, LvX;->a(Landroid/bluetooth/le/ScanResult;)I

    move-result v7

    invoke-static {p1}, LwX;->a(Landroid/bluetooth/le/ScanResult;)I
    ...
    invoke-static {p1}, LxX;->a(Landroid/bluetooth/le/ScanResult;)I
    ...
    invoke-direct/range {v2 .. v13}, Lno/nordicsemi/android/support/v18/scanner/ScanResult;-><init>(Landroid/bluetooth/BluetoothDevice;IIIIIIILBk5;J)V
...
.method public k(Landroid/bluetooth/BluetoothAdapter;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Z)Landroid/bluetooth/le/ScanSettings;
    ...
    invoke-static {p1, p3}, LHd;->a(Landroid/bluetooth/le/ScanSettings$Builder;Z)Landroid/bluetooth/le/ScanSettings$Builder;
    ...
    invoke-static {p1, p2}, LAX;->a(Landroid/bluetooth/le/ScanSettings$Builder;I)Landroid/bluetooth/le/ScanSettings$Builder;
...
.method public l(Landroid/app/PendingIntent;Lno/nordicsemi/android/support/v18/scanner/c$a;)V
    .locals 2
...
.method public m(Landroid/bluetooth/le/ScanFilter;)Lno/nordicsemi/android/support/v18/scanner/ScanFilter;
    .locals 5
...
.method public n(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Lno/nordicsemi/android/support/v18/scanner/c;->m(Landroid/bluetooth/le/ScanFilter;)Lno/nordicsemi/android/support/v18/scanner/ScanFilter;
...
.method public o(Landroid/bluetooth/le/ScanSettings;ZZZJJII)Lno/nordicsemi/android/support/v18/scanner/ScanSettings;
    .locals 3
    ...
    invoke-static {p1}, LyX;->a(Landroid/bluetooth/le/ScanSettings;)Z
    ...
    invoke-static {p1}, LzX;->a(Landroid/bluetooth/le/ScanSettings;)I
...
.method public p(Landroid/app/PendingIntent;)Lno/nordicsemi/android/support/v18/scanner/c$a;
    .locals 2
