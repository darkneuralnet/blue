...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "J",
        "<init>",
        "(LM70;Lokhttp3/MediaType;Ljava/util/List;)V",
        "Companion",
        "Builder",
        "Part",
        "okhttp"
...
# instance fields
.field private final boundaryByteString:LM70;
...
.method public constructor <init>(LM70;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:LM70;
...
.method private final writeOrCountBytes(Ln30;Z)J
    .locals 13
    ...
    invoke-interface {p1, v8}, Ln30;->s0([B)Ln30;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:LM70;

    invoke-interface {p1, v8}, Ln30;->e0(LM70;)Ln30;
    ...
    invoke-interface {p1, v11}, Ln30;->a2(Ljava/lang/String;)Ln30;

    move-result-object v11

    sget-object v12, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v11, v12}, Ln30;->s0([B)Ln30;
    ...
    invoke-interface {v11, v9}, Ln30;->a2(Ljava/lang/String;)Ln30;

    move-result-object v9

    sget-object v11, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v11}, Ln30;->s0([B)Ln30;
    ...
    invoke-interface {p1, v8}, Ln30;->a2(Ljava/lang/String;)Ln30;
    ...
    invoke-interface {v8, v7}, Ln30;->a2(Ljava/lang/String;)Ln30;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, Ln30;->s0([B)Ln30;
    ...
    invoke-interface {p1, v9}, Ln30;->a2(Ljava/lang/String;)Ln30;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Ln30;->x0(J)Ln30;

    move-result-object v9

    sget-object v10, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v10}, Ln30;->s0([B)Ln30;
    ...
    invoke-interface {p1, v9}, Ln30;->s0([B)Ln30;
    ...
    :cond_5
    invoke-virtual {v5, p1}, Lokhttp3/RequestBody;->writeTo(Ln30;)V
    ...
    invoke-interface {p1, v1}, Ln30;->s0([B)Ln30;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:LM70;

    invoke-interface {p1, v2}, Ln30;->e0(LM70;)Ln30;
...
.method public final boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:LM70;

    invoke-virtual {v0}, LM70;->w()Ljava/lang/String;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Ln30;Z)J
...
.method public writeTo(Ln30;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Ln30;Z)J
