...
.field private static final afterBoundaryOptions:Lry3;
...
.field private final crlfDashDashBoundary:LM70;

.field private currentPart:Lokhttp3/MultipartReader$PartSource;

.field private final dashDashBoundary:LM70;
...
.method public static constructor <clinit>()V
    ...
    new-array v1, v1, [LM70;

    sget-object v2, LM70;->e:LM70$a;

    const-string v3, "\r\n"

    invoke-virtual {v2, v3}, LM70$a;->d(Ljava/lang/String;)LM70;
    ...
    invoke-virtual {v0, v1}, Lry3$a;->d([LM70;)Lry3;

    move-result-object v0

    sput-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lry3;

    return-void
.end method

.method public constructor <init>(Lo30;Ljava/lang/String;)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/MultipartReader;->source:Lo30;
    ...
    invoke-virtual {p1, p2}, Li30;->r0(Ljava/lang/String;)Li30;

    move-result-object p1

    invoke-virtual {p1}, Li30;->h1()LM70;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/MultipartReader;->dashDashBoundary:LM70;
    ...
    iput-object p1, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:LM70;
...
.method public constructor <init>(Lokhttp3/ResponseBody;)V
    ...
    invoke-direct {p0, v0, p1}, Lokhttp3/MultipartReader;-><init>(Lo30;Ljava/lang/String;)V
...
.method public static final synthetic access$getAfterBoundaryOptions$cp()Lry3;
    .locals 1

    sget-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lry3;
...
.method public static final synthetic access$getSource$p(Lokhttp3/MultipartReader;)Lo30;
    .locals 0

    iget-object p0, p0, Lokhttp3/MultipartReader;->source:Lo30;
...
.method private final currentPartBytesRemaining(J)J
    ...
    iget-object v0, p0, Lokhttp3/MultipartReader;->source:Lo30;

    iget-object v1, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:LM70;
    ...
    invoke-interface {v0, v1, v2}, Lo30;->x2(J)V
    ...
    invoke-virtual {v0, v1}, Li30;->e2(LM70;)J
    ...
    iget-object v2, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:LM70;

    invoke-virtual {v2}, LM70;->size()I
...
.method public final nextPart()Lokhttp3/MultipartReader$Part;
    ...
    iget-object v5, p0, Lokhttp3/MultipartReader;->dashDashBoundary:LM70;

    invoke-interface {v0, v3, v4, v5}, Lo30;->p3(JLM70;)Z
    ...
    iget-object v3, p0, Lokhttp3/MultipartReader;->dashDashBoundary:LM70;

    invoke-virtual {v3}, LM70;->size()I

    move-result v3

    int-to-long v3, v3

    invoke-interface {v0, v3, v4}, Lo30;->skip(J)V
    ...
    iget-object v3, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:LM70;
    ...
    :goto_2
    iget-object v3, p0, Lokhttp3/MultipartReader;->source:Lo30;

    sget-object v4, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lry3;

    invoke-interface {v3, v4}, Lo30;->Q2(Lry3;)I
    ...
    iget-object v1, p0, Lokhttp3/MultipartReader;->source:Lo30;

    invoke-direct {v0, v1}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lo30;)V
    ...
    invoke-static {v1}, LOe3;->d(LAN5;)Lo30;

    move-result-object v1

    invoke-direct {v2, v0, v1}, Lokhttp3/MultipartReader$Part;-><init>(Lokhttp3/Headers;Lo30;)V
    ...
    invoke-interface {v0, v5, v6}, Lo30;->skip(J)V
