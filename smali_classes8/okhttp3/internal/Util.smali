...
.field private static final UNICODE_BOMS:Lry3;
...
.method public static constructor <clinit>()V
    ...
    sget-object v1, Lry3;->d:Lry3$a;

    const/4 v2, 0x5

    new-array v2, v2, [LM70;

    sget-object v3, LM70;->e:LM70$a;

    const-string v4, "efbbbf"

    invoke-virtual {v3, v4}, LM70$a;->b(Ljava/lang/String;)LM70;
    ...
    invoke-virtual {v1, v2}, Lry3$a;->d([LM70;)Lry3;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lry3;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    invoke-direct {v0, p0}, Loi6;-><init>(Lokhttp3/EventListener;)V
...
.method public static final discard(LAN5;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(LAN5;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)LwB5;
...
.method public static final isHealthy(Ljava/net/Socket;Lo30;)Z
    .locals 2
...
.method public static final readBomAsCharset(Lo30;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lry3;

    invoke-interface {p0, v0}, Lo30;->Q2(Lry3;)I
...
.method public static final readMedium(Lo30;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static final skipAll(Li30;B)I
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Li30;->p(J)B
...
.method public static final skipAll(LAN5;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, LAN5;->timeout()LJ46;

    move-result-object v2

    invoke-virtual {v2}, LJ46;->hasDeadline()Z
    ...
    invoke-virtual {v2}, LJ46;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, LJ46;->deadlineNanoTime(J)LJ46;
    ...
    invoke-interface {p0, p1, v7, v8}, LAN5;->read(Li30;J)J
    ...
    invoke-virtual {p0}, LJ46;->clearDeadline()LJ46;
    ...
    invoke-virtual {p0, v0, v1}, LJ46;->deadlineNanoTime(J)LJ46;
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lni6;-><init>(Ljava/lang/String;Z)V
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()LM70;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()LM70;

    move-result-object v1

    invoke-virtual {v2}, LM70;->w()Ljava/lang/String;
...
.method public static final writeMedium(Ln30;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0, v0}, Ln30;->M0(I)Ln30;
    ...
    invoke-interface {p0, p1}, Ln30;->M0(I)Ln30;
