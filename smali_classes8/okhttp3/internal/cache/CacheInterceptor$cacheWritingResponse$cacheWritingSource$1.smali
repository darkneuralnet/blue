...
# instance fields
.field final synthetic $cacheBody:Ln30;

.field final synthetic $cacheRequest:Lokhttp3/internal/cache/CacheRequest;

.field final synthetic $source:Lo30;

.field private cacheRequestClosed:Z


# direct methods
.method public constructor <init>(Lo30;Lokhttp3/internal/cache/CacheRequest;Ln30;)V
    .locals 0

    iput-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$source:Lo30;
    ...
    iput-object p3, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$cacheBody:Ln30;
...
.method public close()V
    ...
    invoke-static {p0, v0, v1}, Lokhttp3/internal/Util;->discard(LAN5;ILjava/util/concurrent/TimeUnit;)Z
    ...
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$source:Lo30;
...
.method public read(Li30;J)J
    ...
    :try_start_0
    iget-object v1, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$source:Lo30;

    invoke-interface {v1, p1, p2, p3}, LAN5;->read(Li30;J)J
    ...
    iget-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$cacheBody:Ln30;

    invoke-interface {p1}, LwB5;->close()V

    :cond_0
    return-wide v1

    :cond_1
    iget-object v0, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$cacheBody:Ln30;
    ...
    invoke-interface {p1}, Ln30;->T1()Ln30;
