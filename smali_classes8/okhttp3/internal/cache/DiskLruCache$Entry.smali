...
.method private final newSource(I)LAN5;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)LAN5;
    ...
    invoke-direct {v0, p1, v1, p0}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(LAN5;Lokhttp3/internal/cache/DiskLruCache;Lokhttp3/internal/cache/DiskLruCache$Entry;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v3}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)LAN5;
...
.method public final writeLengths$okhttp(Ln30;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, v5}, Ln30;->M0(I)Ln30;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Ln30;->x0(J)Ln30;
