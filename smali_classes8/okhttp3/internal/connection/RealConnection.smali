...
.field private sink:Ln30;

.field private socket:Ljava/net/Socket;

.field private source:Lo30;
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, LOe3;->m(Ljava/net/Socket;)LAN5;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lo30;

    invoke-static {v1}, LOe3;->i(Ljava/net/Socket;)LwB5;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ln30;
    :try_end_1
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ln30;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lo30;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lo30;

    invoke-static {v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ln30;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lo30;Ln30;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, LJ46;->timeout(JLjava/util/concurrent/TimeUnit;)LJ46;

    invoke-interface {v2}, LwB5;->timeout()LJ46;
    ...
    invoke-virtual {p1}, Li30;->O2()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Ln30;->e()Li30;
...
.method private final startHttp2(I)V
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lo30;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lo30;Ln30;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Lo30;

    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Ln30;
...
.method public final isHealthy(Z)Z
    ...
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lo30;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Lo30;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, LAN5;->timeout()LJ46;
    ...
    invoke-virtual {v0, v3, v4, v5}, LJ46;->timeout(JLjava/util/concurrent/TimeUnit;)LJ46;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lo30;Ln30;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lo30;Ln30;Lokhttp3/internal/connection/Exchange;)V
