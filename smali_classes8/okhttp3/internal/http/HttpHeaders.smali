...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:LM70;

.field private static final TOKEN_DELIMITERS:LM70;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:LM70;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:LM70;
...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v4, v2}, Li30;->r0(Ljava/lang/String;)Li30;

    move-result-object v2

    :try_start_0
    invoke-static {v2, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Li30;Ljava/util/List;)V
    :try_end_0
...
.method private static final readChallengeHeader(Li30;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(Li30;)Z

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(Li30;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->skipAll(Li30;B)I
    ...
    invoke-static {p0, v6}, Lokhttp3/internal/http/HttpHeaders;->startsWith(Li30;B)Z

    move-result v6

    if-eqz v6, :cond_a

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Li30;)Ljava/lang/String;
...
.method private static final readQuotedString(Li30;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    :goto_1
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:LM70;

    invoke-virtual {p0, v2}, Li30;->x1(LM70;)J
    ...
    invoke-virtual {v0, p0, v2, v3}, Li30;->write(Li30;J)V
    ...
    invoke-virtual {v0, p0, v8, v9}, Li30;->write(Li30;J)V
...
.method private static final readToken(Li30;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:LM70;

    invoke-virtual {p0, v0}, Li30;->x1(LM70;)J
    ...
    invoke-virtual {p0, v0, v1}, Li30;->G(J)Ljava/lang/String;
...
.method private static final skipCommasAndWhitespace(Li30;)Z
    .locals 5
...
.method private static final startsWith(Li30;B)Z
    .locals 2
