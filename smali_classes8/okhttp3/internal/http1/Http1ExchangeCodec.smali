...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Z",
        "<init>",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lo30;Ln30;)V",
        "Companion",
        "AbstractSource",
        "ChunkedSink",
        "ChunkedSource",
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lo30;Ln30;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lo30;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ln30;

    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lo30;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;LQx1;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(LQx1;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Ln30;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ln30;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lo30;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lo30;
...
.method private final detachTimeout(LQx1;)V
    .locals 2

    invoke-virtual {p1}, LQx1;->a()LJ46;

    move-result-object v0

    sget-object v1, LJ46;->NONE:LJ46;

    invoke-virtual {p1, v1}, LQx1;->b(LJ46;)LQx1;
...
.method private final newChunkedSink()LwB5;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)LAN5;
    .locals 2
...
.method private final newFixedLengthSource(J)LAN5;
    .locals 2
...
.method private final newKnownLengthSink()LwB5;
    .locals 2
...
.method private final newUnknownLengthSource()LAN5;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)LwB5;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()LwB5;
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()LwB5;
...
.method public finishRequest()V
    ...
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ln30;
...
.method public openResponseBodySource(Lokhttp3/Response;)LAN5;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)LAN5;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)LAN5;
    ...
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()LAN5;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(LAN5;ILjava/util/concurrent/TimeUnit;)Z

    invoke-interface {p1}, LAN5;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Ln30;->a2(Ljava/lang/String;)Ln30;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Ln30;->a2(Ljava/lang/String;)Ln30;
    ...
    iget-object v4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ln30;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v5

    invoke-interface {v4, v5}, Ln30;->a2(Ljava/lang/String;)Ln30;
    ...
    invoke-interface {v4, v1}, Ln30;->a2(Ljava/lang/String;)Ln30;

    move-result-object v1

    invoke-interface {v1, v0}, Ln30;->a2(Ljava/lang/String;)Ln30;
    ...
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ln30;
