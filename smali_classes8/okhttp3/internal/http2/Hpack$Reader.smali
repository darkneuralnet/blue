...
# direct methods
.method public constructor <init>(LAN5;I)V
    .locals 7
...
.method public constructor <init>(LAN5;II)V
    .locals 1
    .annotation build Lkotlin/jvm/JvmOverloads;
    .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lo30;
...
.method public synthetic constructor <init>(LAN5;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LAN5;II)V
...
.method private final getName(I)LM70;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:LM70;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lo30;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)LM70;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()LM70;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(LM70;LM70;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(LM70;)LM70;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(LM70;LM70;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(LM70;LM70;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(LM70;LM70;)V
...
.method public final readByteString()LM70;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lo30;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lo30;JLn30;)V

    invoke-virtual {v0}, Li30;->h1()LM70;
    ...
    invoke-interface {v0, v2, v3}, Lo30;->F0(J)LM70;
