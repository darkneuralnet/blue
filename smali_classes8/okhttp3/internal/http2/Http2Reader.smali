...
.method public constructor <init>(Lo30;Z)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lo30;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LAN5;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {v1}, Lo30;->readByte()B
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILo30;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lo30;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {p4}, Lo30;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {v0}, Lo30;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lo30;->F0(J)LM70;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;LM70;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {p2}, Lo30;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {v3}, Lo30;->readByte()B
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lo30;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {v4}, Lo30;->readShort()S
    ...
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lo30;

    invoke-interface {v5}, Lo30;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lo30;)I
    ...
    invoke-interface {p1, v0, v1}, Lo30;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:LM70;
    ...
    invoke-interface {p1, v1, v2}, Lo30;->F0(J)LM70;
    ...
    invoke-virtual {p1}, LM70;->w()Ljava/lang/String;
