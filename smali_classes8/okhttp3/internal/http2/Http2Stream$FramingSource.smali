...
.field private final readBuffer:Li30;

.field private final receiveBuffer:Li30;
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Li30;

    new-instance p1, Li30;

    invoke-direct {p1}, Li30;-><init>()V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Li30;
...
.method public close()V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReadBuffer()Li30;
...
.method public final getReadBuffer()Li30;
    .locals 1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Li30;

    return-object v0
.end method

.method public final getReceiveBuffer()Li30;
    .locals 1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Li30;
...
.method public read(Li30;J)J
    ...
    invoke-virtual/range {p0 .. p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReadBuffer()Li30;

    move-result-object v10

    invoke-virtual {v10}, Li30;->size()J
    ...
    invoke-virtual {v13}, Li30;->size()J
    ...
    invoke-virtual {v10, v0, v13, v14}, Li30;->read(Li30;J)J
...
.method public final receive$okhttp(Lo30;J)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Li30;

    invoke-interface {p1, v2, p2, p3}, LAN5;->read(Li30;J)J
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReceiveBuffer()Li30;
    ...
    invoke-virtual {v3, v4}, Li30;->R2(LAN5;)J
