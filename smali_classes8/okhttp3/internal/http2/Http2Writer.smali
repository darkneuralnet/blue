...
.field private final hpackBuffer:Li30;
...
.method public constructor <init>(Ln30;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    new-instance v4, Li30;

    invoke-direct {v4}, Li30;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li30;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLi30;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li30;

    invoke-interface {v0, v1, v2, v3}, LwB5;->write(Li30;J)V
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    invoke-interface {p1}, Ln30;->flush()V
    :try_end_0
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:LM70;

    invoke-virtual {v2}, LM70;->j()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:LM70;

    invoke-interface {v0, v1}, Ln30;->e0(LM70;)Ln30;
...
.method public final declared-synchronized data(ZILi30;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILi30;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILi30;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, LwB5;->write(Li30;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Ln30;I)V

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Ln30;->M0(I)Ln30;
    ...
    invoke-interface {p2, p1}, Ln30;->N(I)Ln30;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Ln30;->N(I)Ln30;
    ...
    invoke-interface {p1, p2}, Ln30;->N(I)Ln30;
    ...
    invoke-interface {p1, p3}, Ln30;->s0([B)Ln30;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li30;

    invoke-virtual {p3}, Li30;->size()J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li30;

    invoke-interface {p1, v4, v2, v3}, LwB5;->write(Li30;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Ln30;->N(I)Ln30;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, Ln30;->N(I)Ln30;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li30;

    invoke-interface {p2, v2, v3, v4}, LwB5;->write(Li30;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    invoke-interface {v4, v3}, Ln30;->G2(I)Ln30;

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Ln30;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v2

    invoke-interface {v3, v2}, Ln30;->N(I)Ln30;
