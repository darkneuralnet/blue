...
# direct methods
.method private constructor <init>(Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe;Landroid/content/Context;Lio/reactivex/y;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe$ApiClientConnectionCallbacks;->emitter:Lio/reactivex/y;

    return-void
.end method

.method public synthetic constructor <init>(Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe;Landroid/content/Context;Lio/reactivex/y;Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe$1;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe$ApiClientConnectionCallbacks;-><init>(Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe;Landroid/content/Context;Lio/reactivex/y;)V
...
.method public onConnected(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe$ApiClientConnectionCallbacks;->emitter:Lio/reactivex/y;

    invoke-virtual {p1, v0, v1, v2}, Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe;->onGoogleApiClientReady(Landroid/content/Context;Lcom/google/android/gms/common/api/GoogleApiClient;Lio/reactivex/y;)V
    :try_end_0
    ...
    iget-object v0, p0, Lpl/charmas/android/reactivelocation2/observables/BaseObservableOnSubscribe$ApiClientConnectionCallbacks;->emitter:Lio/reactivex/y;
