...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LsI4;->m:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/lang/String;Lokhttp3/HttpUrl;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    iput-object p2, p0, LsI4;->b:Lokhttp3/HttpUrl;

    iput-object p3, p0, LsI4;->c:Ljava/lang/String;

    new-instance p1, Lokhttp3/Request$Builder;

    invoke-direct {p1}, Lokhttp3/Request$Builder;-><init>()V

    iput-object p1, p0, LsI4;->e:Lokhttp3/Request$Builder;

    iput-object p5, p0, LsI4;->g:Lokhttp3/MediaType;

    iput-boolean p6, p0, LsI4;->h:Z
    ...
    iput-object p1, p0, LsI4;->f:Lokhttp3/Headers$Builder;
    ...
    iput-object p1, p0, LsI4;->j:Lokhttp3/FormBody$Builder;
    ...
    iput-object p1, p0, LsI4;->i:Lokhttp3/MultipartBody$Builder;
...
.method public static i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v3, p0, v1, v2}, Li30;->t0(Ljava/lang/String;II)Li30;

    invoke-static {v3, p0, v2, v0, p1}, LsI4;->j(Li30;Ljava/lang/String;IIZ)V

    invoke-virtual {v3}, Li30;->r1()Ljava/lang/String;
...
.method public static j(Li30;Ljava/lang/String;IIZ)V
    .locals 6
    ...
    :cond_1
    invoke-virtual {p0, v1}, Li30;->u0(I)Li30;
    ...
    :cond_3
    invoke-virtual {v0, v1}, Li30;->u0(I)Li30;

    :goto_2
    invoke-virtual {v0}, Li30;->O2()Z
    ...
    invoke-virtual {p0, v3}, Li30;->c0(I)Li30;

    sget-object v4, LsI4;->l:[C
...
.method public a(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object p3, p0, LsI4;->j:Lokhttp3/FormBody$Builder;
...
.method public b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LsI4;->g:Lokhttp3/MediaType;
    :try_end_0
    ...
    :cond_0
    iget-object v0, p0, LsI4;->f:Lokhttp3/Headers$Builder;
...
.method public d(Lokhttp3/Headers;Lokhttp3/RequestBody;)V
    ...
    iget-object v0, p0, LsI4;->i:Lokhttp3/MultipartBody$Builder;
...
.method public f(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, LsI4;->c:Ljava/lang/String;

    if-eqz v0, :cond_1

    invoke-static {p2, p3}, LsI4;->i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object p3, LsI4;->m:Ljava/util/regex/Pattern;
    ...
    iput-object p1, p0, LsI4;->c:Ljava/lang/String;
...
.method public g(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v1, p0, LsI4;->b:Lokhttp3/HttpUrl;

    invoke-virtual {v1, v0}, Lokhttp3/HttpUrl;->newBuilder(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object v0

    iput-object v0, p0, LsI4;->d:Lokhttp3/HttpUrl$Builder;

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, LsI4;->c:Ljava/lang/String;
    ...
    iget-object p3, p0, LsI4;->b:Lokhttp3/HttpUrl;
    ...
    iget-object p3, p0, LsI4;->c:Ljava/lang/String;
    ...
    iget-object p3, p0, LsI4;->d:Lokhttp3/HttpUrl$Builder;
...
.method public h(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, LsI4;->e:Lokhttp3/Request$Builder;
...
.method public k()Lokhttp3/Request$Builder;
    ...
    iget-object v0, p0, LsI4;->d:Lokhttp3/HttpUrl$Builder;
    ...
    :cond_0
    iget-object v0, p0, LsI4;->b:Lokhttp3/HttpUrl;

    iget-object v1, p0, LsI4;->c:Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, LsI4;->k:Lokhttp3/RequestBody;

    if-nez v1, :cond_3

    iget-object v2, p0, LsI4;->j:Lokhttp3/FormBody$Builder;
    ...
    :cond_1
    iget-object v2, p0, LsI4;->i:Lokhttp3/MultipartBody$Builder;
    ...
    :cond_3
    :goto_1
    iget-object v2, p0, LsI4;->g:Lokhttp3/MediaType;

    if-eqz v2, :cond_5

    if-eqz v1, :cond_4

    new-instance v3, LsI4$a;

    invoke-direct {v3, v1, v2}, LsI4$a;-><init>(Lokhttp3/RequestBody;Lokhttp3/MediaType;)V
    ...
    :cond_4
    iget-object v3, p0, LsI4;->f:Lokhttp3/Headers$Builder;
    ...
    :cond_5
    :goto_2
    iget-object v2, p0, LsI4;->e:Lokhttp3/Request$Builder;

    invoke-virtual {v2, v0}, Lokhttp3/Request$Builder;->url(Lokhttp3/HttpUrl;)Lokhttp3/Request$Builder;

    move-result-object v0

    iget-object v2, p0, LsI4;->f:Lokhttp3/Headers$Builder;
    ...
    iget-object v2, p0, LsI4;->b:Lokhttp3/HttpUrl;
    ...
    iget-object v2, p0, LsI4;->c:Ljava/lang/String;
...
.method public l(Lokhttp3/RequestBody;)V
    ...
    iput-object p1, p0, LsI4;->k:Lokhttp3/RequestBody;
