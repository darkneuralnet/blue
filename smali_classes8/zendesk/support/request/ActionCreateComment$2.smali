...
.method public onError(Lsg1;)V
    ...
    invoke-static {v2, v5, v1}, LIx2;->l(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {p1}, Lsg1;->d()Z
    ...
    invoke-virtual {v2, p1}, Lzendesk/support/request/StateMessage;->withError(Lsg1;)Lzendesk/support/request/StateMessage;

    move-result-object v2

    invoke-virtual {v1, p1, v2}, Lzendesk/support/request/ActionFactory;->createCommentError(Lsg1;Lzendesk/support/request/StateMessage;)Lzendesk/support/suas/Action;
