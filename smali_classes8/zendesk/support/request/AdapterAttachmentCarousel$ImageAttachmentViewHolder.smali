...
# direct methods
.method public constructor <init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;LiT3;)V
    .locals 2

    sget v0, Lzk4;->zs_request_carousel_image:I
    ...
    sget p2, LPg4;->request_attachment_carousel_image:I
    ...
    sget p2, LPg4;->request_attachment_carousel_remove:I
    ...
    sget p2, LPg4;->request_attachment_image_carousel_container:I
    ...
    iput-object p3, p0, Lzendesk/support/request/AdapterAttachmentCarousel$ImageAttachmentViewHolder;->picasso:LiT3;
...
.method public bind(Lzendesk/support/request/StateRequestAttachment;Lzendesk/support/request/AdapterAttachmentCarousel$CarouselViewHolder$OnRemoveListener;)V
    ...
    iget-object v0, p0, Lzendesk/support/request/AdapterAttachmentCarousel$ImageAttachmentViewHolder;->picasso:LiT3;

    invoke-virtual {p1}, Lzendesk/support/request/StateRequestAttachment;->getParsedLocalUri()Landroid/net/Uri;

    move-result-object v1

    invoke-virtual {v0, v1}, LiT3;->j(Landroid/net/Uri;)LFI4;

    move-result-object v0

    invoke-virtual {v0}, LFI4;->d()LFI4;

    move-result-object v0

    invoke-virtual {v0}, LFI4;->a()LFI4;
    ...
    invoke-virtual {v0, v1}, LFI4;->g(Landroid/widget/ImageView;)V
    ...
    sget v1, Lgl4;->zs_request_attachment_carousel_remove_attachment_accessibility:I
    ...
    sget v1, Lgl4;->zs_request_attachment_carousel_attachment_accessibility:I
