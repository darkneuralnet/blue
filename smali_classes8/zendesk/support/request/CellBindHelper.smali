...
.method public constructor <init>(Landroid/content/Context;LiT3;Lzendesk/support/request/ActionFactory;Lzendesk/support/suas/Dispatcher;)V
    .locals 0
    ...
    invoke-direct {p3, p2, p1}, Lzendesk/support/request/CellAttachmentLoadingUtil;-><init>(LiT3;Landroid/content/Context;)V
    ...
    sget p2, Lgl4;->request_message_date_today:I
    ...
    sget p2, Lgl4;->request_message_date_yesterday:I
...
.method public addOnClickListenerForFileAttachment(Landroid/view/View;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    sget v0, LPi4;->zs_request_file_attachment_downloading_cell_alpha:I
...
.method public bindStatusLabel(Landroid/widget/TextView;ZZ)V
    ...
    sget p2, Lzf4;->zs_request_cell_label_color_error:I

    sget p3, Lgl4;->request_messages_status_error:I
    ...
    sget p2, Lzf4;->zs_request_cell_label_color:I

    sget p3, Lgl4;->request_message_status_delivered:I
    ...
    invoke-static {v1, p2}, LNA0;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p3, p3, v2, v1}, LkJ3;->a(FFFF)Landroid/view/animation/Interpolator;
...
.method public colorForError(Z)I
    ...
    sget p1, Lzf4;->zs_request_user_background_color_error:I

    goto :goto_0

    :cond_0
    sget p1, Lzf4;->zs_request_user_background_color:I
...
.method public colorForErrorImage(Z)I
    ...
    sget v0, Lzf4;->zs_request_user_background_image_color_error:I
