...
# direct methods
.method public constructor <init>(LiT3;Landroidx/appcompat/widget/Toolbar;Lzendesk/support/request/ViewAlmostRealProgressBar;)V
    .locals 1
    ...
    iput-object p1, p0, Lzendesk/support/request/ComponentToolbar;->picasso:LiT3;
    ...
    sget p1, LPg4;->activity_request_toolbar_container:I
    ...
    sget p1, LPg4;->activity_request_toolbar_custom_title:I
    ...
    sget p1, LPg4;->activity_request_toolbar_custom_sub_title:I
    ...
    sget p1, LPg4;->activity_request_toolbar_avatar_holder:I
...
.method private updateToolbar(Lzendesk/support/request/ComponentToolbar$ToolbarModel;)V
    ...
    sget v5, Lgl4;->request_toolbar_last_reply:I
    ...
    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->picasso:LiT3;

    invoke-virtual {p1}, Lzendesk/support/request/ComponentToolbar$ToolbarModel;->getAvatarUrls()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lzendesk/support/request/ViewToolbarAvatar;->setImageUrls(LiT3;Ljava/util/List;)V
    ...
    invoke-static {v2, v3}, Landroidx/transition/c;->b(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    sget v3, Lgl4;->zs_request_toolbar_accessibility:I
    ...
    sget v0, Lgl4;->request_activity_title:I
