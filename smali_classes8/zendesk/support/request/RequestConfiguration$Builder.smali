...
.method private setConfigurations(Ljava/util/List;)V
    ...
    invoke-static {p1, v0}, LEx0;->d(Ljava/util/List;Ljava/lang/Class;)Ldx0;
...
.method public varargs deepLinkIntent(Landroid/content/Context;[Landroid/content/Intent;)Landroid/content/Intent;
    ...
    new-array v1, v1, [Ldx0;

    invoke-virtual {p0, p1, v1}, Lzendesk/support/request/RequestConfiguration$Builder;->intent(Landroid/content/Context;[Ldx0;)Landroid/content/Intent;
...
.method public intent(Landroid/content/Context;Ljava/util/List;)Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lzendesk/support/request/RequestConfiguration$Builder;->config()Ldx0;
    ...
    invoke-static {v0, p2}, LEx0;->c(Landroid/content/Intent;Ldx0;)V

    return-object v0
.end method

.method public varargs intent(Landroid/content/Context;[Ldx0;)Landroid/content/Intent;
    .locals 0
...
.method public varargs show(Landroid/content/Context;[Ldx0;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lzendesk/support/request/RequestConfiguration$Builder;->intent(Landroid/content/Context;[Ldx0;)Landroid/content/Intent;
...
.method public withFiles(Ljava/util/List;)Lzendesk/support/request/RequestConfiguration$Builder;
    ...
    invoke-static {v2}, Lvl1;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, LnU2;->b(Ljava/lang/String;)Ljava/lang/String;
